...
//    public static String[][] chunks = {"N","PR","DM","V","JJ","RB","PSP","CC","RP","QT","RD"};
 ...
 //   public static int[][] Presence = new int[4][3];        
    ...
    public double[] anninput = new double[120];
    ...
    String[] SMTverb = {"\\u091b\\u0941","\\u0926\\u093f\\u0928","\\u091b\\u094c","\\u0926\\u0948\\u0928\\u094c","\\u091b\\u094c\\u0902","\\u0926\\u0948\\u0928\\u094c\\u0902","\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u091b","\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u0928","\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u091b","\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u0928","\\u091b","\\u0926\\u0948\\u0928","\\u091b\\u093f\\u0928","\\u0926\\u093f\\u0928\\u0928"};
    String[] SMTprnn = {"\\u092e","\\u0924\\u093f\\u092e\\u0940","\\u0939\\u093E\\u092e\\u0940","\\u0924\\u092a\\u093e\\u0908","\\u0935\\u0939\\u093e\\u0901","\\u0909\\u0939\\u093e\\u0901","\\u090a","\\u092f\\u094b","\\u0924\\u094d\\u092f\\u094b","\\u0909\\u0928\\u0940","\\u0924\\u093f\\u0928\\u0940"}; 
    int thobho = 0;
    public int[][] standard = new int[15][50];
    public int[][] standardOri = new int[15][50];
    static int neg = 0;
   ...
   public static void main(String args[])throws IOException 
   {
    ...
    String[] postagset = {"Noun","Proper noun","Noun","Pronoun","Pronoun","Pronoun","Adjective","Verb","Verb","Verb","Verb","Verb","Verb","Proposition","Proposition","Proposition","Proposition","Adverb","Vibhakti","Vibhakti","Vibhakti","Vibhakti","Conjuction","Conjuction","Vibhakti","Question","Conjuction","Interjection","Interjection","Quantity","Quantity","Adverb","Adverb","Determinar","Unknown symbol","PUNC","AB","ALPH","Symbol"};
     ...
     //  int semicount = 0;
       ...
       String vframe;
       String[] Nouns;
       String[] Vibhakti = {"\\u0932\\u0947","\\u0932\\u093E\\u0908", "\\u092E\\u093E", "\\u0915\\u093E", "\\u0915\\u094B", "\\u0926\\u0947\\u0916\\u093F", "\\u092C\\u093E\\u091F","\\u0938\\u092E\\u094D\\u092E", "\\u0938\\u0902\\u0917"};
...
//Actualvibhaktilist = new String[nKarkas];
   ...
   //   System.out.println("before wordnetdata["+i+"] ="+wordnetdata[i]);
      ...
      //    if(tags[i+1].equals("PSPO")){
        ...
        if(tags[i].equals("VAUX")){
          System.out.println("new wordnet neg="+neg);
...
//  Final tags;
      ...
      // vblength = Verbs.length;
       ...
       for(int p = 0 ; p < vblength; p++){
          ...
          if((verbPosition[p]+1) != (verbPosition[p+1]) && Verbs.length >1 && pspexist == 0 ){
        ...
        //  }
            ...
            if(parsedGraphindex  != 100){
              for(int j1 = 0 ; j1 < nnlength ; j1++){
                    ...
                    if(!k7texist && finalend == 0)
                      displayString(filename,goldenfinal,parsedGraphindex,nnlength,nKarkas,NP, false, getk1s(),0,k3exist);
            }
          ...
          //  if(!k1texist)
              ...
              if(!k2pexist && !k7texist  && finalend == 0){
                displayString(filename,golden,0,nnlength,nKarkas,NP, false, getk1s(),0, k3exist);
              }
            }
          //}
          //else{
      ...
      //}
        ...
        System.out.println("eparsed graph index="+eparsedGraphindex);
          ...
          /*if( eparsedGraphindex == 0 && splindex == 1){
            ...
            if(eparsedGraphindex  != 100){
              for(int j1 = 0 ; j1 < nnlength ; j1++){
                    ...
                    System.out.println("splindex="+splindex+"  parsed index="+eparsedGraphindex);
                    if(finalsecondmatching[eparsedGraphindex][0][0] == 1  && finalend == 0)
                        displayString(filename,finalsecondmatching,eparsedGraphindex,nnlength,nKarkas+1,NP, true, getk1s(),splindex, k3exist);
                    else
                        displayString(filename,finalsecondmatching,eparsedGraphindex,nnlength,nKarkas,NP, true, getk1s(),splindex,k3exist);
            }
          ...
          //  if(!k1texist)
              ...
              if(!k2pexist && !k7texist  && finalend == 0){
                displayString(filename,finalsecondmatching,0,nnlength,nKarkas,NP, true, getk1s(), splindex,k3exist);
              }
            }
          ...
          //if(!k1texist){
            if(parsedGraphindex  != 100){
              for(int j1 = 0 ; j1 < nnlength ; j1++){
                    ...
                    if(!k7texist  && finalend == 0)
                      displayString(filename,golden,parsedGraphindex,nnlength,nKarkas,NP, false, getk1s(),0,k3exist);
            }
      ...
      //}
        ...
        //System.out.println("eparsed graph index="+eparsedGraphindex);
          //if(!k1texist){
            if(eparsedGraphindex  != 100){
              for(int j1 = 0 ; j1 < nnlength ; j1++){
                    ...
                    if(finalend == 0)
                    displayString(filename,finalsecondmatching,eparsedGraphindex,nnlength,nKarkas+1,NP, true, getk1s(),0,k3exist);
            }
          ...
          //  if(!k1texist)
              //System.out.print("  parsedindex=  "+0);
              if(!k2pexist && !k7texist  && finalend == 0){
                displayString(filename,finalsecondmatching,0,nnlength,nKarkas,NP, true, getk1s(),0,k3exist);
              }
            }
      //displayString(filename,egolden,g-1,nnlength,nKarkas+1,NP, true, getk1s());
    }
...
//        wordnetfile = wordnet;
      ...
      StringTokenizer st = new StringTokenizer(line);
                while (st.hasMoreTokens()) {
                     ...
                     // flag = 0;
                        ...
                        //    ws1 = st.nextToken();
                            if(ws.equals("\\u092B\\u093E\\u0932\\u0947") || ws.equals("\\u0915\\u093e\\u0932\\u0947")){
                              dontgo = 1;
                              dgindex = counter ;
                            }
               ...
               // }
                     ...
                     if( flag1 == 2 && counter%2 == 0){
                          ...
                          //System.out.println("***wd["+(nowords-3)+"]="+words[nowords-3]);
                            ...
                            if(dgindex != counter )
                       sws = RegionMatchesDemoLai("\\u0932\\u093E\\u0908", ws);
                else
                  sws[0] = "ab";
                     //System.out.println("sws["+0+"]="+sws[0]+"  sws[1]="+sws[1]);
                     if( sws[0].equals("ab"))
                    ...
                    System.out.println("dgindex="+dgindex+"  counter="+counter);
                     if( flag6 == 2 && counter%2 == 0 ){
                          ...
                          System.out.println("wd["+(nowords-3)+"]="+words[nowords-3]);
                           ...
                           // if(dgindex != counter )
                              sws = RegionMatchesDemoLai("\\u0947\\u0915\\u094b", ws);
                  ...
                  //        words[nowords+1] = ws;
                     ...
                     if( flag9 == 2 && counter%2 == 0 ){
                          ...
                          System.out.println("imp wd["+(nowords-3)+"]="+words[nowords-3]);
                            ...
                            if(dgindex != counter )
                              sws = RegionMatchesDemoLai("\\u090f\\u0915\\u093e", ws);
                      else
                        sws[0] = "ab";
                     System.out.println("sws["+0+"]="+sws[0]+"  sws[1]="+sws[1]);
                     if(sws[0].equals("ab") )
                  ...
                  //        words[nowords+1] = ws;
                     ...
                     if( flag4 == 2 && counter%2 == 0){
                          ...
                          //System.out.println("***wd["+(nowords-3)+"]="+words[nowords-3]);
                            ...
                            if(dgindex != counter )
                       sws = RegionMatchesDemoLagi("\\u0932\\u093E\\u0917\\u093F", ws);
                else
                  sws[0] = "ab";
                     //System.out.println("sws["+0+"]="+sws[0]+"  sws[1]="+sws[1]);
                     if( sws[0].equals("ab"))
  ...
  /*                   String temp = "ab";
                ...
                /*     if(dgindex == 0 && flag3 == 2 && flagsampradan != 0){
                  ...
                  //        words[nowords+1] = ws;
                     ...
                     if( flag5 == 2 && counter%2 == 0 ){
                          ...
                          System.out.println("wd["+(nowords-3)+"]="+words[nowords-3]);
                            ...
                            if(dgindex != counter ){
                              sws = RegionMatchesDemoLai("\\u0938\\u0901\\u0917", ws);
                            
                            if(sws[0].equals("ab"))
                              sws = RegionMatchesDemoLai("\\u0938\\u0902\\u0917", ws);
                            }
                      else
                        sws[0] = "ab";
                     //System.out.println("sws["+0+"]="+sws[0]+"  sws[1]="+sws[1]);
                    ...
                    System.out.println("flag5 = "+flag5);
                     if( flag7 == 2 && counter%2 == 0 ){
                          ...
                          //System.out.println("wd["+(nowords-3)+"]="+words[nowords-3]);
                            ...
                            if(dgindex == counter )
                              sws = RegionMatchesDemoLai("\\u092c\\u093e\\u091f", ws);
                      else
                        sws[0] = "ab";
                     //System.out.println("sws["+0+"]="+sws[0]+"  sws[1]="+sws[1]);
                     if(sws[0].equals("ab") )
                     ...
                     if( flag8 == 2 && counter%2 == 0 ){
                          ...
                          //System.out.println("wd["+(nowords-3)+"]="+words[nowords-3]);
                            ...
                            if(dgindex != counter && not == 0){
                              sws = RegionMatchesDemoLai("\\u0939\\u0930\\u0941", ws);
                            
                            if(sws[0].equals("ab"))
                              sws = RegionMatchesDemoLai("\\u0939\\u0930\\u0942", ws);
                            not = 1;
                           // dgindex = counter;
                            }
                            //if(dgindex == counter )
                  ...
                  //        words[nowords+1] = ws;
                        ...
                        alaram = 1;
                            ...
                            if(k2exist == 0 )
                              sws = RegionMatchesDemoLagi("\\u0907\\u0928\\u094d\\u091b", ws);
                             else
                               sws[0] = "ab";
                       ...
                       if(k2exist == 0 )
                           ...
                           if(sws[0].equals("ab") && k2exist == 0)
                              ...
                              if(k2exist == 0 )
                              sws = RegionMatchesDemoLai("\\u092f\\u094b\\u0938", ws);
                             else
                               sws[0] = "ab";
                             //System.out.println("sws["+0+"]="+sws[0]+"  sws[1]="+sws[1]);
                           if(sws[0].equals("ab") && k2exist == 0)
               ...
               if(k2exist == 0 )
                              sws = RegionMatchesDemoLai("\\u0907\\u092f\\u094b", ws);
                             else
                               sws[0] = "ab";
                             //System.out.println("sws["+0+"]="+sws[0]+"  sws[1]="+sws[1]);
                           if(sws[0].equals("ab") && k2exist == 0 )
                    ...
                    // int swsko = getnegation2("\\u0915\\u094b",ws);
                     //System.out.println(" ko exist ",+swsko);
                     
                     
                     System.out.println("flag="+flag+"  flag1 = "+flag1+"   flag2 ="+flag2+"    flag3="+flag3+"   flag4="+flag4+"  flag8="+flag8+"  flag5 ="+flag5+"  flag6 ="+flag6+"   flag7 = "+flag7+"  nowords="+nowords+"  alaram = "+alaram);
                     //flag8=0;
                  ...
                  for(int i = 0 ; i < tvbt.length ; i++ ){
                    ...
                    for(int l = 0 ; l < trows ; l++){
                      ...
                      System.out.println("Actualvibhakti["+t+"]="+Actualvbt);
                          ...
                          if(Actualvibhaktilist[t].equals(tvbt[i]) || Actualvibhaktilist[t].equals("\\u092C\\u093E\\u091F")){
...
//                          continue;
                //System.out.println("flagk2="+flagk2+"    count="+count +"  Actualvibhaktilist["+i+"]="+Actualvibhaktilist[i]);
                      if( count == 1 || Actualvibhakti[l][2*l][1].equals(tvbt[i]) || Actualvibhaktilist[i].equals(tvbt[i])){
                        //System.out.println("**********karma(k2)");
                  //if(vbtk1.equals("\\u0932\\u0947") || vbtk1.equals("\\u0915\\u094B") || vbtk1.equals("null")   || vbtk1.equals("\\u0932\\u093E\\u0908")){
                    ...
                    for(int l = 0 ; l < trows ; l++){
                      ...
                      //System.out.println("Actualvibhakti["+t+"]="+Actualvbt);
                            ...
                            try{
                              while(t < trows && ct1 == 0){
                                //System.out.println("*Actualvibhakti["+t+"]="+Actualvibhaktilist[t]+"    tvbt["+i+"]="+tvbt[i]);
                          if(Actualvibhaktilist[t].equals(tvbt[i]) || Actualvbt.equals("\\u092C\\u093E\\u091F")){
                            if(! Actualvibhaktilist[t].equals("null")){
                              ct1 = 1;
                              //System.out.println("hi vibhakti is not null");  
                            }
...
//            break;
 ...
 /*   public String getPresence(int inx , ReadXMLFile f3){
  ...
  try{
    ...
    public static void displayString(String outputName2, int[][][] fg1,int ind, int rows, int krks, String[] nn, boolean e, boolean k1s, int splind, boolean k3ex){
    try{
...
//      int fugee = 0;
      ...
      System.out.println("k2pexist = "+k2pexist+"   k3exist="+k3exist);
      //sw = np;
...
//        npwords[npcount][s] = words[s];
  ...
  for(int i = 0 ; i <= npcount;i++){
    for(int j = 0 ; j < nptags[i].length ; j++){
      System.out.println(" 123  nptags["+i+"]["+j+"]="+nptags[i][j]+"  nlrows="+nlrows+"   nlcols="+nlcols);
      if(parserelation[j].equals("Karana(K3)") && !parserelation[j+1].equals("PSPLE") && !k3exist)
        parserelation[j] = "Sampradan(K4)";
      if(parserelation[j].equals("Karma(K2)") && parserelation[j+1].equals("PSPLE"))
  ...
  OutputStreamWriter writer = new OutputStreamWriter(new FileOutputStream(filename, true), "UTF-8");
    ...
    /*  if(words[0].equals("\\u0909\\u0928\\u093f"))// Uni
     ...
     /* int e=0;
      ...
      standardOri[10][11] = 1;
      if(neg == 0)
        neg = getNegation("\\u0926\\u093f\\u0928", words[0]);   // dina
     ...
     /* else{
      ...
      if(neg == 0)
        neg = getNegation1("\\u0926\\u0948\\u0928\\u094c", words[0]);   // dainau
      ...
      if(neg == 1){
        ...
        second = 1;
        dainau = 1;
        sign = getNegation4("\\u0924\\u093f\\u092e\\u0940",words[1]);   // timi
       // standardOri[1][2] = 1;
       // standardOri[1][3] = 1;
        if(sign == 1){
          standard[1][3] = 1;
      ...
      if(neg == 0)
        neg = getNegation6("\\u0926\\u0948\\u0928\\u094c\\u0901", words[0]);   // dainaun
      ...
      if(neg == 1){
        ...
        second = 1;
        dainaun = 1;
        sign = getNegation1("\\u0939\\u093E\\u092e\\u0940",words[1]);   // hami
      //  standardOri[2][4] = 1;
      //  standardOri[2][5] = 1;
        if(sign == 1){
          standard[2][5] = 1;
      ...
      if(neg == 0)
        neg = getNegation3("\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u0928\\u093e", words[0]);   // nuhunn
       // neg = getNegation3("\\u0926\\u0948\\u0928\\u094c\\u0901", words[0]);   // dainau
      ...
      if(neg == 1){
        ...
        third = 1;
        nuhunn = 1;
        sign = getNegation1("\\u0924\\u092a\\u093e\\u0908",words[1]);   // Tapai
      //  standardOri[3][6] = 1;
      //  standardOri[3][7] = 1;
        if(sign == 1){
          standard[3][7] = 1;
        ...
        sign = getNegation1("\\u0935\\u0939\\u093e\\u0901",words[1]);   // Vahan       
      //  standardOri[4][6] = 1;
      //  standardOri[4][7] = 1;
        if(sign == 1){
          standard[4][7] = 1;
        ...
        sign = getNegation1("\\u0909\\u0939\\u093e\\u0901",words[1]);   // Uhan
      //  standardOri[5][6] = 1;
      //  standardOri[5][7] = 1;
        if(sign == 1){
          standard[5][7] = 1;
      ...
      fout.write("\n");
       ...
       if(neg == 0)
        neg = getNegation("\\u0926\\u0948\\u0928", words[0]);   // dain
      ...
      //  standardOri[6][9] = 1;
        ...
        sign = getNegation2("\\u092f\\u094b",words[1]);   // yo       
      //  standardOri[7][8] = 1;
      //  standardOri[7][9] = 1;
        if(sign == 1){
          standard[7][9] = 1;
        ...
        sign = getNegation1("\\u0924\\u094d\\u092f\\u094b",words[1]);   // tyo
      //  standardOri[8][8] = 1;
      //  standardOri[8][9] = 1;
        if(sign == 1){
          standard[8][9] = 1;
      ...
      if(neg == 0)
        neg = getNegation6("\\u0926\\u093f\\u0928\\u0928\\u094d", words[0]);   // dinan
      ...
      if(neg == 1){
        ...
        third = 1;
        dinan = 1;
        sign = getNegation("\\u0909\\u0928\\u0940",words[1]);   // uni      
      //  standardOri[9][10] = 1;
      //  standardOri[9][11] = 1;
        if(sign == 1){
          standard[9][11] = 1;
        ...
        sign = getNegation1("\\u0924\\u093f\\u0928\\u0940",words[1]);   // tini
      //  standardOri[10][10] = 1;
      //  standardOri[10][11] = 1;
        if(sign == 1){
          standard[10][11] = 1;
     ...
     /* else{
      ...
      int plural = 0;
      if(plural == 0)
        plural = getNegation2("\\u091b\\u0941", words[0]);   // chu
      fout.write("\n");
      ...
      fout.write("\n");
      if(plural == 0)
        plural = getNegation2("\\u091b\\u094c", words[0]);   // chau
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        fout.write(" Subject is Affirmative ");
        ...
        second = 1;
        chhau = 1;
        sign = getNegation1("\\u0924\\u093f\\u092e\\u0940",words[1]);   // timi
      //  standardOri[0][0] = 1;
        //standardOri[0][1] = 1;
      ...
      if(plural == 0)
        plural = getNegation4("\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u091b", words[0]);   // nuhunchh
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        fout.write(" Subject is Affirmative ");
      ...
      if(plural == 0)
        plural = getNegation2("\\u091b\\u0938", words[0]);   // chas
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        fout.write(" Subject is Affirmative ");
      ...
      if(plural == 0)
        plural = getNegation("\\u091b\\u093f\\u0928", words[0]);   // cheen
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        fout.write(" Subject is Affirmative ");
      ...
      if(plural == 0)
        plural = getNegation("\\u091b\\u0940\\u0928", words[0]);   // chin
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        fout.write(" Subject is Affirmative ");
      ...
      for(int v=0;v<vb.length;v++){
        ...
        if(plural == 0){
          ...
          if(vb[v].equals("\\u091b\\u0928\\u094d")  || vb[v].equals("\\u091b\\u0928")){
            neg = 1;
            plural = 1;
          }
        //plural = getNegation4("\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u091b", words[0]);   // chau
        }
      }
      ...
      if(plural == 0){
        plural = getNegation2("\\u091b\\u0928", words[0]);   // chau
        System.out.println("123 plural = "+plural);
        if(plural == 0 ){
          plural = getNegation("\\u091b\\u0928\\u094d", words[0]);
    ...
    if(neg == 0)
        neg = getNegation1("\\u0930\\u093f\\u0928\\u093e", words[0]);   // rina
      if(neg == 1){
        System.out.println("Negative sentence");
        fout.write(" sentence is negative ");
        System.out.println("Simple Past Tense");
      ...
      if(neg == 0)
        neg = getNegation("\\u090f\\u0928\\u094c", words[0]);   // rina
      if(neg == 1){
        System.out.println("Negative sentence");
        fout.write(" sentence is negative ");
        System.out.println("Simple Past Tense");
      ...
      if(plural == 0)
        plural = getNegation6("\\u0917\\u0930\\u094d\\u092f\\u094c", words[0]);   // garyau
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
...
if(neg == 0)
        neg = getNegation2("\\u092f\\u094c", words[0]);   // rina
      if(neg == 1){
        System.out.println("Negative sentence");
        fout.write(" sentence is negative ");
        System.out.println("Simple Past Tense");
      ...
      if(plural == 0)
        plural = getNegation6("\\u0917\\u0930\\u094d\\u092f\\u094c", words[0]);   // e
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
      ...
      fout.write("\n");
      if(neg == 0)
        neg = getNegation6("\\u0928\\u0941\\u092d\\u090f\\u0928", words[0]);   // nubhaen
      if(neg == 1){
        System.out.println("Negative sentence");
        fout.write(" sentence is negative ");
        System.out.println("Simple Past Tense");
      ...
      if(plural == 0)
        plural = getNegation6("\\u0928\\u0941\\u092d\\u092f\\u094b", words[0]);   // nubhayo
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
      ...
      if(neg == 0)
        neg = getNegation1("\\u090f\\u0928\\u0928\\u094d", words[0]);   // enen
      if(neg == 1){
        System.out.println("Negative sentence");
        fout.write(" sentence is negative ");
        System.out.println("Simple Past Tense");
      ...
      if(plural == 0)
        plural = getNegation2("\\u092f\\u094b", words[0]);   // yo
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
      ...
      if(neg == 0)
        neg = getNegation7("\\u0928\\u0947\\u091b\\u0948\\u0928\\u0901", words[0]);   // nechhu
      if(neg == 1){
        System.out.println("Negative sentence");
        fout.write(" sentence is negative ");
      ...
      if(plural == 0)
        plural = getNegation1("\\u0928\\u0947\\u091b\\u0941", words[0]);   // nechhauna
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
...
if(neg == 0)
        neg = getNegation4("\\u0928\\u0947\\u091b\\u0948\\u0928\\u094c\\u0902", words[0]);   // nechhu
      if(neg == 1){
        System.out.println("Negative sentence");
        fout.write(" sentence is negative ");
        System.out.println("Simple Future Tense");
      ...
      if(plural == 0){
        garnuexist = getNegation6("\\u093e\\u0930\\u094d\\u0928\\u0941", words[0]);   // nechhauna
      ...
      fout.write("\n");
      if(plural == 0)
        plural = getNegation6("\\u0928\\u0947\\u091b\\u094c\\u0902", words[0]);   // nechhauna
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
    ...
    if(neg == 0)
        neg = getNegation7("\\u0928\\u0947\\u091b\\u0948\\u0928\\u094c", words[0]);   // nechhainau
      if(neg == 1){
        System.out.println("Negative sentence");
        fout.write(" sentence is negative ");
        System.out.println("Simple Future Tense");
      ...
      if(plural == 0)
        plural = getNegation1("\\u0928\\u0947\\u091b\\u094c", words[0]);   // nechhau
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
      ...
      if(neg == 0)
        neg = getNegation6("\\u0928\\u0947\\u091b\\u0948\\u0928", words[0]);   // nechhain
      if(neg == 1){
        System.out.println("Negative sentence");
        fout.write(" sentence is negative ");
        System.out.println("Simple Future Tense");
      ...
      if(plural == 0)
        plural = getNegation("\\u0928\\u0947\\u091b", words[0]);   // nechh
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
      ...
      if(neg == 0)
        neg = getNegation7("\\u0928\\u0947\\u091b\\u0948\\u0928\\u0928", words[0]);   // nechhainan
      if(neg == 1){
        System.out.println("Negative sentence");
        fout.write(" sentence is negative ");
        System.out.println("Simple Future Tense");
      ...
      if(plural == 0)
        plural = getNegation1("\\u0928\\u0947\\u091b\\u0928", words[0]);   // nechhau
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
      ...
      if(plural == 0)
        plural = getNegation2("\\u0928\\u0941", words[0]);   // unu
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      fout.write("\n");
      if( plural == 1){
     ...
     // try{
      ...
      fout.write("\n");
        ...
        if( words[r].equals("\\u0924\\u094d") || words[r].equals("\\u092e")  || words[r].equals("\\u0924\\u0901") || words[r].equals("\\u0924") || words[r].equals("\\u0909") || words[r].equals("\\u0924") || words[r].equals("\\u0909\\u0928\\u093f") || words[r].equals("\\u092f\\u094b") || words[r].equals("\\u0909\\u0928\\u0940")){
            System.out.println("Subject is Singular");
            fout.write(" Subject is Singular ");
            plural=3;
             
        }
        if( words[r].equals("\\u0939\\u093e\\u092e\\u0940")){
            System.out.println("Subject is Plural");
            fout.write(" Subject is Plural ");
            plural=4;
             
        }
        if(words[r].equals("\\u0909\\u0928\\u0940") || words[r].equals("\\u0924") || words[r].equals("\\u0909\\u0928\\u093f") || words[r].equals("\\u092f\\u094b")){
          third=1;
          first=0;
          second=0;
        }
        ...
        if(vb.length > 1){
          ...
          for(int v=0;v<vb.length;v++){
              ...
              //if(plural == 0){
              cont = getNegation4("\\u0926\\u0948", vb[v]);
              if(cont == 1){
            
                if(vb[v+1].equals("\\u091b\\u0941") || vb[v+1].equals("\\u091b\\u094c") || vb[v+1].equals("\\u091b\\u094c\\u0901") || vb[v+1].equals("\\u0939\\u0941\\u0939\\u0941\\u0928\\u094d\\u091b") || vb[v+1].equals("\\u091b") || vb[v+1].equals("\\u091b\\u0941") || vb[v+1].equals("\\u091b\\u093f\\u0928\\u094d") || vb[v+1].equals("\\u091b\\u0928\\u094d")){// || vb[v].equals("\\u091b\\u0928")){
                    spc = 1;
                    neg = 0;
                    System.out.println("Present contunous Tense spc="+spc+"   neg="+neg);
            
                 }
                  if(vb[v+1].equals("\\u091b\\u0948\\u0928") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u094c") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u094c\\u0901") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u0924\\u0930") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u0928\\u094d") || vb[v+1].equals("\\u091b\\u0948\\u0928") || vb[v+1].equals("\\u091b\\u093f\\u0928\\u094d") ){// || vb[v].equals("\\u091b\\u0928")){
                    spc = 1;
                    neg = 0;
                    System.out.println("Present contunous Tense spc="+spc+"   neg="+neg);
            
                 }
                 if(vb[v+1].equals("\\u091b\\u0948\\u0928") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u0928") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u0928") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u094c") ){
                    spc = 1;
                    neg = 1;
                    System.out.println("Present contunous Tense spc="+spc+"   neg="+neg);
        ...
        //plural = getNegation4("\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u091b", words[0]);   // chau
            ...
            //}
          //plural = getNegation1("\\u0926\\u0948", words[r]);   // nechhau
      ...
      for(int v=0;v<vb.length;v++){
              ...
              if(cont == 1){
                ...
                if(vb[v+1].equals("\\u0925\\u093f\\u090f\\u0901") || vb[v+1].equals("\\u0925\\u093f\\u092f\\u094c") || vb[v+1].equals("\\u0925\\u093f\\u092f\\u094c\\u0901") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u0925\\u094d\\u092f\\u094b") || vb[v+1].equals("\\u0925\\u093f\\u092f\\u094b") || vb[v+1].equals("\\u0925\\u093f\\u0907\\u0928\\u094d") || vb[v+1].equals("\\u0925\\u093f\\u090f") ){// || vb[v].equals("\\u091b\\u0928")){
                    pastc = 1;
                    neg = 0;
                    System.out.println("Past contunous Tense pastc="+pastc+"   neg="+neg);
            
                 }
                  if(vb[v+1].equals("\\u0925\\u093f\\u0907\\u0928\\u0901") || vb[v+1].equals("\\u0925\\u093f\\u090f\\u0928\\u094c") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u094c\\u0901") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0941\\u0939\\u0941\\u0928\\u094d\\u0928") || vb[v+1].equals("\\u0925\\u093f\\u0907\\u0928") || vb[v+1].equals("\\u0925\\u093f\\u090f\\u0928\\u0928") || vb[v+1].equals("\\u0925\\u093f\\u0907\\u0928\\u0928") ){// || vb[v].equals("\\u091b\\u0928")){
                    pastc = 1;
                    neg = 1;
      ...
      for(int v=0;v<vb.length;v++){
              ...
              if(cont == 1){
                ...
                if(vb[v+1].equals("\\u0939\\u0941\\u0928\\u0947\\u091b\\u0941") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0947\\u091b\\u094c") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0947\\u091b\\u094c\\u0901") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0941\\u0939\\u0941\\u0928\\u0947\\u091b") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0947\\u091b") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0947\\u091b\\u093f\\u0928") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0947\\u091b\\u0928") ){// || vb[v].equals("\\u091b\\u0928")){
                    futc = 1;
                    neg = 0;
                    System.out.println("Future contunous Tense futurec="+futc+"   neg="+neg);
            
                 }
                  if(vb[v+1].equals("\\u0939\\u0941\\u0928\\u0947\\u091b\\u0948\\u0928") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0947\\u091b\\u0948\\u0928\\u094c") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0941") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0947\\u091b\\u0948\\u0928") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0947\\u091b\\u0948\\u0928") || vb[v+1].equals("\\u0939\\u0941\\u0928\\u0947\\u091b\\u0948\\u0928\\u0928\\u094d")  ){// || vb[v].equals("\\u091b\\u0928")){
                    futc = 1;
                    neg = 1;
                    System.out.println("Future contunous Tense futurec="+futc+"   neg="+neg);
...
// PRESENT PERFECT TENSE
      ...
      for(int v=0;v<vb.length;v++){
              ...
              //if(plural == 0){
              cont = getNegation("\\u090f\\u0915\\u094b", vb[v]);
              if(cont == 0) {
                cont=getNegation("\\u090f\\u0915\\u0940", vb[v]);
                ekiexist = 1;
              }
              if(cont == 1){
            
                if( ekoexist == 1  || ekiexist == 1){// || vb[v].equals("\\u091b\\u0928")){
                    sperf = 1;
                    neg = 0;
                    System.out.println("Simple perfect Tense futurec="+futc+"   neg="+neg);
            
                 }
                  if(sperf == 1 && (vb[v+1].equals("\\u091b\\u0948\\u0928") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u094c") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u0901") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u0928\\u094d")  ) ){// || vb[v].equals("\\u091b\\u0928")){
                    sperf = 1;
                    neg = 1;
                    System.out.println("Simple perfect Tense futurec="+futc+"   neg="+neg);
      ...
      for(int v=0;v<vb.length;v++){
              ...
              //if(plural == 0){
              cont = getNegation("\\u090f\\u0915\\u094b", vb[v]);     // eko
              System.out.println("cont ="+cont);
              ekoexist = 1;
              if(cont == 0) {
                cont=getNegation("\\u090f\\u0915\\u0940", vb[v]);     // eki
                ekiexist = 1;
              }
              if(cont == 1){
                fperf = 1;
                ...
                if( ekoexist == 1  || ekiexist == 1){// || vb[v].equals("\\u091b\\u0928")){
                  ...
                  if(v < (vb.length - 1) && fperf == 1 && (vb[v+1].equals("\\u091b\\u0948\\u0928") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u094c") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u0901") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u0928\\u094d")  ) ){// || vb[v].equals("\\u091b\\u0928")){
                    fperf = 1;
                    neg = 1;
                    System.out.println("Future perfect Tense futurepc="+fperf+"   neg="+neg);
      ...
      for(int v=0;v<vb.length;v++){
              ...
              if(cont == 1){
                ...
                if( ekoexist == 1  || ekiexist == 1){// || vb[v].equals("\\u091b\\u0928")){
                  ...
                  if(pperf == 1 && (vb[v+1].equals("\\u091b\\u0948\\u0928") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u094c") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u0901") || vb[v+1].equals("\\u091b\\u0948\\u0928\\u0928\\u094d")  ) ){// || vb[v].equals("\\u091b\\u0928")){
                    pperf = 1;
                    neg = 1;
                    System.out.println("Past perfect Tense pperf="+pperf+"   neg="+neg);
      ...
      English1 = getEnglishsentence(duplicateparse, np, words, tags, parserelation, words[0], neg,plural,first,second,third,spre,spast,sfuture, chunkinfo, spc,pastc,futc,fperf,sperf,pperf, sent, filename,filename3,gender,vb,garnuexist);
      fout.write("\n");
      fout.write("\n");
       ...
       //   if(extduplicate[m1][n1] == 1){
             ...
             /* if(tags[n1].equals("VAUX") || tags[n1].equals("VF") ){
              ...
              if(n1 == 0){
                  ...
                  if(n1 != 1 && 2*n1 < stopindex /*|| !Words[2*n1-2].equals(null)*/){
                    fout.write("\n");
...
public static String[][] getTraslation(String fileName) throws IOException {
    ...
    g[0] = "ab";
        ...
        boolean foundIt = false;
          String ekoutf = "\\u0947\\u0915\\u094b";
          System.out.println("eko check="+ekoutf+"   findMe1="+findMe1);
       //   try{
      ...
      //  for(int i = 0; i < s; i++) {
          ...
          int s1 = findMe.compareTo(findMe1);
           int s = findMe1.compareTo(ekoutf);
...
//              count++;
    ...
    public String[] getEnglishsentence(int[][] parsedtree, String[]  chunk,String[] nep, String[] tags, String[] rel, String vb, int ne, int pl, int f, int s, int thd, int sp, int spa, int sf, int[] tsword, int spc,int pastc,int futc,int fperf,int sperf,int pperf, String[] sen, String fn, String filename3, int gend, String[] verbs, int garnu){
        ...
        System.out.println("Verb vb="+vb+" negative ne="+ne+" Plural pl="+pl+" future f="+f+" singular"+s+" third thd="+thd+" simple present sp="+sp+"  simple past spa="+spa+"  simple future sf= "+sf+"  simple present continuous spc= "+spc+"  past cont="+pastc+"  future cont="+futc+" future perfect ="+fperf+"  simple perfect="+sperf+" past perfect= "+pperf+" fn= "+fn+"  gend="+gend);
      ...
      //  String[] englishunicode = new String[wdct];
       ...
       /*   try{
        ...
        if(ne==1) anninput[50] = 1;
        if(pl==1) anninput[51] = 1;
  ...
  OutputStreamWriter writer2 = new OutputStreamWriter(new FileOutputStream(filename3, true), "UTF-8");
     ...
     // }
       ...
       /* else{
        ...
        for(int i = 0 ; i < chunk.length+time +1 && vbexist;i++){
  ...
  for(int n1 = 0 ; n1 < nlcols;n1++){
       //   if(extduplicate[m1][n1] == 1){
              if(n1 == 0){
                  ...
                  System.out.println("Part of Speech of "+words[n1-2]+" is "+postagset[index]);
                  if(!words[n1-2].equals(null)) {
