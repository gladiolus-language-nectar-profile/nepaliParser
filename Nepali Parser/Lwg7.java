...
public class Lwg7
{
    ...
    public static int ekoexist = 0;
     public static int vmkoekoexist = 0;
    public static int ekiexist = 0;
     public static int ekaexist = 0;
     public static int ikaexist = 100;
    public static int pspexist = 0;
    public static int psppos = 0;
    public static int RBindex = 0;
   ...
   // public static double[][] observationMatrix = new double[totaltag][300];
    ...
    public static int noma = 0;
    public static int sangexist = 0;
    public static String output;
    public static int pluralharu = 0;
    public static int wordcount = 0;
    public static int verbslength = 0;
...
//    public static String[][] chunks = {"N","PR","DM","V","JJ","RB","PSP","CC","RP","QT","RD"};
    ...
    public static String[][] TTN = new String[50][3];    // Maximum 5 noun groups and each group has 3 words are assumed
     public static String[][] Vph = new String[50][3];    // Maximum 5 Verb groups and each group has 3 words are assumed
    public static String[][] TN = new String[50][3];    // Maximum 5 noun groups and each group has 3 words are assumed
     public static String[] NP = new String[50]; // Noun Phrase
     public static String[] TNP = new String[50]; // Tag Noun Phrase
 ...
 //   public static int[][] Presence = new int[4][3];        
    ...
    public static boolean k3exist = false;
    public static int QTCexist = 100;
    public static int k5exist = 0;
    ...
    public static int batexist = 0;
    public static int[][] duplicate;
    public static int[][] intramatrix;
    public static int[] verbPosition = new int[25];
    public static int[]  seperatepos = new int[25];
    ...
    public static int pluralverb = 0;  
    public static String[][] dictionary;
    public static String[][] dictionaryverb;
    public static int QWexist = 100;
    public static int QWexist1 = 200;
    //public static int noVerbs = 1;
    public static int nlcols = 0;    
    public static int[][] npfinal = new int[50][16]; 
    ...
    public String[][] oldparserelation1 = new String[5][100];    
    public int[][] npextduplicate = new int[50][16]; // Assuming max 4 verbs in a sentences
    public int[][] extduplicate = new int[50][16];
    public int[] anninput = new int[120];
    public static int entrymatris = 0;
    ...
    String[] SMTverb = {"\u091b\u0941","\u0926\u093f\u0928","\u091b\u094c","\u0926\u0948\u0928\u094c","\u091b\u094c\u0902","\u0926\u0948\u0928\u094c\u0902","\u0928\u0941\u0939\u0941\u0928\u094d\u091b","\u0928\u0941\u0939\u0941\u0928\u094d\u0928","\u0928\u0941\u0939\u0941\u0928\u094d\u091b","\u0928\u0941\u0939\u0941\u0928\u094d\u0928","\u091b","\u0926\u0948\u0928","\u091b\u093f\u0928","\u0926\u093f\u0928\u0928"};
    String[] SMTprnn = {"\u092e","\u0924\u093f\u092e\u0940","\u0939\u093E\u092e\u0940","\u0924\u092a\u093e\u0908","\u0935\u0939\u093e\u0901","\u0909\u0939\u093e\u0901","\u090a","\u092f\u094b","\u0924\u094d\u092f\u094b","\u0909\u0928\u0940","\u0924\u093f\u0928\u0940"}; 
    int thobho = 0;
    public int[][] standard = new int[50][50];
    public int[][] standardOri = new int[50][50];
    static int neg = 0;
    static int transitive = 1;
    public static int laiindex = 100;
    //public final String[] tpst;
    
    
    Tag ftag;
    public  Lwg7(String s, String[] f){
    }
   public  Lwg7(){}
   public static void main(String args[])throws IOException 
   {
      String output = args[0];
      String dicnary = args[1];

       String glyph = "\u0926\u0947\u0916\u093F";
       int nonouns = 0;
       //String[] presence = new String[];
    String[] tagset = {"NN","NNP","NST","PRP","PRL","PRF","JJ","VF","VINF","VAUX","VMNE","VMKO","VMO","DM","DMR","DMD","DMI","RB","PSPLE","PSPLAI","PSPKO","PSPO","CCD","CCS","HRU","QW","CL","INJ","INTF","QTC","QTO","RDF","RP","DT","UNK","PUNC","AB","ALPH","SYM"};
    String[] postagset = {"Noun","Proper noun","Noun","Pronoun","Pronoun","Pronoun","Adjective","Verb","Verb","Verb","Verb","Verb","Verb","Proposition","Proposition","Proposition","Proposition","Adverb","Vibhakti","Vibhakti","Vibhakti","Vibhakti","Conjuction","Conjuction","Vibhakti","Question","Conjuction","Interjection","Interjection","Quantity","Quantity","Adverb","Adverb","Determinar","Unknown symbol","PUNC","AB","ALPH","Symbol"};
...
//       String[] Vibhakti = {}
     ...
     //  String[][] N = new String[5][3];
       ...
       dictionary  = new String[2500][10];
       dictionaryverb  = new String[1500][7];
...
//Actualvibhaktilist = new String[nKarkas];
      // t.readFile(args[0], args[1],args[2], glyph);
       ...
       String filename3 = "input.txt";
       String filename4 = "dict1.txt";
       dictionary = getTraslation(filename2);
       dictionaryverb = getrootTraslation(filename4);
     //  ac.main1("annoutput.txt", dicnary);
   ...
   //   //System.out.println("*****sentwords1["+0+"]="+sentwords1[0
        ...
        if(tags[i].equals("NN") || tags[i].equals("NNP")){
          if(tags[i+1].equals("PSPO")){
            if(morphs[i+1].equals("\u092E\u093E")){
              System.out.println(" Welcome special k2pexist");
             // k2pexist = true;
              k7texist = true;
              break;
            }
    ...
    int k2pcount = 0;
    for(int i=0;i<wordnetdata.length;i++){

      if(wordnettag[i]==null){
        wordnetdata[i] = "nl";
        wordnettag[i] = "nl";  
      }
      
   //   System.out.println("before wordnetdata["+i+"] ="+wordnetdata[i]);
    }
      try{
        //int k2pcount1=0;
       for(int i = 0 ; i < tags.length ; i++){
      //  System.out.println("wordnet tag["+i+"] ="+tags[i]);
        if((tags[i].equals("NN") && tags[i+1].equals("NN")) || (tags[i].equals("NNP") && tags[i+1].equals("NN") )){
          k2pcount++;
      //    if(tags[i+1].equals("PSPO")){
           for(int s = 0 ; s < wordnetdata.length && !wordnetdata[i].equals("nl");s++){
           // System.out.println("wordnetdata["+s+"] ="+wordnetdata[s]);
            if(wordnetdata[s].equals("INSTRUMENT")){
                  k3exist = true;
                  System.out.println("k3exist="+k3exist);
            }
        ...
        if(tags[i].equals("VAUX") || tags[i].equals("VF")){
          System.out.println("new wordnet neg="+neg+"  transitive ="+transitive);
          for(int s = 0 ; s < wordnetdata.length;s++){
            System.out.println("wordnettag["+s+"] ="+wordnettag[s]+"  morphs["+i+"]="+morphs[i]);
           if(morphs[i].equals(wordnetdata[s]) && wordnettag[s].equals("NEG")){
                  neg = 1;
                  System.out.println("new neg="+neg);
            }
            if(morphs[i].equals(wordnetdata[s]) && wordnettag[s].equals("Transitive")){
                  transitive = 1;
                  System.out.println("new transitive="+transitive);
            }
            else if(transitive == 1){
                 // transitive = 0;
                  System.out.println("new non transitive="+transitive); 
            }
            if(morphs[i].equals(wordnetdata[s]) && wordnettag[s].equals("Intransitive")){
                  transitive = 2;
                  System.out.println("new transitive="+transitive);
            }
            else if(transitive == 2){
                 // transitive = 0;
                  System.out.println("new non transitive="+transitive); 
            }
          }
      ...
      //    if(tags[i+1].equals("PSPO")){
           for(int s = 0 ; s < wordnetdata.length;s++){
            ...
            if(morphs[i].equals(wordnetdata[s]) ){
              ...
              if(wordnettag[s].equals("INSTRUMENT")){
                  k3exist = true;
                  System.out.println("k3exist="+k3exist);
                }
                if(wordnettag[s].equals("TIME")){
                  k7texist = true;
                  System.out.println("k7texist="+k7texist);
                }
  ...
  for(int i = 0 ; i < tags.length ; i++){
    ...
    /* try{
       ...
       for(int i = 0 ; i < sentwords1.length ; i++){
          ...
          System.out.println("psp exist="+pspexist+"  psp position="+psppos);
          //}
          if(i>0 && pspexist == 1 && tags[psppos-1].equals("NN")){
            tags[psppos-1] = "VF";
          }
          System.out.println("tags["+(psppos-1)+"]="+tags[psppos]);
   ...
   System.out.println("first bat exist ="+batexist);
  Chunker ch =  new Chunker(noTags, morphs, tags, k2pexist, k7texist, ekoexist,ekaexist, ikaexist, batexist);
        N = ch.getNounChunks();
        TN = ch.getnountag();
        int oldi = 100;
        //nnlength = 1;
...
//              NP[i] =  N[i][j]  
  ...
  Vph= ch.getVerbChunks();
       ...
       vphtag = ch.getverbtag();
        ...
        //tgv = 0;
  System.out.println("verb chunk Lwg7 Vph["+0+"]["+0+"]="+Vph[0][0]+"    vphtag["+0+"]["+0+"]"+vphtag[0][0]);
    ...
    //    //System.out.println("nnlength = "+nnlength+"  tg="+tg);
       /*   //System.out.println("N.length="+len+"  N[0][0]="+N[0][0]+"  n["+0+"].LEN="+N[0].length);
        ...
        for(int i = 0 ; i < len; i++){
          ...
          try{
            nnlength = len;
            System.out.println("123456  NP["+i+"]="+NP[i]+"   noun phase["+i+"]="+nPhase[i]+"   tg="+tg+"   p in="+in+"   nnlength="+nnlength+"   ntstart["+i+"]="+ntstart[i]);
            if(nPhase[i].equals("RB") || nPhase[i].equals(" RB  ") || nPhase[i].equals(" RB ")){
          RBindex = i;
          System.out.println("RB index ="+RBindex);
        }
            if(tg > 1)
              nPhase[i]=NP[i];
          }
...
//  Final tags;
      ...
      // noVerbs= Vph.length;
       ...
       System.out.println(" kyahe WELCOME tags.len = "+tags.length+"   TAGS["+0+"]"+tags[0]+"  tg = "+tg);
       for(int l1 = 0;l1 < tags.length/2 ; l1++){
        if(tags[l1].equals("PSPLAI") && tg > 1){
           // decesion = 10; 
            laiindex = 2*l1;  
             System.out.println("sampradan decesion ="+decesion+"  lai index ="+laiindex);
          }
        }
      ...
      // int verblength = 1;
       ...
       int vblen1 = 0;
       System.out.println("333 vblength = "+vblength);
      // vblength = Verbs.length;
       try{
       for(int p = 0 ; p < vblength; p++){
          ...
          for(int q = 0 ; q < Verbs.length ; q++){
           ...
           // if(sentwords1[vblen1].equals("null")) vblen1 = vblen1-1;
            try{
            ...
            catch(NullPointerException ne){ vblen1 = vblen1-1;}
          }
          if((verbPosition[p]+1) != (verbPosition[p+1]) && Verbs.length >1 && pspexist == 0 && ekaexist == 0 && vmkoekoexist == 0 ){
...
//                count = count + 2;
        ...
        count++;
            ...
            //nllength = i;
            t.NPmain(nlsentence1[i], "ann.txt" ,"display.txt", wordnetfile, i, filename1, filename3);
      ...
      nonouns = nnlength;
          ...
          // vibhakti = t.findVibhakti(sentwords1,morphs, Vibhakti, nonouns,nouns);
           ...
           semifinalmatching = new int[1000][nnlength][nKarkas];
    ...
    // OUT OF 8 KARKAS 7 ARE CONSIDERED FOR PERMUTATION SAMBANDH (K6) IS REMOVED 
           ...
           System.out.println("factorial = "+fac+"  ntkarkas="+ntKarkas+"   nkarkas="+nKarkas+"  nnlength="+nnlength);
           int diff = 0;
           int tsum = 0;
           ...
           for(int i = 0 ; i < fac ; i++){
              for(int j = 0 ; j < nnlength ; j++){
                for(int k = 0 ; k < ntKarkas ; k++){
                 ...
                 // tsum = tsum + tsubgraphs[i][j][k];
                  //System.out.println("   tsum = "+tsum);
                 /* if(tsum <= (nnlength-1)){
                    diff = nnlength - tsum;
                    for(int p=i+diff+1 ; p<nnlength;p++)
                     tsubgraphs[i][p][k+diff] = 1; 
      ...
      System.out.println("g="+g+"  nKarkas="+nKarkas);
      int addentries=0;

      golden = new int[550][nnlength][nKarkas];
      egolden = new int[550][nnlength][nKarkas];
           for(int l = 0 ; l < Verbs.length ; l++){
                subgraphs = finalmaxMatchings;
             //  subgraphs = t.findsubGraphs(edges, nKarkas, nnlength, l, indexkarana);
             System.out.println("first k1snoun="+k1snoun);
          finalmatching = t.findfinalmatching(finalmaxMatchings, 5040, nnlength, nKarkas, indexkarta, indexkarana, NP, k1snoun, false);
          ...
          //  finalcountParse = 0;
           ...
           System.out.println("Semi parsed tree finalmatching finalmatching.length ="+finalmatching.length);
          System.out.println("Semi parsed tree finalmatching");
          for(int m = 0 ; m < finalmatching.length ;m++){
            for(int j = 0 ; j < nnlength ; j++){
                    for(int k = 0 ; k < nKarkas ; k++){
                      ////System.out.print("   "+ntsubgraphs[i][j][k]);
                      addentries++;
                      System.out.print("   "+finalmatching[m][j][k] );
                    }
                    System.out.println();
                  }
                  System.out.println(); 
          }
          System.out.println("generic marker k2p="+k2pexist+"    gereric marker k7t="+k7texist+"  number of parsed graphs g= "+g+"  nKarkas="+nKarkas);

          System.out.println("Semi parsed tree ");
          iteration = semifinalmatching.length;
        /*  if(k1sexist){
            iteration = 1;
            g=1;
          }*/
          if(g==0){
           eparsed = 1;
            for(int j = 0 ; j < nnlength ; j++){
              for(int k = 0 ; k < nKarkas ; k++){
                  if(j==k)
                    semifinalmatching[0][j][k] = 1;
              }
            }
          }
          else{
            System.out.println("special Semi parsed tree ");
          //  semifinalmatching = finalmatching;
          }
         ...
         // if(anncount < 18000)
          ...
          itct = 0;
            for(int j = 0 ; j < nnlength ; j++){
                    for(int k = 0 ; k < nKarkas ; k++){
                      ////System.out.print("   "+ntsubgraphs[i][j][k]);
                     // System.out.print("   "+golden[m][j][k] );
                      if(golden[m][j][k] == 1) itct++;
                    }
                   // System.out.println();
                  }
                  System.out.println();
                //  System.out.println("itct ="+itct);  
                  if(itct == nnlength){
                    itctbus = m;
                  //  System.out.println("itctbus ="+itctbus);
                  }
                  if(itctbus == m){
                    for(int j = 0 ; j < nnlength ; j++){
                       for(int k = 0 ; k < nKarkas ; k++){
                ...
                //  System.out.println("   k1s="+k1s+"   k7t="+k7t+"    k2p="+k2p+"     k3exist="+k3exist);
          }
           fout2.close();
        }
      ...
      //    golden = semifinalmatching;
        ...
        System.out.println("g="+g);
          if(g == 0 || g == 1){
            ...
            System.out.println("generic marker golden k7t exists");
           // golden = semifinalmatching;
            System.out.println("generic marker golden assignment k7t exists");
            for(int m = 0 ; m < iteration ;m++){
            for(int j = 0 ; j < nnlength ; j++){
                    for(int k = 0 ; k < nKarkas ; k++){
                      ////System.out.print("   "+ntsubgraphs[i][j][k]);
         ...
         //   g=iteration;
          ...
          //}
         // golden = semifinalmatching;
          System.out.println("Golden g="+g+"  k7texist="+k7texist+"  nKarkas"+nKarkas);
          try{
        ...
        //  }
            goldenfinal = golden;
          System.out.println("Golden final nKarkas="+nKarkas);
          //if(!k1texist){
         ...
         /* if(k1sexist){
          ...
          System.out.println(" outside  parsedindex=  "+parsedGraphindex+"   k5exist="+k5exist+"   nKarkas="+nKarkas+" laiindex ="+laiindex);
          System.out.println("Parsed Golden final");
          //if(!k1texist){
           System.out.println("  parsedindex=  "+parsedGraphindex);
            if(parsedGraphindex  != 100){
              for(int j1 = 0 ; j1 < nnlength ; j1++){
                    ...
                    if(!k7texist && finalend == 0)
                      displayString(filename3,goldenfinal,parsedGraphindex,nnlength,nKarkas,NP, false, getk1s(),0,k3exist, k5exist, k7tindex, noma, laiindex);
            }
          ...
          //  if(!k1texist)
              ...
              if(!k2pexist && !k7texist  && finalend == 0){
                displayString(filename3,golden,0,nnlength,nKarkas,NP, false, getk1s(),0, k3exist,k5exist, k7tindex, noma, laiindex);
              }
            }
          //}
          //else{
    ...
    finalsecondmatching = new int[iteration][nnlength][nKarkas];
    finalsemisecondsfm = new int[3*iteration][nnlength][nKarkas];
    int cnt = 0;
    System.out.println("iteration of nKarkas"+ nKarkas);
   /* for(int i = 0 ; i < iteration ; i++){
      for(int j=0;j<nnlength;j++){
        for(int k=0;k<(nKarkas+1);k++){
          finalsecondmatching[i][j][k] = 0;
        }
      }
    }*/
    ...
    if(finalcountParse == 0 && projective){
      ...
      System.out.println("CAP OF GOOD HOPE AGAIN iteration ="+iteration);
      ...
      for(int m = 0 ; m < 3*iteration ;m++){
        for(int j = 0 ; j < nnlength ; j++){
              for(int k = 0 ; k < nKarkas ; k++){
                    ...
                    fl = mm.getUniqueIncMatrix(m,nnlength,nKarkas,semisecondsfm);
      ...
      System.out.println("Extended second : nKarkas="+nKarkas);
    /*  try{
      for(int m = 0 ; m < 3*iteration ;m++){
      ...
      if(iteration == 0) {
        System.out.println("No check TAM ");
       // iteration = 1;
      }
      System.out.println("check check");
     /* for(int i = 0 ; i < iteration ; i++){
        System.out.println("check check iteration="+i);
      for(int j=0;j<nnlength;j++){
        for(int k=0;k<(nKarkas);k++){
          System.out.print("   "+finalsecondmatching[i][j][k]);
        }
        System.out.println();
      }
      System.out.println();
      System.out.println();
       ...
       System.out.println(" second previous final Iteration = "+finalsecondmatching.length+"  nnlength="+nnlength+ " nKarks+1 ="+nKarkas);
      finalsecondmatching = t.findfinalmatching(semisecondsfm, 3*iteration, nnlength, nKarkas, indexkarta, indexkarana, NP, k1snoun, true);
      int splindex = 0;
     // nKarkas = krks;
     // try{
     /* for(int i = 0 ; i < iteration ; i++){
     ...
     /* for(int i = 0 ; i < iteration ; i++){
      ...
      for(int m = 0 ; m < finalsecondmatching.length ;m++){
         System.out.println();
        System.out.println("final Iteration = "+m+"  nnlength="+nnlength+ " nKarks+1 ="+nKarkas);
        for(int j = 0 ; j < nnlength ; j++){
              for(int k = 0 ; k < (nKarkas) ; k++){
                splindex = 1;
             //    System.out.print("m="+m+"   j="+j+"  k="+k);
   ...
   // }
     // catch(ArrayIndexOutOfBoundsException ae2){}
      ...
      //if(!k7texist ){
        eparsedGraphindex = getparsedGraph1(finalsecondmatching , Actualvibhaktilist, iteration, nnlength, nKarkas, getk1s(),k7texist, k2pexist,k7tindex,k2pindex);
      //}
      //else{
      //  eparsedGraphindex = 100;
      //}
        //System.out.println("Extended Parsed Golden final");
      /*  if(eparsedGraphindex == 0) {
          eparsedGraphindex = 1;
          eparsed = 1;
        }*/
        System.out.println("eparsed graph index="+eparsedGraphindex);
          //if(!k1texist){
          if( eparsed == 1) {          // when there is no parsed matrix then identity matrix
            eparsedGraphindex = 0;
            finalsecondmatching = semifinalmatching;
          }
          /*else{
            eparsedGraphindex = 0;
            finalsecondmatching = goldenfinal;
          }*/
          /*if( eparsedGraphindex == 0 && splindex == 1){
            ...
            if(eparsedGraphindex  != 100){
              for(int j1 = 0 ; j1 < nnlength ; j1++){
                    ...
                    //eparsedGraphindex = eparsed;
                    System.out.println("splindex="+splindex+"  parsed index="+eparsedGraphindex+"  k7tindex="+k7tindex);
                    if(finalsecondmatching[eparsedGraphindex][0][0] == 1  && finalend == 0)
                        displayString(filename3,finalsecondmatching,eparsedGraphindex,nnlength,nKarkas,NP, true, getk1s(),splindex, k3exist, k5exist, k7tindex, noma, laiindex);
                    else
                        displayString(filename3,finalsecondmatching,eparsedGraphindex,nnlength,nKarkas,NP, true, getk1s(),splindex,k3exist, k5exist, k7tindex, noma, laiindex);
            }
          ...
          //  if(!k1texist)
              //System.out.print("  parsedindex=  "+0);
              System.out.println("1 splindex="+splindex);
              if(!k2pexist && !k7texist  && finalend == 0){
                displayString(filename3,finalsecondmatching,0,nnlength,nKarkas,NP, true, getk1s(), splindex,k3exist,k5exist, k7tindex, noma, laiindex);
              }
            }
     ...
     //  for(int l1 = 0 ; l1 < Verbs.length ; l1++){
      ...
      /* for(int b=0;b<duplicate.length;b++){
       ...
       if(projective){
          ...
          System.out.println("bhosdina nlen="+nlen);
          System.out.println("display string duplicate matris:");
          for(int l = 0 ; l < nnlength ; l++){
            for(int m = 0 ; m < nKarkas ; m++){
              System.out.print("  "+duplicate[l][m]);
             // fout.write("  "+duplicate[l][m]);
            }
            System.out.println();
          }
        //  fout.close();
        //  if(lol ==0)
         intramatrix = t.intrachunk(NNP,TTNP,duplicate,nlen, Verbs, filename, filename1, output, Words,filename3);
  }
  ...
  //}
   ...
   public static void NPmain1(String[] np1, String args, String args1, String args2, int index1)throws IOException {
    ...
    public static void NPmain(String[] np1, String args, String args1, String args2, int index1, String filename1, String filename3)throws IOException 
   {
       String glyph = "\u0926\u0947\u0916\u093F";
       int nonouns = 0;

       System.out.println("Welcome to NPmain non projective");
       //String[] presence = new String[];
    String[] tagset = {"NN","NNP","NST","PRP","PRL","PRF","JJ","VF","VINF","VAUX","VMNE","VMKO","VMO","DM","DMR","DMD","DMI","RB","PSPLE","PSPLAI","PSPKO","PSPO","CCD","CCS","HRU","QW","CL","INJ","INTF","QTC","QTO","RDF","RP","DT","UNK","PUNC","AB","ALPH","SYM"};
       //String[] tagset = {"NN","NNP","PP","PP$","PPR","DM","DUM","VBF","VBX","VBI","VBNE","VBKO","VBO","JJ","JJM","JJD","RBM","RBO","INTF","PLE","PLAI","PKO","POP","CC","CS","UH","CD","OD","HRU","QW","CL","RP","DT","UNW","FW","YF","YM","YQ","YB","FB","SYM","STOP"};
      // for(int i = 0 ; i < totaltag ; i++)
...
//       Actualvibhaktilist = new String[10];
       ...
       System.out.println("bat exist ="+batexist);
       Chunker ch =  new Chunker(noTags, morphs, tags, k2pexist, k7texist, ekoexist, ekaexist,ikaexist, batexist);
       int nnlength = 0;
       int temp = 0;
       int nttg = 0;
...
//              NP[i] =  N[i][j]  
           ...
           //}
            System.out.println("123456 *NP["+i+"]="+NP[i]+"   TNP["+i+"]="+TNP[i]+"   tp1="+tp1);
            nPhaseInd[i] = tg;
...
//  Final tags;
      ...
      //System.out.println("hi");
          ...
          if(tags[l].equals("PSPLAI")){
            laiindex = l;
            System.out.println("laiindex ="+laiindex);
          }
       }
       }
  catch(NullPointerException nullPointer){}
    ...
    // OUT OF 8 KARKAS 7 ARE CONSIDERED FOR PERMUTATION SAMBANDH (K6) IS REMOVED 
      ...
      egolden = new int[150][nnlength][nKarkas+1];
           for(int l = 0 ; l < Verbs.length ; l++){
                subgraphs = finalmaxMatchings;
               //subgraphs = t.findsubGraphs(edges, nKarkas, nnlength, l, indexkarana);
                System.out.println("Third k1s ="+k1snoun);
        ...
        //  }
          ...
          //}
          //if(!k7texist){
            parsedGraphindex = getparsedGraph1(golden, Actualvibhaktilist, g-1, nnlength, nKarkas, getk1s(),k7texist, k2pexist,k7tindex, k2pindex);
          //}
          //else{
          //  parsedGraphindex = 100;
          //}
          ...
          //if(!k1texist){
            if(parsedGraphindex  != 100){
              for(int j1 = 0 ; j1 < nnlength ; j1++){
                    ...
                    if(!k7texist  && finalend == 0)
                      displayString(filename3,golden,parsedGraphindex,nnlength,nKarkas,NP, false, getk1s(),0,k3exist, k5exist, k7tindex, noma, laiindex);
            }
    ...
    if(finalcountParse == 0 && projective){
      ...
      for(int m = 0 ; m < 3*iteration ;m++){
        for(int j = 0 ; j < nnlength ; j++){
              ...
              //  for(int i = 0 ; i < (nnlength-(nKarkas+1)) ; i++){
                  //for(int j1= 0 ; j1 < (nKarkas+1) ; j1++){
                    System.out.println("Hi it is unique iteration ="+cnt);
                    if(cnt < 300){
                      if(cnt< (iteration)){
                        finalsemisecondsfm[cnt][j][k] = semisecondsfm[m][j][k];
                      System.out.println("  finalsemi["+cnt+"]["+j+"]["+k+"]  "+finalsemisecondsfm[cnt][j][k]);
      ...
      System.out.println("Fourth k1s="+k1snoun);
      finalsecondmatching = t.findfinalmatching(semisecondsfm, 3*iteration, nnlength, nKarkas, indexkarta, indexkarana, NP, k1snoun, true);
      for(int m = 0 ; m < finalsecondmatching.length ;m++){
      ...
      //}
        ...
        //System.out.println("eparsed graph index="+eparsedGraphindex);
          //if(!k1texist){
            if(eparsedGraphindex  != 100){
              for(int j1 = 0 ; j1 < nnlength ; j1++){
                    ...
                    if(finalend == 0)
                    displayString(filename3,finalsecondmatching,eparsedGraphindex,nnlength,nKarkas,NP, true, getk1s(),0,k3exist, k5exist, k7tindex, noma, laiindex);
            }
          ...
          //  if(!k1texist)
              //System.out.print("  parsedindex=  "+0);
              if(!k2pexist && !k7texist  && finalend == 0){
                displayString(filename3,finalsecondmatching,0,nnlength,nKarkas,NP, true, getk1s(),0,k3exist, k5exist, k7tindex, noma, laiindex);
              }
            }
      //displayString(filename,egolden,g-1,nnlength,nKarkas+1,NP, true, getk1s());
    }
     ...
     //  for(int l1 = 0 ; l1 < Verbs.length ; l1++){
       ...
       if(projective){
         ...
         if(index1 ==0){
            ...
            intramatrix = t.intrachunk(NP,TNP,duplicate,nnlength, Verbs, filename, filename1, output, mainWords,filename3);
         }
         else{
           intramatrix = t.intrachunk1(NP,TNP,duplicate,nnlength, Verbs, intramatrix, filename, output, mainWords);
         }
  }
  ...
  System.out.println("g="+g+"  a="+a+"    b="+b+"    c="+c+"   k1s="+k1s+"   k7t="+k7t+"    k2p="+k2p+"     k7tind="+k7tind+"   k2pind="+k2pind+"  TEMP="+temp.length);
    for(int m1 = 0 ; m1 < g ;m1++){
      for(int j1 = 0 ; j1 < b ;j1++){
        for(int n1 = 0 ; n1 < c ;n1++){
          System.out.println("m1="+m1+"   j1="+j1+"   n1="+n1);
         //  System.out.println(" before k2p n1 ="+n1+"  temp["+m1+"]["+k2pind+"]["+n1+"]="+temp[m1][j1][n1]);

          if(temp[m1][j1][n1] == 1 && temp[m1][0][2] != 1){
            if(c >8 ){
              if(k1s){
                if(gu[m1][0][0] == 1)
                  return m1;                
            ...
            //if(temp[m1][j1][0] == 1){
              if(n1 == 8 && temp[m1][j1][n1] == 1 && temp[m1][0][2] != 1){
                if(k7t){
                 // try{
            ...
            //}
            // try{
              System.out.println(" k2p n1 ="+n1+"  temp["+m1+"]["+k2pind+"]["+n1+"]="+temp[m1][j1][n1]);
          //  if(n1==7 && temp[m1][j1][n1]  == 1){
              if(k2pind < b && k2p && n1 == 7 && temp[m1][0][2] != 1){
                if(temp[m1][k2pind][n1] == 1 ){
                  System.out.println("m1 for k2p is"+m1);
                 // if(b == 2){
...
//        wordnetfile = wordnet;
        ...
        try {
            ...
            String tempVF = "hari";
            String[] twd = new String[300];   // check verb vibhakti
            int not = 0;
            noma = 0;
                ...
                for(int i = 1 ; i < counterc  ; i++){
                  ...
                  //for(int j = 0 ; j < verbs.length ; j++){
                    if(i%2 == 0 ){
                      ...
                      if(twd[i].equals("QTC")){
                        QTCexist = i;
                        System.out.println("chalo twd["+i+"]"+twd[i]+" and QTCexist ="+QTCexist);
                      }
                      if((twd[i].equals("NN") || twd[i].equals("NNP")) && (!twd[i+2].equals("PSPLE") || !twd[i+2].equals("PSPLAI"))){
                          System.out.println("mummy mari chhe");
                          noma = 0;
                      }
      ...
      StringTokenizer st = new StringTokenizer(line);
                while (st.hasMoreTokens()) {
                     ...
                     // flag = 0;
                            ...
                            if(ekaexist == 1){
                              System.out.println("3333 ws["+counter+"]="+ws);
                             // ws = "VF";
                          //    ekaexist = 0;
                            }
                        //    ws1 = st.nextToken();
                            ...
                            if(flag8 == 2){
                              if(!ws.equals("NN") && !ws.equals("PRL") && !ws.equals("PRP")){
                                  ws = "NN";
                              }
                            }
                            ...
                            if(ws.equals("HRU") && counter%2 == 0){
                                pluralharu = 1;
                                System.out.println("Plural Haru="+pluralharu);
                            }
               ...
               // }
                  ...
                  sws[0] = "ab";
                     ...
                     if( flag1 == 2){
                        words[nowords] = sws[0];
                        laiindex = nowords;
                        System.out.println("Lai index laiindex ="+laiindex);
                  ...
                  //        words[nowords+1] = ws;
                    ...
                    System.out.println("dgindex="+dgindex+"  counter="+counter);
                     ...
                     if( flag6 == 2 ){
                        ...
                        if(nowords > 8){
                          ekoexist = counter;
                           vmkoekoexist = ekoexist;
                           System.out.println("vmko eko exist ="+vmkoekoexist);
                        }
                        else
                          ekoexist = 0;
                      if(dgindex <2){
                     ...
                     if( flag9 == 2 && counter%2 == 0 ){
                          ...
                          //  if(dgindex != counter )
                              sws = RegionMatchesDemoLai("\u090f\u0915\u093e", ws);
                               System.out.println("Projective CHECK FOR eka SWS["+0+"]="+sws[0]);
                       if(sws[0].equals(null)){
                        System.out.println("inside Projective CHECK FOR eka ");
                        sws[0] = "ab";
                  ...
                  //        words[nowords+1] = ws;
                    ...
                    System.out.println("words["+(nowords+2)+"]="+words[nowords+2]);
               //     if(ws == "VF"){
                 //     words[]
                   // }
                   int flagsampradan = 0;
                  ...
                  sws[0] = "ab";
                     ...
                     if( sws[0].equals("ab"))
                       flag4 = 0;
                        ...
                        flag4 = 2;
                       System.out.println(" Projective CHECK FOR ika ikaexist="+ikaexist);
                      sws = RegionMatchesDemoika("\u093f\u0915\u093e\u0020", ws);
                   //   if(sws[0].equals())
                     //  ikaexist = 1;
                      System.out.println(" again Projective CHECK FOR ika ikaexist sws[0]="+sws[0]);
                        if(sws[0].equals(null) ){
                          sws[0]= "ab";
                          
                         
                        }
                        else if(!sws[0].equals("ab") && ikaexist == 100){
                          ikaexist = counter/2;
                          System.out.println("deep inside Projective CHECK FOR ika ikaexist ="+ikaexist);
                        }
                      //}
                     // for(int i = 0 ; i < 1 && flag == 1 ; i++){
                     if( flag4 == 2){
  ...
  /*                   String temp = "ab";
                ...
                /*     if(dgindex == 0 && flag3 == 2 && flagsampradan != 0){
                  ...
                  //        words[nowords+1] = ws;
                     ...
                     if( flag8 == 2 && counter%2 == 0 ){
                          ...
                          //System.out.println("wd["+(nowords-3)+"]="+words[nowords-3]);
                            ...
                            System.out.println("dgindex="+dgindex+"  counter="+counter+"  flag8="+flag8);
                            if(dgindex != counter && not == 0){
                              sws = RegionMatchesDemoLai("\u0939\u0930\u0941", ws);
                        ...
                        sws[0] = "ab";
                     System.out.println("sws["+0+"]="+sws[0]+"  sws[1]="+sws[1]+"  not="+not);
                     if(sws[0].equals("ab") ){
                  ...
                  //        words[nowords+1] = ws;
                   ...
                   System.out.println("Projective CHECK FOR Bat ");
                     ...
                     if( flag10 == 2 && counter%2 == 0 ){
                                words[nowords-3] = ws;
                          //System.out.println("wd["+(nowords-3)+"]="+words[nowords-3]);
                            }

                            System.out.println("dgindex="+dgindex+"  counter="+counter+"  flag10="+flag10);
                            if(dgindex != counter ){
                              sws = RegionMatchesDemoLai("\u092c\u093e\u091f", ws);
               ...
               if(k2exist == 0 )
                    ...
                    // int swsko = getnegation2("\u0915\u094b",ws);
                     //System.out.println(" ko exist ",+swsko);
                     
                     
                     System.out.println("flag="+flag+"  flag1 = "+flag1+"   flag2 ="+flag2+"    flag3="+flag3+"   flag4="+flag4+"  flag8="+flag8+"  flag5 ="+flag5+"  flag6 ="+flag6+"   flag7 = "+flag7+"  flag8 ="+flag8+" flag9="+flag9+"  flag10="+flag10+"  nowords="+nowords+"  alaram = "+alaram);
                     //flag8=0;
                      if(flag == 0 && flag1 == 0 && flag2 == 0 && flag3 == 0 && flag4 == 0 && flag5 == 0 && flag6 == 0 && flag7 == 0 && flag8 == 0 && flag9 == 0 && flag10 == 0 && alaram == 0){
                            //  if(not == 0)
                                  words[nowords]=ws;
                              System.out.println("**wd["+(nowords)+"]="+words[nowords]);
                              nowords++;
                      }
                      else if(flag == 0 && flag1 == 0 && flag2 == 0 && flag3 == 0 && flag4 == 0 && flag5 == 0 && flag6 == 0 && flag7 == 0 && flag8 == 0 && flag9 == 0 && flag10 == 0 ) {
                            //  if(not == 0)
                              alaram = 0;
                      }
                 }
       ...
       //     }
          ...
          System.out.println("nowods="+nowords+"  VFexist ="+VFexist);
             for(int i = 0 ; i < nowords; i++){
                  if(VFexist  != 0 && ekoexist != 0){
               ...
               //fout.write("\n **********************************************   ");
                ...
                for(int i = 0 ; i < nowords; i++){
                  ...
                  System.out.println("ekoexist="+ekoexist+"   words["+i+"]="+words[i]+" bat exist ="+batexist);
                  if(i< (nowords-2) ){
                      System.out.println("prior prior word["+i+"]="+words[i]);
                      if(words[i].equals("PSPKO")){
                        ekoexist = i;
                      }
                      System.out.println("ekoexist="+ekoexist+"   words["+i+"]="+words[i]);

                    if(words[i].equals("VF")){
                      System.out.println("prior word["+i+"]="+words[i]);
                     if(words[i+2].equals("PSPO")){
                        words[i] = "NN";
                        System.out.println("word["+i+"]="+words[i]);
                      }
                      if(words[i+2].equals("BAT") || batexist != 0){
                        words[i] = "NN";
                        System.out.println("BAT word["+i+"]="+words[i]);
                      }
                    //}
                  //}
                    else{
                        System.out.println("1 could not word["+i+"]="+words[i]);
                      }
                      System.out.println("2 could not word["+i+"]="+words[i]);

                    }
                    System.out.println("3 could not word["+i+"]="+words[i]);

                  }

                    if(ekoexist == 1 && words[i].equals("VF") &&  words[i+2].equals("NN") ){
                        if(words[i+4].equals("PSPO") || words[i+4].equals("PSPLAI")){
                          words[i] = "JJ";
                         // not = 0;
                      }
                  }
          ...
          int wordct = 0;
          try{
          for(int c=0;c<mainWords.length;c++){
            if(!mainWords[c].equals(null)){
            System.out.println("123 newsentwords["+c+"]="+mainWords[c]);
              wordct = c;
          }
          }
        }
        ...
        //  int crt = 0;
          ...
          System.out.println("123 nowords="+nowords);
          for(int i = 0 ; i < nowords ; i++){

                if(i %2 == 0){
                  sentwords[j] = words[i];
                  System.out.println("123 sentwords["+j+"]="+sentwords[j]);
       ...
       /* System.out.println("ekoexist="+ekoexist+"   words["+(nowords+3)+"]="+words[noWords+3]);
                    if(ekoexist == 1 && words[].equals("NN")){
                          words[nowords+1] = "JJ";
                         // not = 0;
                      }*/
...
//      int psnverb;
  ...
  //  ReadXMLFile xm = new ReadXMLFile();
   ...
   //   f2.readFile1(wordnetfile);
        ...
        //k2pindex = k2pindex - 1;
        System.out.println("k2pindex="+k2pindex+"  words length ="+noWords+"  gm="+gm);
        k7tindex = f2.getk7tindex();
        if(gm.equals("TIME") && noWords > 6 ){
          k7texist = true;
          k2pexist = false;
        }
        System.out.println("k7tindex="+k7tindex+"  words length ="+noWords+" k7texist="+k7texist+"  k2pexist ="+k2pexist);
        if(gm.equals("PLACE")){
          k2pexist = true;
        }
        if(gm.equals("INSTRUMENT")){
          k3exist = true;
          System.out.println("k3exist="+k3exist);
        }
        if(ind == 5){
      ...
      System.out.println("index = "+ind+"  direct krk"+directkrk+"   k7texist="+k7texist+"     k2pexist="+k2pexist+"  k3exist="+k3exist);
      if(ind != -1){
  ...
  String prsk7;
      ...
      // Check Karta (K1) Subjective or Nominative or Ergative Case
            ...
            if(prsk1.equals("Mendatory") || prsk1.equals("Optional") ){
                    ...
                    for(int l = 0 ; l < trows ; l++){
                      ...
                      System.out.println("Actualvibhakti["+t+"]="+Actualvbt);
                          ...
                          if(Actualvibhaktilist[t].equals(tvbt[i]) || Actualvibhaktilist[t].equals("\u092C\u093E\u091F")){
                            ...
                            if(tg[0][l][0] == 1 && ct1 == 1 ){    // 0th col for karta K1 of the final subgraph
                              ...
                              System.out.println("karta count ="+ count+" ct1="+ct1);
                              if(count == 1){
                  ...
                  System.out.println("   tvbt["+i+"]="+tvbt[i]+"  trows="+trows+"  ct1="+ct1);
                    ...
                    try{
                          ...
                          if(Actualvibhaktilist[t].equals(tvbt[i]) || Actualvibhaktilist[t].equals("\u092C\u093E\u091F")){
                            ...
                            if(tg[0][l][1] == 1 && ct2 == 1 ){    // 0th col for karta K1 of the final subgraph
                              if(Actualvibhaktilist[t].equals(tvbt[i]))
                                count++;
                     ...
                     // System.out.println("Actualvibhakti("+l+")="+Actualvibhaktilist[l]);
                       try{
                          ...
                          if(Actualvibhaktilist[t].equals(tvbt[i]) ){
                            ...
                            System.out.println("**********karana(k3)");
                            for(int l = 0 ; l < trows ; l++){
                                    System.out.println("tg[0]["+l+"]["+2+"]="+tg[0][l][2]);
                            if(tg[0][l][2] == 1 && ct3 == 1){    // 0th col for karta K1 of the final subgraph
                              if(Actualvibhaktilist[t].equals(tvbt[i]))
                                count++;
              ...
              if(krrk5.equals("Apadan(K5)")){
                ...
                vbtk5 = vibh[4][2];
                  ...
                  for(int i = 0 ; i < tvbt.length && t < trows; i++ ){
                    ...
                    try{
                    for(int l = 0 ; l < Actualvibhaktilist.length  ; l++){
                      System.out.println("**Actualvibhakti["+t+"]="+Actualvibhaktilist[t] +"   t="+t);
                    //  try{
                        if(count == 0 || Actualvibhaktilist[t].equals(tvbt[i]) && ct5 == 0){
                          ...
                          System.out.println("Apadan count ="+ count+"  ct5="+ct5);
                  //if(vbtk1.equals("\u0932\u0947") || vbtk1.equals("\u0915\u094B") || vbtk1.equals("null")   || vbtk1.equals("\u0932\u093E\u0908")){
                  for(int k = 0; k < trows ; k++){
                      ...
                      catch (NullPointerException nullPointer){ System.out.println("Apadan Null pointer");}
                      if(count == 1){
...
//                            }
      ...
      // Check Location (K7t) Optional
          if(ext){
            ...
            System.out.println("flagk1= "+flagk1+"   flagk2="+flagk2+"    flagk3= "+flagk3+"  flagk4= "+flagk4 +"      flagk5=  "+flagk5+  "     flagk6="+flagk6+  "      flagk7="+flagk7+  "     flagk2p="+flagk2p+   "  flagk7t="+flagk7t+    "    trows="+trows+" count="+count);
            flgk[0] = flagk1;
            flgk[1] = flagk2;
            flgk[2] = flagk3;
            flgk[3] = flagk4;
            ...
            //int iteration = 0;
            int[][][] semifinal;
            System.out.println("ct1="+ct1+" ct2="+ct2+" ct3="+ct3+" ct4="+ct4+" ct5="+ct5+" ct6="+ct6+" ct7="+ct7+" ct8="+ct8+" ct9="+ct9+" ct10="+ct10);
            int semicountnull = ct1 + ct2 + ct3 + ct4 + ct5 + ct6 + ct7 + ct8 + ct9 + ct10;
            ...
            if(ext){
             ...
             System.out.println(" ct0="+ct+"   trows="+trows+" semicountnull= "+semicountnull+" count="+count);     
        ...
        //      }
            ...
            System.out.println(" ct="+ct+"   trows="+trows+" semicount1="+semicount1+"  semicount ="+semicount+" count="+count);
            if(flg1)
...
//            break;
 ...
 /*   public String getPresence(int inx , ReadXMLFile f3){
  ...
  try{
    ...
    public static void displayString(String outputName2, int[][][] fg1,int ind, int rows, int krks, String[] nn, boolean e, boolean k1s, int splind, boolean k3ex, int k5ex, int k7tex, int nma, int laiind){
    try{
        OutputStreamWriter writer = new OutputStreamWriter(new FileOutputStream(outputName2, true), "UTF-8");
          BufferedWriter fout = new BufferedWriter(writer);
          System.out.println("transitive ="+transitive+"  k7tindex ="+k7tex+" noms mummy ="+nma+"  lai index ="+laiind);
           System.out.println("before wecome to duplicate matris :");
          ...
          if(k5ex == 0 && fg1[ind][0][6] == 1 && !k2pexist && !k7texist){
            System.out.println("Mummi le k5");
              fg1[ind][0][0] = 1;
              fg1[ind][0][6] = 0;
          }
         // if(k5ex != 0 )
          if(nma != 0 && rows > 1 && !k2pexist && !k7texist){
            if(fg1[ind][1][1] == 1){
              System.out.println("Mummi ma");
              fg1[ind][1][6] = 1;
              fg1[ind][1][1] = 0;

            }
          }
          if(transitive == 2 && k7tex == 100 ){
            for(int c=0;c<rows;c++){
              //if()
              fg1[ind][c][1] = 0;
              System.out.println("transitive ="+transitive+"   No karma");
            }
          }
          if(k7tex != 100 && rows > 1 && laiind != 2){
            System.out.println("transitive ="+transitive+"   No karma"+"  k7tex="+k7tex+"  rows="+rows);
           // if(k7tex > rows) k7tex = rows-1;
            for(int c=0;c<krks ;c++){
                if(k7tex > 1){
                    fg1[ind][k7tex-2][c] = 0;
               ...
               //   fg1[ind][k7tex+1][c] = 0;
                ...
                System.out.println("fari transitive ="+transitive+"   No karma"+"  k7tex="+k7tex+"  rows="+rows);
                if(k7tex > 1){
                  fg1[ind][k7tex-2][8] = 1;
                }
                else
          ...
          System.out.println("wecome to duplicate matris :");
          if(k2pexist && k2pindex < rows){
            fg1[ind][k2pindex][7] = 1;
            for(int c=0;c<rows;c++){
              //if()
              fg1[ind][c][1] = 0;
              System.out.println("transitive ="+transitive+"   k7t");
            }
          ...
          System.out.println("are kya K7t"+k7texist);
...
//      krks = krks + 1;
    ...
    int ctrw = 0;
          System.out.println("Hi its displaystring ");
           System.out.println("k1s= "+k1s+" ind="+ind+"  rows="+rows+"  krks="+krks+"  k5exist"+k5ex+"  k2exist ="+k2exist+"  ctrw="+ctrw+"  rows="+rows);
           if(k5ex == 1 &&  rows > 1){
            fg1[ind][1][4]=1;     // K5 exist 
           }

           System.out.println("Lai index ="+laiind);
           if(laiind == 2){
              fg1[ind][0][0] = 0;
              fg1[ind][0][3] = 1;
           }
            if(rows > 2 && laiind > 2 && laiind != 100 && fg1[ind][1][1] == 1){
              System.out.println("K4 entered and K2 removed");
              fg1[ind][1][1] = 0;
              fg1[ind][1][3] = 1;
              fg1[ind][2][2] = 0;
              fg1[ind][2][1] = 1;
         ...
         //  if(k7texist) fg1[ind][0][0] = 1;
           if(k2exist == 1 && fg1[ind][0][0] == 1  && transitive == 1){  // Projective but two verb exist
           ...
           if(k2exist == 1 && fg1[ind][0][0] == 1 && fg1[ind][1][1] != 1 &&  transitive != 1){
            //System.out.println("yes karma exist");
            fg1[ind][0][1] = 1;
            fg1[ind][0][0] = 0;
           }
           if(rows > 1 && k5exist == 1 && fg1[ind][1][1] == 1){
            //System.out.println("yes karma exist");
            System.out.println("K5 entered and K2 removed");
            fg1[ind][1][4] = 1;
            fg1[ind][1][1] = 0;
           }
           if(rows > 2 && fg1[ind][1][1] == 1 && fg1[ind][2][2] == 1 && k3ex){
                System.out.println("K3 entered and K2 removed");
                fg1[ind][1][2] = 1;
                fg1[ind][1][1] = 0;
                fg1[ind][2][1] = 1;
                fg1[ind][2][2] = 0;
              ...
              if(rows == 1){
                if(QTCexist != 100 && fg1[ind][0][0] == 1){
                  System.out.println("K2 entered and K1 removed");
                  fg1[ind][0][0] = 0;
                  fg1[ind][0][1] = 1;
            }
              }
          ...
          // if(k7texist){
           ...
           if(k2pexist){
                        ...
                        for(int i = 0 ; i < rows ; i++){
                          if(fg1[ind][i][3] == 1 ){
                            ...
                            for(int j1 = 0 ; j1 < rows ; j1++){
                              ...
                              if(j1 != i && fg1[ind][j1][7] == 1){     // index 7 is for K2p
                                fg1[ind][j1][7] = 0;
                                fg1[ind][j1][1] = 1;
                                System.out.println("*fg1["+ind+"]["+j1+"]["+7+"]="+fg1[ind][j1][7]+"   i="+i);
              ...
              System.out.println("rows="+rows+" krks ="+krks+" ind ="+ind);
                for(int i = 0 ; i < rows ; i++){
                  for(int j = 0 ; j < krks ; j++){
                      System.out.print("  "+fg1[ind][i][j]);
        ...
        /*  if(k2pexist ){
         ...
         // do{
          ...
          for(int m = 0 ; m < krks ; m++){
            ...
            if(!k2pexist && !k1s && !e && rows>2 ){
             ...
             /* if(duplicate[1][2] == 1 && duplicate[2][1] == 1 ){
                System.out.println("Sampradan added instead of K3");
                duplicate[1][3] = 1;
                duplicate[1][2] = 0;
              }*/
                //fout.write("         "+0);
         ...
         // fout.close();
          ...
          if(transitive == 2 && k7tex == 100){    // No k7t
            for(int c = 0 ; c < rows ;c++){
              duplicate[c][1] = 0;

            
              System.out.println("duplicate [1][1]="+duplicate[c][1]);
            }
            duplicate[0][0] = 1;
          }
          System.out.println("RBindex ="+RBindex);
          if(RBindex != 0 && rows > 2 && k7texist){
          /*  if(duplicate[RBindex][8] != 1 ){
                    //  if(l == RBindex){
                        duplicate[RBindex][8] = 1;
                    //    duplicate[RBindex+1][8]
                        
                  //    }
                }*/
            for(int l = 0 ; l < rows ; l++){
             for(int m = 0 ; m < krks ; m++){
                  if(duplicate[RBindex][m] == 1){
                    if(m != 8){
                      duplicate[RBindex][8] = 1;
                      duplicate[RBindex][m] = 0;
                      duplicate[RBindex+1][m] = 1;
                      duplicate[RBindex+1][8] = 0;
                    }
                  }
          ...
          for(int a = 0 ; a < rows ; a++){
           ...
           System.out.println("ctrw addone= "+ctrw);
           if(ctrw < rows){
            addone = true;
           }
           else{
          ...
          System.out.println("display string duplicate matris:");
          for(int l = 0 ; l < rows && entrymatris == 0 ; l++){
            for(int m = 0 ; m < krks ; m++){
              System.out.print("  "+duplicate[l][m]);
           //   fout.write("  "+duplicate[l][m]);
            }
...
public int[][] intrachunk(String[] np, String[] tnp, int[][] duplicateparse, int ln, String[] vb, String filename, String filename1, String out, String[] sent, String filename3){
    ...
    //  int[][] npfinal = new int[15][16];
     ...
     // Picture pc = new Picture(300,300);
      ...
      for(int i = 0 ; i < vb.length;i++){
        System.out.println(" 1234 vb["+i+"]="+vb[i]);
      }
      ...
      int oldi = 0;
      int ftk = 0;
      int[] chunkinfo  =  new int[tags.length];
     // chunkinfo = NP;
...
//      int fugee = 0;
      ...
      String[] parserelation = new String[100];
      for(int s=0;s<sent.length;s++){
        System.out.println("12345 sent["+s+"]="+sent[s]);
      }
      for(int m = 0 ; m < 100 ; m++)
        parserelation[m] = "next";
      
      System.out.println("k2pexist = "+k2pexist+"   k3exist="+k3exist+"  k5exist"+k5exist+"  duplicate length="+duplicateparse.length);

      //sw = np;
    //  extduplicate = duplicateparse;
      System.out.println("duplicate parse MATRIS");
      for(int m = 0 ; m < duplicateparse.length;m++){
       for(int n = 0 ; n < duplicateparse[0].length;n++){
           //  System.out.println();
            System.out.print("   "+duplicateparse[m][n]);
         }
         System.out.println();
        }
     /*   for(int m = 0 ; m < duplicateparse.length;m++){
       for(int n = 0 ; n < duplicateparse[0].length;n++){
           //  System.out.println();
          if(duplicateparse[m][n] == 1){
            parserelation[parcnt] = relation[n];
            System.out.print(" parserelation["+parcnt+"]  "+parserelation[parcnt]);
            parcnt++;
  ...
  //        fugee = 1;
    ...
    //  swcount++;
    //}
                System.out.println("input string words separated by whitespace: " + sw[0] +"    "+tsw[0]); 

     // System.out.println("duplicateparse[1][2]="+duplicateparse[1][2]+"  duplicateparse[2][1]="+duplicateparse[1][2]+"  tsw[0]="+tsw[0]);
     System.out.println("Transitive");
    try{
    if(!k3exist && np.length >1 && duplicateparse[1][2] == 1 && duplicateparse[2][1] == 1 && tsw[1].equals("PSPLAI") && nouse==0){
                System.out.println("Sampradan added instead of K3");
                duplicateparse[1][3] = 1;
                duplicateparse[1][2] = 0;
                nouse = 1;
              }
   // if(laiindex)
     /* if(!k3exist && np.length >1 && duplicateparse[0][0] == 1  && tsw[0].equals("PSPLAI") && nouse==0){
                System.out.println("Sampradan added instead of K1");
                duplicateparse[0][3] = 1;
                duplicateparse[0][0] = 0;
                nouse = 1;
              }*/
    ...
    //try{
        ...
        System.out.println("k2p="+k2pexist+"  k7texist="+k7texist+" lai index ="+laiindex);
        if((laiindex != 100 && laiindex <3 ) && transitive == 1 && !k2pexist && !k7texist && k5exist == 0 && !k1sexist){
          System.out.println("Sentence is transitive");
          for(int s=0;s<np.length && ekaexist == 0 ;s++){
                   System.out.println("because Sentence is transitive");
                   duplicateparse[1][s] = 0;
                }
                duplicateparse[1][1] = 1;
                
        }


        if(transitive == 2 && !k2pexist && !k7texist && k5exist == 0){
          System.out.println("Sentence is Intransitive");
         // for(int s=0;s<np.length;s++){
                   System.out.println("because Sentence is Intransitive");
                   duplicateparse[1][1] = 0;
                   duplicateparse[1][0] = 1;
             //   }
               // duplicateparse[1][1] = 1;

        }
        }
        catch(NullPointerException | ArrayIndexOutOfBoundsException nullPointer ){
            System.out.println(" PARSING IS NOT POSSIBLE BECAUSE OF MULTIPLE RELATIONSHIP: ");
            //thobho = 1;
            //sw[0] = "null1";
        //tsw[0] = "null1";
    }
        ...
        for(int j = 0 ; j < sw.length;j++){
          ...
          words[count1] = sw[j];
          //if(count1 == 1)
            chunkinfo[count1] = sw.length ;
            System.out.println("j="+j);
          System.out.println("input string words separated by whitespace: " + sw[j] +"    "+tsw[j]+"  chunkinfo["+count1+"]="+chunkinfo[count1]); 
          tags[count2] = tsw[j];
          count2++;
  ...
  //} 
    ...
    //System.out.println();
  //  int parcnt = 0;
    System.out.println("addone ="+addone+"  ln ="+ln+"  duplicateparselength ="+duplicateparse.length);
      if(addone){
        for(int k1=0;k1<9;k1++)
                duplicateparse[ln-1][k1] = 0;

        duplicateparse[ln-1][5] = 1;
      }

        System.out.println("No of vertices ="+novertices+"  i="+i+"    sw.length =="+sw.length+"  duplicateparse["+0+"]="+duplicateparse[0].length+"  superindex111 ="+superindex111+"  icount="+icount);
        //for(int m = 0 ; m < novertices;m++){
        System.out.println();
        for(int m = 0 ; m < duplicateparse.length;m++){
       for(int n = 0 ; n < duplicateparse[0].length;n++){
           //  System.out.println();
           if(duplicateparse.length > 0 && duplicateparse[0].length >8 && ln > 1){ 
            if( duplicateparse[1][9] == 1 ){
              for(int k1=0;k1<9;k1++)
                duplicateparse[1][k1] = 0;
            }
            System.out.print("   "+duplicateparse[m][n]);
         }
       }
          ...
          for(int n = 0 ; n < duplicateparse[0].length;n++){
           //  System.out.println();
            ...
            if(duplicateparse[i][n] == 1 && icount == 0){
              //  parserelation[parcnt] = relation[n];
              System.out.println();
              System.out.println("  i="+i+"  n="+n+" parserelation["+parcnt+"]="+parserelation[parcnt]);
             //   parcnt++;
              ...
              icount++;
                ...
                System.out.println("early intrachunk duplicate n = "+n);
              //  noedges = noedges+1;
               // noedges1 = noedges1 +1;
  ...
  System.out.println("go ahead Every thing is main: i = "+i+"  parserelation["+ct+"] ="+parserelation[ct]+"  relation n="+n+"  flag="+flag+"  available="+available );
              ...
              if(flag != 200){
                if(sw.length == 1 && available == 0 ){
                 ...
                 // if( //extduplicate[superindex][superindex1] == 0)
                  ...
                  //System.out.println("superindex="+superindex+"    superindex1"+(superindex1 + i));
                    ...
                    if((tsw[0].equals("PRL") || tsw[0].equals("PRP")) && ftk == 0){
                        if(tsw[1].equals("NN") && tsw[2].equals("RB") && !k2pexist && !k3exist){
                              parserelation[ct] = relation[10];
                            }
                          else if(tsw[1].equals("RB") ){
                            parserelation[ct] = relation[10];
                 ...
                 // superindex = superindex + i;
                  ...
                  //System.out.println("superindex="+superindex+"   superindex1 ="+(superindex1 + i));
                  //ct++;
                  if(k2pexist && k2pindex == ct) {
                    parserelation[ct] = relation[7];
                  }

                  System.out.println("Vibhakti exist and Every thing is main: i = "+i+"  parserelation["+ct+"] ="+parserelation[ct]+"   k2pindex ="+k2pindex);
                  ct++;
                }
                else{
                  available = 1;
...
//        npwords[npcount][s] = words[s];
  ...
  String[] finalwords = new String[100];
  String[] finaltags = new String[100];  
  //else{
  if(npcount == 1){
  ...
  for(int i = 0 ; i <= npcount;i++){
    for(int j = 0 ; j < nptags[i].length ; j++){
      System.out.println(" 123  nptags["+i+"]["+j+"]="+nptags[i][j]+"  nlrows="+nlrows+"   nlcols="+nlcols+"  transitive="+transitive+"  parserelation["+j+"]="+parserelation[j]+"  tags["+j+"= ]"+tags[j]); // transitive =1 means transitive 
      if(parserelation[j].equals("Karana(K3)") && !tags[j+1].equals("PSPLE") && !k3exist && k5exist == 0 && !tags[j+2].equals("PSPKO") )   // transitive = 2 means intransitive
        parserelation[j] = "Sampradan(K4)";
      if(parserelation[j].equals("Karma(K2)") && tags[j+1].equals("PSPLE"))
        parserelation[j] = "Karana(K3)";
      if(parserelation[j].equals("Karana(K3)") && k5exist == 1 && transitive != 2)
        parserelation[j] = "Karma(K2)";  
      if(parserelation[j].equals("Karana(K3)") && tags[j+2].equals("PSPKO") && transitive != 2)
        parserelation[j] = "Karma(K2)";  
      if(ikaexist != 100 && parserelation[j].equals("Adhikaran(K7)") ){
          for(int k=j+1;k<nptags[i].length;k++){
                if( parserelation[k].equals("Karma(K2)"))
                    System.out.println("off");
                    parserelation[k] = relation[0];
          }
      }
    }
  }
  ...
  for(int i = 0 ; i < nlcols;i++){
    ...
    System.out.println("  finalwords["+i+"]="+finalwords[i]+"   vfinaltags["+i+"]="+vfinaltags[i]+"  parserelation["+i+"]="+parserelation[i]+"  tags["+i+"]="+tags[i]);
  ...
  OutputStreamWriter writer = new OutputStreamWriter(new FileOutputStream(filename, false), "UTF-8");
     ...
     // fout.write(" Sentence :");
      ...
      for(int s = 0 ; s < sent.length; s++){
        ...
        else if(sent[s].equals("PUNC") ){
         //System.out.println("POS Tags["+s+"]="+sent[s]);
          //fout.write(" sentence "+sent[s]); 
          don = 1;
        }
      }
    }
    catch(NullPointerException ne22){};
      fout.write("\n");
      don = 0;
      // fout.write("\n");
      fout.write(" POS Tags:");
    ...
    sw1 = NP;
    tsw1 = TNP;
    int stopindex = 2*nlcols+4;
    try{
    for(int r=0; r< nlrows-1; r++){
                   // fout.write("\n");
                    System.out.println("  Noun chunks["+r+"]="+NP[r]);
                    //fout.write("\n");
                    if(!NP[r].equals(null)){
                      fout.write("  ("+NP[r]+")");
                    }
      ...
      catch(NullPointerException new1){}
    ...
    for(int r=0; r< nlrows-1; r++){
          ...
          ctsing = 0;
                   // fout.write("\n");
                    System.out.println("  Noun chunks["+r+"]="+NP[r]+"  nlrows-1 ="+(nlrows-1));
                    //fout.write("\n");
                    if(!NP[r].equals(null))
                    {
                     // try{
                      sw1 = NP[r].trim().split("\\s+"); 
                      tsw1 = TNP[r].trim().split("\\s+");
                      for(int r1=r;r1<chunkinfo.length &&  chunkinfo[r1+1]!=0 && ctsing == 0;r1++){
                          System.out.println("input string words separated by whitespace: " + sw1[0] +"    "+tsw1[0]+"  chunkinfo["+r1+"]="+chunkinfo[r1+1]); 
                          fout.write("(");
                          for(int r2=0;r2<chunkinfo[r1+1];r2++){
                             fout.write("{ "+sw1[r2]+" "+tsw1[r2]+"}");
                               
                          }
                          fout.write(")");

                         // fout.write("_"+parserelation[r]);
                         // else
                         // {
                          int ll = chunkinfo[r1+1];
                          System.out.println("parserelation length early = "+parserelation.length);
                            for(int r3 = r ; r3 < parserelation.length ; r3++){
                               System.out.println("parserelation["+r3+"]="+parserelation[r3]+"  relcount ="+relcount);
                               //relcount = 0;
                              if(!parserelation[r3].equals("Oth") && !parserelation[r3].equals("next") && relcount == 0){
                                System.out.println("INSIDE parserelation["+r3+"]="+parserelation[r3]+" position ="+position+"  ll="+ll);
                                
                               // if(r3>0 && parserelation[r3].equals(a)){
                                  //r3 = r3 + ll;
                                  
                                 // if(!parserelation[r3].equals("Oth") )
                                   // fout.write("_"+parserelation[r3]);
                                 // r3++;
                               /*   else{
                                    if(!parserelation[r3+1].equals("Oth") ){
                                      fout.write("_"+parserelation[r3+1]);
                               //       r3 = r3+1;
                                    }
                                    else{
                                      if(!parserelation[r3+2].equals("Oth") ){
                                        fout.write("_"+parserelation[r3+2]);
                                 //       r3 = r3+2;
                                      }
                                      else{
                                        if(!parserelation[r3+3].equals("Oth") ){
                                          fout.write("_"+parserelation[r3+3]);
                                   //       r3 = r3 + 3;
                                      }
                                      System.out.println("just inside 3 parserelation["+r3+"]="+parserelation[r3]+"  a="+a);
                                      }
                                    }
                                  }*/
                                  System.out.println("just parserelation["+r3+"]="+parserelation[r3]+"  a="+a+" position ="+position);
                                  fout.write("_"+parserelation[position]);
                                  position = position + ll;
                               // }
                                //else{
                                  
                                  if(dangll != 100){
                                   // for(int s=1;s<parserelation.length;s++)
                                      
                                      a = parserelation[position ];
                                      
                                      System.out.println("position ="+position);
                                  }
                                  System.out.println("parserelation["+r3+"]="+parserelation[r3]+"  a="+a+"  ll ="+ll+"  dangll ="+dangll);
                                  dangll = r3;
                                  System.out.println("parserelation["+r3+"]="+parserelation[r3]+"  a="+a+"  dang ll="+dangll);
                              //  }
                                
                                relcount++;
                              }
                              //relcount = 0;
                              System.out.println("end parserelation["+r3+"]="+parserelation[r3]+"  a="+a);
                            }
                         // }
                           fout.write(" ");
                          ctsing = 1;
      ...
      catch(NullPointerException new2) {}
    try{
      for(int s = 0 ; s < sent.length && ekaexist == 0; s++){
        if(sent[s].equals("VAUX") || sent[s].equals("VF") ){
          don = 0;
        }
        else{
         // don = 1;
  ...
  /*  don = 0;
   // System.out.println
      ...
      for(int s = 0 ; s < sent.length; s++){
        ...
        //  System.out.println("12345 sent["+s+"]="+sent[s]);
         ...
         if(s%2 ==0){
          ...
          fout.write(" ,"+sent[s]+" })"); 
          System.out.println("DON nlcols="+nlcols+"  parserelation["+n11+"]="+parserelation[n11]);
          if(n11 <= nlcols){
            fout.write("_"+parserelation[n11]);   
            n11++;
          }
        }
        //don = 1;
      ...
      int gender = 2; //default Neutral
      System.out.println("Front ="+front+" stop = "+thobho);
      if(thobho == 1){
        System.out.println("Parsing is not possible due to grmmatical error: ");
        //fout.write("\n");
        //fout.write(" Parsing is not possible due to grmmatical error: ");
      }

      //neg = getNegation("\u0928", words[0]);
    /*  if(words[0].equals("\u0909\u0928\u093f"))// Uni
      {
        gender = 1;
      }*/
     ...
     /* int e=0;
      ...
      for(int d=0;d<11;){
        //for(int e=0;e<12;e=e+2){
            ...
            {
              System.out.println("else d="+d);
              for(int r=1;r<3;r++){
                standardOri[d+r][e] = 1;
                standardOri[d+2][e+1] = 1;
              }
              d=d+3;
            }
        }
      ...
      standardOri[10][11] = 1;
      if(neg == 0)
        neg = getNegation("\u0926\u093f\u0928", words[0]);   // dina
      System.out.println("neg="+neg);
      if(neg == 1){
        System.out.println("Negative sentence");
        //fout.write(" sentence is negative ");
        System.out.println("Simple Present Tense");
        //fout.write(" Simple Present Tense  ");
        System.out.println("Subject is First person and Singular");
        //fout.write(" Subject is First person and Singular ");
        neg=2;
        spre = 1;
        first = 1;
        dina = 1;
        sign = getNegation5("\u092e",words[1]);   // m
      //  standardOri[0][0] = 1;
        //standardOri[0][1] = 1;
        if(sign == 1){
          standard[0][1] = 1;
         // standardOri[0][1] = 1;
          ...
          standard[0][1] = 0;
       // sign = getNegation("\u092e",words[1]);   // m
        //standard[0][dina-1] = 1;

      }
     /* else{
        System.out.println("Affirmative sentence");
        //fout.write(" sentence is Affirmative ");
        System.out.println("Simple Present Tense");
        //fout.write(" Simple Present Tense  ");
      }*/
      if(neg == 0)
        neg = getNegation1("\u0926\u0948\u0928\u094c", words[0]);   // dainau
      ...
      if(neg == 1){
        ...
        System.out.println("Simple Present Tense");
        //fout.write(" Simple Present Tense  ");
        System.out.println("Subject is First/Second person and plural/Singular");
        //fout.write(" Subject is First/Second person and plural/Singular ");
        neg=2;
        spre = 1;
        first = 1;
        second = 1;
        dainau = 1;
        sign = getNegation4("\u0924\u093f\u092e\u0940",words[1]);   // timi
       // standardOri[1][2] = 1;
       // standardOri[1][3] = 1;
        if(sign == 1){
          standard[1][3] = 1;
      ...
      if(neg == 0)
        neg = getNegation6("\u0926\u0948\u0928\u094c\u0901", words[0]);   // dainaun
      ...
      if(neg == 1){
        ...
        second = 1;
        dainaun = 1;
        sign = getNegation1("\u0939\u093E\u092e\u0940",words[1]);   // hami
      //  standardOri[2][4] = 1;
      //  standardOri[2][5] = 1;
        if(sign == 1){
          standard[2][5] = 1;
      ...
      //fout.write("\n");
      if(neg == 0)
        neg = getNegation("\u0928\u0928\u094d", words[0]);   // nan
      ...
      if(neg == 1){
        ...
        System.out.println("Simple Present Tense");
        //fout.write(" Simple Present Tense  ");
        System.out.println("Subject is Third person ");
        //fout.write(" Subject is Third person ");
        neg=2;
        spre = 1;
        //third = 1;
      ...
      if(neg == 0)
        neg = getNegation3("\u0928\u0941\u0939\u0941\u0928\u094d\u0928\u093e", words[0]);   // nuhunn
       // neg = getNegation3("\u0926\u0948\u0928\u094c\u0901", words[0]);   // dainau
      ...
      if(neg == 1){
        ...
        System.out.println("Simple Present Tense");
        //fout.write(" Simple Present Tense  ");
        System.out.println("Subject is Second/ Third person ");
        //fout.write(" Subject is Second / Third person ");
        neg=2;
        spre = 1;
        second = 1;
        third = 1;
        nuhunn = 1;
        sign = getNegation1("\u0924\u092a\u093e\u0908",words[1]);   // Tapai
      //  standardOri[3][6] = 1;
      //  standardOri[3][7] = 1;
        if(sign == 1){
          standard[3][7] = 1;
        ...
        sign = getNegation1("\u0935\u0939\u093e\u0901",words[1]);   // Vahan       
      //  standardOri[4][6] = 1;
      //  standardOri[4][7] = 1;
        if(sign == 1){
          standard[4][7] = 1;
        ...
        sign = getNegation1("\u0909\u0939\u093e\u0901",words[1]);   // Uhan
      //  standardOri[5][6] = 1;
      //  standardOri[5][7] = 1;
        if(sign == 1){
          standard[5][7] = 1;
      ...
      //fout.write("\n");
       ...
       if(neg == 0)
        neg = getNegation("\u0926\u0948\u0928", words[0]);   // dain
      ...
      //  standardOri[6][9] = 1;
        ...
        sign = getNegation2("\u092f\u094b",words[1]);   // yo       
      //  standardOri[7][8] = 1;
      //  standardOri[7][9] = 1;
        if(sign == 1){
          standard[7][9] = 1;
        ...
        sign = getNegation1("\u0924\u094d\u092f\u094b",words[1]);   // tyo
      //  standardOri[8][8] = 1;
      //  standardOri[8][9] = 1;
        if(sign == 1){
          standard[8][9] = 1;
      ...
      if(neg == 0)
        neg = getNegation6("\u0926\u093f\u0928\u0928\u094d", words[0]);   // dinan
      ...
      if(neg == 1){
        ...
        third = 1;
        dinan = 1;
        sign = getNegation("\u0909\u0928\u0940",words[1]);   // uni      
      //  standardOri[9][10] = 1;
      //  standardOri[9][11] = 1;
        if(sign == 1){
          standard[9][11] = 1;
        ...
        sign = getNegation1("\u0924\u093f\u0928\u0940",words[1]);   // tini
      //  standardOri[10][10] = 1;
      //  standardOri[10][11] = 1;
        if(sign == 1){
          standard[10][11] = 1;
     ...
     /* else{
      ...
      int plural = 0;
      if(plural == 0)
        plural = getNegation2("\u091b\u0941", words[0]);   // chu
      //fout.write("\n");

      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        //fout.write(" Subject is Affirmative ");
        System.out.println("Simple Present Tense");
        //fout.write(" Simple Present Tense  ");
        System.out.println("Subject is First person and Singular");
        //fout.write(" Subject is First person and Singular ");
        plural = 3;     // plural = 3 indicates the subject is singular 
        spre = 1;
        first = 1;
        chhu = 1;
        sign = getNegation5("\u092e",words[1]);   // m
      //  standardOri[0][0] = 1;
        //standardOri[0][1] = 1;
        System.out.println("first sign ="+sign);
        if(sign == 1){
          standard[0][0] = 1;
         // standardOri[0][1] = 1;
        }
      ...
      //fout.write("\n");
      if(plural == 0)
        plural = getNegation2("\u091b\u094c", words[0]);   // chhau
        if(plural == 0)
          pluralverb = getNegation("\u091b\u094c\u0902",words[0]);
        System.out.println("chhau Plural ="+plural+" words ="+words[0]);
      //fout.write("\n");
        String tchau = "\u091b\u094c";
        String tchau1 = "\u091b\u094c\u0902";
        System.out.println("frist Chhau exist "+tchau+" word="+words[0]+"   next word="+words[1]+" tchau1="+tchau1);
      if(tchau.equals(words[0]) || tchau.equals(words[1]) || tchau1.equals(words[0])){
        pluralverb = 1;
        System.out.println("rist Chhau exist");
      }
      if(plural == 1){
        System.out.println("Chhau exist");
        pluralverb = 1; // verb is plural
      }
      ...
      if(neg == 0 && plural == 1){
        ...
        System.out.println("Simple Present Tense");
        //fout.write(" Simple Present Tense  ");
        System.out.println("Subject is First/Second person and Plural");
        //fout.write(" Subject is First/Second person and Plural ");
        plural= 4;    // plural = 4 indicates the subject is plural and plural = 2 indicates the sentence is affirmative
        spre = 1;
        first = 1;
        second = 1;
        chhau = 1;
        neg = 2;
        sign = getNegation1("\u0924\u093f\u092e\u0940",words[1]);   // timi
      //  standardOri[0][0] = 1;
        //standardOri[0][1] = 1;
        System.out.println("second sign ="+sign);
        if(sign == 1){
          standard[1][2] = 1;
         // standardOri[0][1] = 1;
        }
      ...
      if(plural == 0)
        plural = getNegation4("\u0928\u0941\u0939\u0941\u0928\u094d\u091b", words[0]);   // nuhunchh
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        //fout.write(" Subject is Affirmative ");
      ...
      //  standardOri[0][0] = 1;
        //standardOri[0][1] = 1;
        System.out.println("Third sign ="+sign);
        if(sign == 1){
          standard[3][6] = 1;
         // standardOri[0][1] = 1;
        }
      ...
      if(plural == 0)
        plural = getNegation2("\u091b\u0938", words[0]);   // chas
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        //fout.write(" Subject is Affirmative ");
      ...
      if(plural == 0)
        plural = getNegation("\u091b\u093f\u0928", words[0]);   // cheen
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        //fout.write(" Subject is Affirmative ");
      ...
      if(plural == 0)
        plural = getNegation("\u091b\u0940\u0928", words[0]);   // chin
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        //fout.write(" Subject is Affirmative ");
      ...
      for(int v=0;v<vb.length;v++){
        System.out.println(" Separate chh and chhan word["+v+"]"+vb[v]);
        ...
        if(plural == 0){
          ...
          if(vb[v].equals("\u091b\u0928\u094d")  || vb[v].equals("\u091b\u0928")){
            neg = 1;
            plural = 1;
          }
        //plural = getNegation4("\u0928\u0941\u0939\u0941\u0928\u094d\u091b", words[0]);   // chau
        }
      }
      ...
      if(neg == 0 && plural == 1){
        ...
        System.out.println("Simple Present Tense");
        //fout.write(" Simple Present Tense  ");
        System.out.println("Subject is First person ");
        //fout.write(" Subject is First person ");
        plural=2;
        spre = 1;
        first = 1;
      }
      if(neg == 1 && plural == 1){
        System.out.println("Subject is Negative");
        //fout.write(" Subject is Negative ");
        System.out.println("Simple Present Tense");
        //fout.write(" Simple Present Tense  ");
        System.out.println("Subject is First person ");
        //fout.write(" Subject is First person ");
      ...
      if(plural == 0)
        plural = getNegation5("\u091b", words[0]);   // ch
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        //fout.write(" Subject is Affirmative ");
      ...
      if(plural == 0){
        plural = getNegation2("\u091b\u0928", words[0]);   // chan
        System.out.println("123 plural = "+plural);
        if(plural == 0 ){
          plural = getNegation("\u091b\u0928\u094d", words[0]); //chanan
      ...
      // SIMPLE PAST TENSE
      // neg = 2 means the sentence is negative
      // neg = 0 means the sentence may  be affirmative
      // neg is not equals to 2 and plural is not equals to 0 means the sentence is affirmative
      // plural = 3 means singular
      // plural = r means plural
     // neg = 0;
      //plural = 0
      System.out.println("Simple Past Tense :");
    if(neg == 0)
        neg = getNegation1("\u0930\u093f\u0928\u093e", words[0]);   // rina
      if(neg == 1){
        System.out.println("Negative sentence");
        //fout.write(" sentence is negative ");
        System.out.println("Simple Past Tense");
        //fout.write(" Simple Past Tense  ");
        System.out.println("Subject is First person and Singular");
        //fout.write(" Subject is First person and Singular ");
        neg=2;
        spast = 1;
      ...
      if(plural == 0)
        plural = getNegation5("\u0947", words[0]);   // e
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        //fout.write(" Subject is Affirmative ");
        System.out.println("Simple Past Tense");
        //fout.write(" Simple Past Tense  ");
        System.out.println("Subject is First/Third person and singular ");
        //fout.write(" Subject is First/Third person singular ");
        plural=3;
        spast = 1;
        first = 1;
        third = 1; 
      ...
      if(neg == 0)
        neg = getNegation("\u090f\u0928\u094c", words[0]);   // rina
      if(neg == 1){
        System.out.println("Negative sentence");
        //fout.write(" sentence is negative ");
        System.out.println("Simple Past Tense");
      ...
      if(plural == 0)
        plural = getNegation6("\u0917\u0930\u094d\u092f\u094c", words[0]);   // garyau
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        ...
        System.out.println("Simple Past Tense");
        //fout.write(" Simple Past Tense  ");
        System.out.println("Subject is First person and Plural ");
        //fout.write(" Subject is First person Plural ");
        //plural=2;
        spast = 1;
        first = 1;
        plural = 4; 
...
if(neg == 0)
        neg = getNegation2("\u092f\u094c", words[0]);   // rina
      if(neg == 1){
        System.out.println("Negative sentence");
        //fout.write(" sentence is negative ");
        System.out.println("Simple Past Tense");
      ...
      if(plural == 0)
        plural = getNegation6("\u0917\u0930\u094d\u092f\u094c", words[0]);   // e
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
      ...
      //fout.write("\n");
      if(neg == 0)
        neg = getNegation6("\u0928\u0941\u092d\u090f\u0928", words[0]);   // nubhaen
      if(neg == 1){
        System.out.println("Negative sentence");
        //fout.write(" sentence is negative ");
        System.out.println("Simple Past Tense");
      ...
      if(plural == 0)
        plural = getNegation6("\u0928\u0941\u092d\u092f\u094b", words[0]);   // nubhayo
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        ...
        System.out.println("Simple Past Tense");
        //fout.write(" Simple Past Tense  ");
        System.out.println("Subject is Second person ");
        //fout.write(" Subject is Second person ");
        plural=2;
        spast = 1;
        second = 1;
      ...
      if(neg == 0)
        neg = getNegation1("\u090f\u0928\u0928\u094d", words[0]);   // enen
      if(neg == 1){
        System.out.println("Negative sentence");
        //fout.write(" sentence is negative ");
        System.out.println("Simple Past Tense");
      ...
      if(plural == 0)
        plural = getNegation2("\u092f\u094b", words[0]);   // yo
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
      ...
      if(neg == 0)
        neg = getNegation7("\u0928\u0947\u091b\u0948\u0928\u0901", words[0]);   // nechhu
      if(neg == 1){
        System.out.println("Negative sentence");
        //fout.write(" sentence is negative ");
        System.out.println("Simple Future Tense");
        //fout.write(" Simple Future Tense  ");
        System.out.println("Subject is First person ");
        //fout.write(" Subject is First person ");
        neg=2;
        sfuture = 1;
      ...
      if(plural == 0)
        plural = getNegation1("\u0928\u0947\u091b\u0941", words[0]);   // nechhauna
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
...
if(neg == 0)
        neg = getNegation4("\u0928\u0947\u091b\u0948\u0928\u094c\u0902", words[0]);   // nechhu
      if(neg == 1){
        System.out.println("Negative sentence");
        //fout.write(" sentence is negative ");
        System.out.println("Simple Future Tense");
        //fout.write(" Simple Future Tense  ");
        System.out.println("Subject is First person and Plural ");
        //fout.write(" Subject is First person and Plural");
        neg=2;
        sfuture = 1;
        first = 1;
        plural = 4; 
      ...
      if(plural == 0){
        garnuexist = getNegation6("\u093e\u0930\u094d\u0928\u0941", words[0]);   // nechhauna
        System.out.println("in simple past tense neg="+neg+"   plural="+plural+"  garnu exist="+garnuexist);
      }
      ////fout.write("\n");
      ...
      //fout.write("\n");
      if(plural == 0)
        plural = getNegation6("\u0928\u0947\u091b\u094c\u0902", words[0]);   // nechhauna
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
    ...
    if(neg == 0)
        neg = getNegation7("\u0928\u0947\u091b\u0948\u0928\u094c", words[0]);   // nechhainau
      if(neg == 1){
        System.out.println("Negative sentence");
        //fout.write(" sentence is negative ");
        System.out.println("Simple Future Tense");
      ...
      if(plural == 0)
        plural = getNegation1("\u0928\u0947\u091b\u094c", words[0]);   // nechhau
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
      ...
      if(neg == 0)
        neg = getNegation6("\u0928\u0947\u091b\u0948\u0928", words[0]);   // nechhain
      if(neg == 1){
        System.out.println("Negative sentence");
        //fout.write(" sentence is negative ");
        System.out.println("Simple Future Tense");
      ...
      if(plural == 0)
        plural = getNegation("\u0928\u0947\u091b", words[0]);   // nechh
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
      ...
      if(neg == 0)
        neg = getNegation7("\u0928\u0947\u091b\u0948\u0928\u0928", words[0]);   // nechhainan
      if(neg == 1){
        System.out.println("Negative sentence");
        //fout.write(" sentence is negative ");
        System.out.println("Simple Future Tense");
      ...
      if(plural == 0)
        plural = getNegation1("\u0928\u0947\u091b\u0928", words[0]);   // nechhau
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      //fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
      ...
      if(plural == 0)
        plural = getNegation2("\u0928\u0941", words[0]);   // unu
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      //fout.write("\n");
      if( plural == 1){
      ...
      System.out.println(" neg="+neg+"  plural="+plural+"  first="+first+"  second="+second+"  third="+third+"  SPreT="+spre+" SPast="+spast+"  Sfut="+sfuture+"  pastc="+pastc+"  spc ="+spc+"  futurec="+futc+"np length ="+np.length+" plural verb ="+pluralverb);
      ////fout.write(" neg="+neg+"  plural="+plural+"  first="+first+"  second="+second+"  third="+third+"  SPreT="+spre+" SPast="+spast+"  Sfut="+sfuture+"  pastc="+pastc+"  spc="+spc+"  futurec="+futc);

      System.out.println("nlrows ="+nlrows);
     // try{
      for(int r=0;r<(nlrows-1);r++){
        System.out.println("words["+r+"]="+words[r]+"  tags["+(r+1)+"]="+tags[r+1]+" Nouns["+r+"]="+Words[r]);
        if(Words[r].equals("\u0909\u0928\u093f") || Words[r].equals("\u0926\u093f\u0926\u0940") || Words[r].equals("\u092c\u0939\u093f\u0928\u0940") || words[r].equals("\u092c\u093f\u0939\u0928\u0940")  )// Uni or or didi or bahini or bihani)
      {
        gender = 1;
        third = 1;
        System.out.println("Gender is Feminine and subject is Third person  ");
        //fout.write(" Gender is Feminine and subject is Third person ");
      //fout.write("\n");
      }
      if(Words[r].equals("\u0909") || Words[r].equals("\u092d\u093e\u0908") || Words[r].equals("\u0926\u093e\u091c\u0941"))// Uni or Bhai or Daju
      {
        gender = 0;
        third = 1;
        first = 0;
        System.out.println("Gender is Masculine and subject is Third person  ");
        //fout.write(" Gender is Masculine and subject is Third person ");
      //fout.write("\n");
      }

        if( Words[r].equals("\u0924\u094d") || Words[r].equals("\u092e")  || Words[r].equals("\u0924\u0901") || Words[r].equals("\u0924") || Words[r].equals("\u0909") || Words[r].equals("\u0924") || Words[r].equals("\u0909\u0928\u093f") || Words[r].equals("\u092f\u094b") || Words[r].equals("\u0909\u0928\u0940")){
            System.out.println("Subject is Singular");
            //fout.write(" Subject is Singular ");
            plural=3;
             
        }
        if( words[r].equals("\u0939\u093e\u092e\u0940")){
            System.out.println("Subject is Plural");
            //fout.write(" Subject is Plural ");
            plural=4;
             
        }
        if(words[r].equals("\u0909\u0928\u0940") || words[r].equals("\u0924") || words[r].equals("\u0909\u0928\u093f") || words[r].equals("\u092f\u094b")){
          third=1;
          first=0;
          second=0;
        }
        ...
        if(vb.length > 1){
          ...
          for(int v=0;v<vb.length;v++){
              System.out.println(" Separate present continuous word["+v+"]"+vb[v]);

              //if(plural == 0){
              cont = getNegation4("\u0926\u0948", vb[v]);
              if(cont == 1){
            
                if(vb[v+1].equals("\u091b\u0941") || vb[v+1].equals("\u091b\u094c") || vb[v+1].equals("\u091b\u094c\u0901") || vb[v+1].equals("\u0939\u0941\u0939\u0941\u0928\u094d\u091b") || vb[v+1].equals("\u091b") || vb[v+1].equals("\u091b\u0941") || vb[v+1].equals("\u091b\u093f\u0928\u094d") || vb[v+1].equals("\u091b\u0928\u094d")){// || vb[v].equals("\u091b\u0928")){
                    spc = 1;
                    neg = 0;
                    System.out.println("Present contunous Tense spc="+spc+"   neg="+neg);
            
                 }
                  if(vb[v+1].equals("\u091b\u0948\u0928") || vb[v+1].equals("\u091b\u0948\u0928\u094c") || vb[v+1].equals("\u091b\u0948\u0928\u094c\u0901") || vb[v+1].equals("\u0939\u0941\u0928\u0941\u0939\u0941\u0928\u094d\u0924\u0930") || vb[v+1].equals("\u091b\u0948\u0928\u0928\u094d") || vb[v+1].equals("\u091b\u0948\u0928") || vb[v+1].equals("\u091b\u093f\u0928\u094d") ){// || vb[v].equals("\u091b\u0928")){
                    spc = 1;
                    neg = 0;
                    System.out.println("Present contunous Tense spc="+spc+"   neg="+neg);
            
                 }
                 if(vb[v+1].equals("\u091b\u0948\u0928") || vb[v+1].equals("\u091b\u0948\u0928\u0928") || vb[v+1].equals("\u0939\u0941\u0928\u0941\u0939\u0941\u0928\u094d\u0928") || vb[v+1].equals("\u091b\u0948\u0928\u094c") ){
                    spc = 1;
                    neg = 1;
                    System.out.println("Present contunous Tense spc="+spc+"   neg="+neg);
        ...
        //plural = getNegation4("\u0928\u0941\u0939\u0941\u0928\u094d\u091b", words[0]);   // chau
            ...
            //}
          //plural = getNegation1("\u0926\u0948", words[r]);   // nechhau
         // System.out.println("Present contunous Tense neg="+neg+"   plural="+plural);
        }
      }
      ...
      pastc = 0;
      for(int v=0;v<vb.length;v++){
              System.out.println(" Separate past continuous word["+v+"]"+vb[v]);

              //if(plural == 0){
              cont = getNegation4("\u0926\u0948", vb[v]);
              if(cont == 1){
            
                if(vb[v+1].equals("\u0925\u093f\u090f\u0901") || vb[v+1].equals("\u0925\u093f\u092f\u094c") || vb[v+1].equals("\u0925\u093f\u092f\u094c\u0901") || vb[v+1].equals("\u0939\u0941\u0928\u0941\u0939\u0941\u0928\u094d\u0925\u094d\u092f\u094b") || vb[v+1].equals("\u0925\u093f\u092f\u094b") || vb[v+1].equals("\u0925\u093f\u0907\u0928\u094d") || vb[v+1].equals("\u0925\u093f\u090f") ){// || vb[v].equals("\u091b\u0928")){
                    pastc = 1;
                    neg = 0;
                    System.out.println("Past contunous Tense pastc="+pastc+"   neg="+neg);
            
                 }
                  if(vb[v+1].equals("\u0925\u093f\u0907\u0928\u0901") || vb[v+1].equals("\u0925\u093f\u090f\u0928\u094c") || vb[v+1].equals("\u091b\u0948\u0928\u094c\u0901") || vb[v+1].equals("\u0939\u0941\u0928\u0941\u0939\u0941\u0928\u094d\u0928") || vb[v+1].equals("\u0925\u093f\u0907\u0928") || vb[v+1].equals("\u0925\u093f\u090f\u0928\u0928") || vb[v+1].equals("\u0925\u093f\u0907\u0928\u0928") ){// || vb[v].equals("\u091b\u0928")){
                    pastc = 1;
                    neg = 1;
                    System.out.println("Present contunous Tense pastc="+pastc+"   neg="+neg);
      ...
      futc = 0;
      for(int v=0;v<vb.length;v++){
              System.out.println(" Separate Future continuous word["+v+"]"+vb[v]);

              //if(plural == 0){
              cont = getNegation4("\u0926\u0948", vb[v]);
              if(cont == 1){
            
                if(vb[v+1].equals("\u0939\u0941\u0928\u0947\u091b\u0941") || vb[v+1].equals("\u0939\u0941\u0928\u0947\u091b\u094c") || vb[v+1].equals("\u0939\u0941\u0928\u0947\u091b\u094c\u0901") || vb[v+1].equals("\u0939\u0941\u0928\u0941\u0939\u0941\u0928\u0947\u091b") || vb[v+1].equals("\u0939\u0941\u0928\u0947\u091b") || vb[v+1].equals("\u0939\u0941\u0928\u0947\u091b\u093f\u0928") || vb[v+1].equals("\u0939\u0941\u0928\u0947\u091b\u0928") ){// || vb[v].equals("\u091b\u0928")){
                    futc = 1;
                    neg = 0;
                    System.out.println("Future contunous Tense futurec="+futc+"   neg="+neg);
            
                 }
                  if(vb[v+1].equals("\u0939\u0941\u0928\u0947\u091b\u0948\u0928") || vb[v+1].equals("\u0939\u0941\u0928\u0947\u091b\u0948\u0928\u094c") || vb[v+1].equals("\u0939\u0941\u0928\u0941") || vb[v+1].equals("\u0939\u0941\u0928\u0947\u091b\u0948\u0928") || vb[v+1].equals("\u0939\u0941\u0928\u0947\u091b\u0948\u0928") || vb[v+1].equals("\u0939\u0941\u0928\u0947\u091b\u0948\u0928\u0928\u094d")  ){// || vb[v].equals("\u091b\u0928")){
                    futc = 1;
                    neg = 1;
                    System.out.println("Future contunous Tense futurec="+futc+"   neg="+neg);
...
// PRESENT PERFECT TENSE
      ...
      sperf = 0;
      for(int v=0;v<vb.length;v++){
              System.out.println(" Simple Perfect Tense word["+v+"]"+vb[v]);

              //if(plural == 0){
              cont = getNegation("\u090f\u0915\u094b", vb[v]);
              if(cont == 0) {
                cont=getNegation("\u090f\u0915\u0940", vb[v]);
                ekiexist = 1;
              }
              if(cont == 1){
            
                if( ekoexist == 1  || ekiexist == 1){// || vb[v].equals("\u091b\u0928")){
                    sperf = 1;
                    neg = 0;
                    System.out.println("Simple perfect Tense futurec="+futc+"   neg="+neg);
            
                 }
                  if(sperf == 1 && (vb[v+1].equals("\u091b\u0948\u0928") || vb[v+1].equals("\u091b\u0948\u0928\u094c") || vb[v+1].equals("\u091b\u0948\u0928\u0901") || vb[v+1].equals("\u091b\u0948\u0928\u0928\u094d")  ) ){// || vb[v].equals("\u091b\u0928")){
                    sperf = 1;
                    neg = 2;
                    System.out.println("Simple perfect Tense futurec="+futc+"   neg="+neg);
      ...
      fperf = 0;
      for(int v=0;v<vb.length;v++){
              System.out.println(" Future Perfect Tense word["+v+"]"+vb[v]);

              //if(plural == 0){
              cont = getNegation("\u090f\u0915\u094b", vb[v]);     // eko
              System.out.println("cont ="+cont);
              ekoexist = 1;
              if(cont == 0) {
                cont=getNegation("\u090f\u0915\u0940", vb[v]);     // eki
                ekiexist = 1;
              }
              if(cont == 1){
                fperf = 1;
                ...
                if( ekoexist == 1  || ekiexist == 1){// || vb[v].equals("\u091b\u0928")){
                  if(front.equals("\u0939\u0941\u0928\u0947")){
                    fperf = 1;
                    neg = 0;
                    System.out.println("future perfect Tense positive futurepc="+fperf+"   neg="+neg);
                  }
            
                 }
                  if(fperf == 1 && (vb[v+1].equals("\u091b\u0948\u0928") || vb[v+1].equals("\u091b\u0948\u0928\u094c") || vb[v+1].equals("\u091b\u0948\u0928\u0901") || vb[v+1].equals("\u091b\u0948\u0928\u0928\u094d")  ) ){// || vb[v].equals("\u091b\u0928")){
                    fperf = 1;
                    neg = 2;
                    System.out.println("Future perfect Tense negative futurepc="+fperf+"   neg="+neg);
      ...
      pperf = 0;
      for(int v=0;v<vb.length;v++){
              if(vb[v].equals("\u091b\u0948\u0928") || vb[v].equals("\u091b\u0948\u0928\u094c") || vb[v].equals("\u091b\u0948\u0928\u0901") || vb[v].equals("\u091b\u0948\u0928\u0928\u094d") || vb[v].equals("\u0917\u090f\u0928") )// || vb[v].equals("\u091b\u0928")){ chain, chanau, chainan, gaen
              {
              ...
              System.out.println(" Past Perfect Tense word["+v+"]"+vb[v]);
              ...
              if(cont == 1){
                ...
                if( ekoexist == 1  || ekiexist == 1){// || vb[v].equals("\u091b\u0928")){ // thi positive
                  if(front.equals("\u0925\u093f")){
                    pperf = 1;
                    neg = 0; // positive
                    System.out.println("Past perfect Tense positive pperf="+pperf+"   neg="+neg);
                  }
            
                 }
                  if(pperf == 1 && (vb[v+1].equals("\u091b\u0948\u0928") || vb[v+1].equals("\u091b\u0948\u0928\u094c") || vb[v+1].equals("\u091b\u0948\u0928\u0901") || vb[v+1].equals("\u091b\u0948\u0928\u0928\u094d") || vb[v+1].equals("\u0917\u090f\u0928") ) ){// || vb[v].equals("\u091b\u0928")){ chain, chanau, chainan, gaen
                    pperf = 1;
                    neg = 2;
                    System.out.println("Past perfect Tense negative pperf="+pperf+"   neg="+neg);
      ...
      if(spre==0 && spast==0 && sfuture == 0){
        spre = 1;
      }
      if(fperf ==1 || spre == 1 || spast == 1 || spc == 1 || pastc == 1){
        spre =0;
      }

      System.out.println("new neg="+neg+"  plural="+plural+"  first="+first+"  second="+second+"  third="+third+"  SPreT="+spre+" SPast="+spast+"  fut="+sfuture+" spc="+spc+"  pastc="+pastc+"  futc="+futc+"  fperfect="+fperf+"  sperf ="+sperf+"  past perfect ="+pperf+" pluralverb="+pluralverb);
      ////fout.write("new neg="+neg+"  plural="+plural+"  first="+first+"  second="+second+"  third="+third+"  SPreT="+spre+" SPast="+spast+"  Sfut="+sfuture+" spc="+spc+"  pastc="+pastc+"  fcont="+futc+"  fperfect="+fperf+"  sperf ="+sperf+"  past perfect="+pperf);
      //fout.write("\n");
      if(QWexist1 != 200){
        //fout.write("1. Sentence is Interrogative.");
      }
      else{
        //fout.write("1. Sentence is Non Interrogative.");
      }
      //fout.write("\n");
      if(neg == 0){
        //fout.write("1. Sentence is affirmative.");
      }
      else{
        //fout.write("1. Sentence is negative.");
      }
       //fout.write("\n");
      if(plural == 4){
        //fout.write("2. Sentence is plural.");
      }
      else if(plural == 3){
        //fout.write("2. Sentence is singular.");
      }
       //fout.write("\n");
      if(first == 0){
       // //fout.write("First person does not exist.");
      }
      else{
        //fout.write("3. Subject is First person.");
      }
       //fout.write("\n");
      if(second == 0){
        ////fout.write("Second person does not exist.");
      }
      else{
        //fout.write("4. Subject is second person.");
      }
       //fout.write("\n");
      if(third == 0){
        ////fout.write("Third person does not exist.");
      }
      else{
        //fout.write("5. Subject is third person.");
      }
       //fout.write("\n");
      if(spre == 0){
       // //fout.write("Sentence is not in Simple Present Tense.");
      }
      else{
        //fout.write("6. Sentence is in Simple Present Tense.");
      }
       //fout.write("\n");
      if(spast == 0){
        ////fout.write("Sentence is not in Simple Past Tense.");
      }
      else{
        //fout.write("7. Sentence is in Simple Past Tense.");
      }
       //fout.write("\n");
      if(sfuture == 0){
        ////fout.write("Sentence is not in Simple Future Tense.");
      }
      else{
        //fout.write("8. Sentence is in Simple Future Tense.");
      }
       //fout.write("\n");
      if(spc == 0){
        ////fout.write("Sentence is not in Simple Present continuous Tense.");
      }
      else{
        //fout.write("9. Sentence is in Simple Present Continuous Tense.");
      }
       //fout.write("\n");
      if(spc == 0){
        ////fout.write("Sentence is not in Simple Present continuous Tense.");
        ...
        //fout.write("10. Sentence is in Simple Present Continuous Tense.");
      }
       //fout.write("\n");
      if(pastc == 0){
        ////fout.write("Sentence is not in Past continuous Tense.");
      }
      else{
        //fout.write("11. Sentence is in Past Continuous Tense.");
      }
       //fout.write("\n");
      if(futc == 0){
        ////fout.write("12. Sentence is not in future continuous Tense.");
      }
      else{
        //fout.write("12. Sentence is in future Continuous Tense.");
      }
       //fout.write("\n");
      if(fperf == 0){
        ////fout.write("Sentence is not in Future Perfect Tense.");
      }
      else{
        //fout.write("13. Sentence is in Future Perfect Tense.");
      }
       //fout.write("\n");
      if(sperf == 0){
        ////fout.write("14. Sentence is not in Present Perfect Tense.");
      }
      else{
        //fout.write("14. Sentence is in Present Perfect Tense.");
      }
       //fout.write("\n");
      if(pperf == 0){
        ////fout.write("Sentence is not in Past Perfect Tense.");
      }
      else{
        //fout.write("15. Sentence is in Past Perfect Tense.");
      }
      ...
      String rootvb = front;
      int busyaar = 0;
        System.out.println("Standard input SPT");
      for(int b=0;b<11;b++){
        for(int c = 0 ; c < 12 ;c++){
          if(standardOri[b][c] == 1){
            if(standard[b][c] != 1 && busyaar == 0){
           //  System.out.print(" Error...  "+words[0]);
             ////fout.write(" Error...  "+words[0]);
             ////fout.write("\n");
             // rootvb = getNegation21(SMTverb[c],words[0]);
              //System.out.print(" Correct option is...  "+rootvb+""+SMTverb[c]);
              ////fout.write(" Correct option is...  "+rootvb+""+SMTverb[c]);
              busyaar=1;   // to stop
            }
          }
          else{
      ...
      System.out.println();
      System.out.println("Standard original SPT");
      for(int b=0;b<11;b++){
        for(int c = 0 ; c < 12 ;c++){
          System.out.print("   "+standardOri[b][c]);
        }
        System.out.println();
      }

      System.out.println("Standard SPT");
      for(int b=0;b<11;b++){
        for(int c = 0 ; c < 12 ;c++){
          System.out.print("   "+standard[b][c]);
        }
        System.out.println();
      }
      ...
      String[] English1 = new String[words.length];
      int wdct1=0;
      for(int i = 0 ; i < tags.length;i++){
        if(tags[i].equals("RB")){
          if(i>0)
            parserelation[i-1] = "Comparision K*u";
          else
            parserelation[i] = "Location(K7t)";
        }
        System.out.println("tags["+i+"]="+tags[i]);
      }
      for(int i=0;i<chunkinfo.length;i++){
        System.out.println("chunkinfo ["+i+"]="+chunkinfo[i]);
      }
      System.out.println("wait new neg="+neg+"  plural="+plural+"  first="+first+"  second="+second+"  third="+third+"  SPreT="+spre+" SPast="+spast+"  fut="+sfuture+" spc="+spc+"  pastc="+pastc+"  futc="+futc+"  fperfect="+fperf+"  sperf ="+sperf+"  past perfect ="+pperf+" gender ="+gender+" pluralverb= "+pluralverb);
      English1 = getEnglishsentence(duplicateparse, np, words, tags, parserelation, words[0], neg,plural,first,second,third,spre,spast,sfuture, chunkinfo, spc,pastc,futc,fperf,sperf,pperf, sent, filename,filename3,gender,vb,garnuexist, pluralverb);
    fout.write("\n");
     fout.write("\n");
     // fout.write("English Translation:");
      try{
      for(int c=0;c<English1.length;c++){
        if(!English1[c].equals("null1") ){
      //   fout.write(" "+English1[c]+" ");
        }
        }
      }
     ...
     /* try{
        for(int c=0;c<words.length;c++){
         if(!English1[c].equals("null1")){
          if(!English1[c].equals(null) ){
           // if(!engTr[j].equals("null1")  ){
            if( !English1[c].equals("123")){
             //System.out.println("  "+engTr[j]);
         ...
         //}
                 ...
                 // //fout.write("English Translation");
                  ////fout.write("\n");
                  //if(English1)
        System.out.println("wdct1="+wdct1+"  nlcols ="+nlcols+"  nlrows="+nlrows);
        //for(int i =0 ; i < wdct1; i++)
                   // //fout.write("  "+English1[i]);
    stopindex = 2*nlcols+4;
    for(int r=0; r< nlrows-1; r++){
                    //fout.write("\n");
                    System.out.println("  Noun chunks["+r+"]="+NP[r]);
                  //  fout.write("\n");
                  //  fout.write("  Noun chunks["+r+"]="+NP[r]);
                  }
  for(int n1 = 0 ; n1 < 2*nlcols+3;n1++){
    int ctn1 = 0;
    int ctr = 0;
       //   if(extduplicate[m1][n1] == 1){
              System.out.println(" words["+n1+"]="+words[n1]+" tags["+n1+"]="+tags[n1]+" parserelation["+n1+"]= "+parserelation[n1]+" Words["+n1+"]="+Words[n1]);
             /* if(tags[n1].equals("VAUX") || tags[n1].equals("VF") ){
                  stopindex = n1;
              }*/
            //fout.write("sentence :"+words[n1]);
             // fout.write("\n");
              if(n1 == 0){
                 ...
                 /* for(int v = 0 ; v < vb.length ; v++){
                    fout.write("  "+vb[v]);
                //  }
                   // if(tags[2*nlcols+4].equals("VAUX") || tags[2*nlcols+4].equals("VF"))
                    for(int r2=0;r2< stopindex ;r2++){
                      if(tags[r2].equals("VAUX") || tags[r2].equals("VF"))
                      fout.write(","+tags[2*nlcols+4]+"}_VF");
                    }
                }
                  fout.write("\n");*/
              }
              else if(!tags[n1].equals("VAUX") && !tags[n1].equals("VF") ){
                  System.out.println("new Part of Speech of "+Words[n1]+" is "+tags[n1]);
                  for(int i = 0 ; i < tagset.length ; i++){
                    if(tags[n1].equals(tagset[i])){
                        index = i;
                    }
                    if(tags[n1].equals("NN1")){
                        index = 6;    // NN1 refers to JJ
                    }
                  }
                  System.out.println("n1="+n1+"  Words["+n1+"]="+Words[n1]+"  Words["+(2*n1-2)+"]="+Words[2*n1-2]+" stop index="+stopindex);
                  if(n1 != 1 && 2*n1 < stopindex){
                    //fout.write("\n");
                    //fout.write("Part of Speech of "+Words[2*n1]+" is "+Words[2*n1+1]);
                    System.out.println("Part of Speech of "+Words[2*n1]+" is "+Words[2*n1+1]);
                    //fout.write("\n");
                    //fout.write("Part of Speech of "+Words[2*n1-2]+" is "+Words[2*n1-1]);
                    System.out.println(" Part of Speech of "+Words[2*n1-2]+" is "+Words[2*n1-1]);
                   // System.out.println("  "+Words[2*n1-2]+" is a noun chunk with "+ Words[2*n1]);
                    fout.write("\n");
                 //   fout.write("  "+Words[2*n1-2]+" is a noun chunk with "+ Words[2*n1]);
                    
            
                  
                  }
                  else if ((2*n1-2)<stopindex){
                    //fout.write("\n");
                    //fout.write("Part of Speech of "+Words[2*n1-2]+" is "+Words[2*n1-1]);
                    System.out.println("else Part of Speech of "+Words[2*n1-2]+" is "+Words[2*n1-1]);
                  }
                 // //fout.write("Part of Speech of "+Words[n1]+" is "+postagset[index]);
                   
                  //System.out.println("Part of Speech of "+Words[2*n1-1]+" is "+postagset[index]);
                  //fout.write("\n");
                  try{
                    if(parserelation[n1].equals("Oth")) parserelation[n1] = "Chunk with "+words[n1];
                  }
                  catch(NullPointerException ne){};
                  System.out.println("before try n1="+n1);   
                  try{
                    System.out.println("n1="+n1+" ctn1="+ctn1+"  ctr="+ctr);
                  if(!parserelation[n1-1].equals("next") && n1!= 1 ){
                    while(ctn1 != 1){
                      System.out.println("relation zone Words["+(2*n1+ctr)+"]="+Words[2*n1+ctr]+"   Words["+(2*n1+ctr+1)+"]="+Words[2*n1+ctr+1]);
                      //if(!Words[2*n1+ctr+1].equals("PSPKO") && !Words[2*n1+ctr+1].equals("PSPLAI") && !Words[2*n1+ctr+1].equals("PSPLE")){
                      if(Words[2*n1+ctr+1].equals("NN") || Words[2*n1+ctr+1].equals("NNP") ){  
                        System.out.println("Relation of  "+Words[2*n1+ctr]+" with verb is "+ parserelation[n1-1]);
                        //fout.write("Relation of  "+Words[2*n1+ctr]+" with verb is "+ parserelation[n1-1]);
                        //fout.write("\n");
                        ctn1=1;
                        
                        System.out.println("relation ctn1="+ctn1+"  ctr="+ctr);
                      }
                      if( Words[2*n1+ctr-1].equals("NN") || Words[2*n1+ctr-1].equals("NNP")){  
                        System.out.println("next Relation of  "+Words[2*n1-ctr-2]+" with verb is "+ parserelation[n1-1]);
                        //fout.write("next Relation of  "+Words[2*n1-ctr-2]+" with verb is "+ parserelation[n1-1]);
                        //fout.write("\n");
                        ctn1=1;
                  ...
                  if(!parserelation[n1-1].equals("next") && n1 == 1) {
                      System.out.println("else if Relation of  "+Words[2*n1-2]+" with verb is "+ parserelation[n1-1]);
                      //fout.write("Relation of  "+Words[2*n1-2]+" with verb is  "+ parserelation[n1-1]);
                      //fout.write("\n");

                  }
                  System.out.println(" Parsed relation is "+ parserelation[n1]);
                  if(parserelation[n1].equals("next1") && n1 != 0){
                   // System.out.println("else Relation of  "+Words[2*n1-1]+" with verb is a chunk with "+ Words[2*n1-2]);
                    ////fout.write("else Relation of  "+Words[2*n1-1]+" with verb is a chunk with "+ Words[2*n1-2]);
                      //fout.write("\n");
                    System.out.println("  "+Words[2*n1-2]+" is a noun chunk with "+ Words[2*n1]);
                    //fout.write("\n");
                    //fout.write("  "+Words[2*n1-2]+" is a noun chunk with "+ Words[2*n1]);
                  ...
                  if((Words[n1].equals("JJ") && Words[n1+2].equals("NN"))  ){
                   // System.out.println("else Relation of  "+Words[2*n1-1]+" with verb is a chunk with "+ Words[2*n1-2]);
                    ////fout.write("else Relation of  "+Words[2*n1-1]+" with verb is a chunk with "+ Words[2*n1-2]);
                      //fout.write("\n");
                    System.out.println("  "+Words[n1-1]+" is a noun chunk with "+ Words[n1+1]);
                    //fout.write("\n");
                    //fout.write("  "+Words[n1-1]+" is a noun chunk with "+ Words[n1+1]);
              ...
              String[] English = new String[words.length];
              for(int i=0;i<words.length;i++){
                English[i] = "null1";
              }
  ...
  //}
    ...
    public int[][] intrachunk(String[] np, String[] tnp, int[][] duplicateparse, int ln, String[] vb, String filename, String filename1, String out, String[] sent, BufferedWriter fout2){
...
//      int fugee = 0;
      ...
      System.out.println("k2pexist = "+k2pexist+"   k3exist="+k3exist+"  k5exist"+k5exist);
  ...
  //        fugee = 1;
    ...
    //try{
        ...
        System.out.println("k2p="+k2pexist+"  k7texist="+k7texist);
        if(transitive == 1 && !k2pexist && !k7texist && k5exist == 0){
          System.out.println("Sentence is transitive");
          for(int s=0;s<np.length && ekaexist == 0 ;s++){
                   System.out.println("because Sentence is transitive");
                   duplicateparse[1][s] = 0;
  ...
  //} 
    ...
    //System.out.println();
  //  int parcnt = 0;
    System.out.println("addone ="+addone+"  ln ="+ln);
      if( addone){
              duplicateparse[ln-1][5] = 1;
            }
                    ...
                    if(!NP[r].equals(null))
                    {
                     // try{
                      ...
                      for(int r1=r;r1<chunkinfo.length &&  chunkinfo[r1+1]!=0 && ctsing == 0;r1++){
                         ...
                         // else
                         // {
                          System.out.println("parserelation length later = "+parserelation.length);
                            for(int r3 = r ; r3 < parserelation.length ; r3++){
                               System.out.println("parserelation["+r3+"]="+parserelation[r3]);
                              if(!parserelation[r3].equals("Oth") && !parserelation[r3].equals("next") && relcount == 0){
                                if(r3>0 && parserelation[r3].equals(a)){
                                  r3 = r3 + 1;
                                  fout.write("_"+parserelation[r3]);
                                  ...
                                  fout.write("_"+parserelation[r3]);
                                  a = parserelation[r3];
                                  System.out.println("parserelation["+r3+"]="+parserelation[r3]+"  a="+a);
                                }
   ...
   // System.out.println
    ...
    /*  if(words[0].equals("\u0909\u0928\u093f"))// Uni
     ...
     /* else{
      ...
      //fout.write("\n");
      if(plural == 0)
        plural = getNegation2("\u091b\u094c", words[0]);   // chau
      //fout.write("\n");
      if(plural == 1){
        plural = 4;
        pluralharu = 1;
      ...
      for(int v=0;v<vb.length;v++){
        ...
        //plural = getNegation4("\u0928\u0941\u0939\u0941\u0928\u094d\u091b", words[0]);   // NUHUNCH
        }
      }
      ...
      if(plural == 0){
        ...
        System.out.println("123 plural = "+plural);
        if(plural == 0 ){
          plural = getNegation("\u091b\u0928\u094d", words[0]);
...
if(neg == 0)
    ...
    if(neg == 0)
      ...
      System.out.println(" neg="+neg+"  plural="+plural+"  first="+first+"  second="+second+"  third="+third+"  SPreT="+spre+" SPast="+spast+"  Sfut="+sfuture+"  pastc="+pastc+"  spc ="+spc+"  futurec="+futc+"np length ="+np.length);
      ////fout.write(" neg="+neg+"  plural="+plural+"  first="+first+"  second="+second+"  third="+third+"  SPreT="+spre+" SPast="+spast+"  Sfut="+sfuture+"  pastc="+pastc+"  spc="+spc+"  futurec="+futc);

      System.out.println("nlrows ="+nlrows);
     // try{
      for(int r=0;r<(nlrows-1);r++){
        System.out.println("words["+r+"]="+words[r]+"  tags["+(r+1)+"]="+tags[r+1]);
        if(words[r].equals("\u0909\u0928\u093f") || words[r].equals("\u0926\u093f\u0926\u0940") || words[r].equals("\u092c\u0939\u093f\u0928\u0940") || words[r].equals("\u092c\u093f\u0939\u0928\u0940")  )// Uni or or didi or bahini or bihani
      {
        gender = 1;
        third = 1;
...
// PRESENT PERFECT TENSE
              ...
              if(cont == 1){
                ...
                if( ekoexist == 1  || ekiexist == 1){// || vb[v].equals("\u091b\u0928")){
                  if(front.equals("\u0939\u0941\u0928\u0947")){
                    fperf = 1;
                    neg = 0;
                    System.out.println("future perfect Tense futurepc="+fperf+"   neg="+neg);
                  }
              ...
              if(cont == 1){
                ...
                if( ekoexist == 1  || ekiexist == 1){// || vb[v].equals("\u091b\u0928")){
                  if(front.equals("\u0925\u093f")){
                    pperf = 1;
                    neg = 0;
                    System.out.println("Past perfect Tense pperf="+pperf+"   neg="+neg);
                  }
            
                 }
                  if(pperf == 1 && (vb[v+1].equals("\u091b\u0948\u0928") || vb[v+1].equals("\u091b\u0948\u0928\u094c") || vb[v+1].equals("\u091b\u0948\u0928\u0901") || vb[v+1].equals("\u091b\u0948\u0928\u0928\u094d")  ) ){// || vb[v].equals("\u091b\u0928")){
                    pperf = 1;
                    neg = 1;
                    System.out.println("Past perfect Tense pperf="+pperf+"   neg="+neg);
      ...
      System.out.println("new neg="+neg+"  plural="+plural+"  first="+first+"  second="+second+"  third="+third+"  SPreT="+spre+" SPast="+spast+"  fut="+sfuture+" spc="+spc+"  pastc="+pastc+"  futc="+futc+"  fperfect="+fperf+"  sperf ="+sperf+"  past perfect ="+pperf);
      ////fout.write("new neg="+neg+"  plural="+plural+"  first="+first+"  second="+second+"  third="+third+"  SPreT="+spre+" SPast="+spast+"  Sfut="+sfuture+" spc="+spc+"  pastc="+pastc+"  fcont="+futc+"  fperfect="+fperf+"  sperf ="+sperf+"  past perfect="+pperf);
      //fout.write("\n");
      if(QWexist1 != 200){
        //fout.write("1. Sentence is Interrogative.");
      ...
      System.out.println("wait Simple perfect Tense futurec="+futc+"   neg="+neg+"  gender ="+gender);
      English1 = getEnglishsentence(duplicateparse, np, words, tags, parserelation, words[0], neg,plural,first,second,third,spre,spast,sfuture, chunkinfo, spc,pastc,futc,fperf,sperf,pperf, sent, filename,fout2,gender,vb,garnuexist,pluralverb);
    fout.write("\n");
     fout.write("\n");
     // fout.write("English Translation:");
      try{
  ...
  //}
   ...
   /* public static String translate(String text, Language sourceLang, Language targetLang, boolean markTranslation) {
    ...
    /*public static Language processLanguage(int one) {
  // 由于中文前缀一样，需针对中文特殊处理。
...
public static String[][] getTraslation(String fileName) throws IOException {
        ...
        try {
            ...
            while(line != null){
              ...
              //System.out.println("check verb vibhakti");
              //for(int i=0;i<3;i++){
                while (stc.hasMoreTokens() && ind <10) {
                  //counterc++;
                  //System.out.println("counterc="+counterc);
                  wsc = stc.nextToken();
    ...
    public static String[][] getrootTraslation(String fileName) throws IOException {
        BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(fileName), "UTF-8"));
        BufferedReader br1 = new BufferedReader(new InputStreamReader(new FileInputStream(fileName), "UTF-8"));
        String wsc = "hi";
        String[][] twd = new String[1100][7];
        int counterc = -1;
        int ind=0;
        try {
            StringBuilder sb = new StringBuilder();
    ...
    public int getNegation(String findMe, String file){
      int ans = 0;
    ...
    g[0] = "ab";
      ...
      //  for(int i = 0; i < s; i++) {
          //  //System.out.println("i ="+i+"file["+i+"]="+file[i]);
           if(findMe1.equals(findMe) || findMe1.equals("\u0947\u0915\u094b")) {
...
//              count++;
    ...
    public int getNegation1(String findMe, String file){
      int ans = 0;
      ...
      //  for(int i = 0; i < s; i++) {
          //  //System.out.println("i ="+i+"file["+i+"]="+file[i]);
           if(findMe1.equals(findMe)) {
               ...
               //System.out.println(" filelength="+fileLength);   
              foundIt = true;
              g[0] = file.substring(0, fileLength - 4);
              front = g[0];
              System.out.println("g[0]="+g[0]);
              g[1] = findMe1;
              ans = 1;
...
//              count++;
    ...
    public int getNegation2(String findMe, String file){
      int ans = 0;
...
//              count++;
    ...
    public String getNegation21(String findMe, String file){
      int ans = 0;
...
//              count++;
    ...
    public int getNegation3(String findMe, String file){
      int ans = 0;
      ...
      String[] positions = new String[50000];  // Maximum number of tags to each words = 5
       ...
       int fileLength = file.length();
        ...
        if(fileLength > 7){
          try{
            findMe1 = file.substring(fileLength-8,fileLength);
    }
    catch(ArrayIndexOutOfBoundsException ae){}
  }
  else
      ...
      //  for(int i = 0; i < s; i++) {
          //  //System.out.println("i ="+i+"file["+i+"]="+file[i]);
           if(findMe1.equals(findMe)) {
               ...
               //System.out.println(" filelength="+fileLength);   
              foundIt = true;
              g[0] = file.substring(0, fileLength - 8);
              front = g[0];
              System.out.println("g[0]="+g[0]);
              g[1] = findMe1;
              ans = 1;
...
public int getNegation4(String findMe, String file){
      int ans = 0;
      ...
      String[] positions = new String[50000];  // Maximum number of tags to each words = 5
       ...
       int fileLength = file.length();
        ...
        if(fileLength > 6){
          try{
            findMe1 = file.substring(fileLength-7,fileLength);
    }
    catch(ArrayIndexOutOfBoundsException ae){}
  }
  else
      ...
      //  for(int i = 0; i < s; i++) {
          //  //System.out.println("i ="+i+"file["+i+"]="+file[i]);
           if(findMe1.equals(findMe)) {
               ...
               //System.out.println(" filelength="+fileLength);   
              foundIt = true;
              g[0] = file.substring(0, fileLength - 7);
              front = g[0];
              System.out.println("g[0]="+g[0]);
              g[1] = findMe1;
              ans = 1;
...
//              count++;
    ...
    public int getNegation5(String findMe, String file){
      int ans = 0;
      ...
      String[] positions = new String[50000];  // Maximum number of tags to each words = 5
       ...
       int fileLength = file.length();
        ...
        if(fileLength > 1){
          try{
            findMe1 = file.substring(fileLength-1,fileLength);
    }
    catch(ArrayIndexOutOfBoundsException ae){}
  }
  else
      ...
      //  for(int i = 0; i < s; i++) {
          //  //System.out.println("i ="+i+"file["+i+"]="+file[i]);
           if(findMe1.equals(findMe)) {
               ...
               //System.out.println(" filelength="+fileLength);   
              foundIt = true;
              g[0] = file.substring(0, fileLength - 1);
              front = g[0];
              System.out.println("g[0]="+g[0]);
              g[1] = findMe1;
              ans = 1;
...
//              count++;
    ...
    public int getNegation6(String findMe, String file){
      int ans = 0;
      ...
      String[] positions = new String[50000];  // Maximum number of tags to each words = 5
       ...
       int fileLength = file.length();
        ...
        if(fileLength > 4){
          try{
            findMe1 = file.substring(fileLength-5,fileLength);
    }
    catch(ArrayIndexOutOfBoundsException ae){}
  }
  else
      ...
      //  for(int i = 0; i < s; i++) {
          //  //System.out.println("i ="+i+"file["+i+"]="+file[i]);
           if(findMe1.equals(findMe)) {
               ...
               //System.out.println(" filelength="+fileLength);   
              foundIt = true;
              g[0] = file.substring(0, fileLength - 5);
              front = g[0];
              System.out.println("g[0]="+g[0]);
              g[1] = findMe1;
              ans = 1;
...
public int getNegation7(String findMe, String file){
      int ans = 0;
      ...
      String[] positions = new String[50000];  // Maximum number of tags to each words = 5
       ...
       int fileLength = file.length();
        ...
        if(fileLength > 5){
          try{
            findMe1 = file.substring(fileLength-6,fileLength);
    }
    catch(ArrayIndexOutOfBoundsException ae){}
  }
  else
      ...
      //  for(int i = 0; i < s; i++) {
          //  //System.out.println("i ="+i+"file["+i+"]="+file[i]);
           if(findMe1.equals(findMe)) {
               ...
               //System.out.println(" filelength="+fileLength);   
              foundIt = true;
              g[0] = file.substring(0, fileLength - 6);
              front = g[0];
              System.out.println("g[0]="+g[0]);
              g[1] = findMe1;
              ans = 1;
...
//              count++;
    ...
    public int getNegation8(String findMe, String file){
      int ans = 0;
...
//              count++;
    ...
    public String getEnglishword(String nepali){
          return "abc";
    }

    public String[] getEnglishsentence(int[][] parsedtree, String[]  chunk,String[] nep, String[] tags, String[] rel, String vb, int ne, int pl, int f, int s, int thd, int sp, int spa, int sf, int[] tsword, int spc,int pastc,int futc,int fperf,int sperf,int pperf, String[] sen, String fn, BufferedWriter fout2 , int gend, String[] verbs, int garnu, int pluralv){
        String[] eng = new String[nep.length+5];
        String verbal = "hi";
        System.out.println("nep length="+nep.length);
        for(int i = 0 ; i < nep.length ; i++){
          eng[i]="null1";
        }
        String[] engTr = new String[nep.length];
        String[] engverbs = {"is","are","was","were","will","shall","has","have","am"};
        String[] articles = {"a","an","the"};
        boolean vbexist = true;
        int vbindex = 0;
        int npindex = 0;
        System.out.println("verb is "+vb+"  chunk.length="+chunk.length);
        System.out.println("Verb vb="+vb+" negative ne="+ne+" Plural pl="+pl+" future f="+f+" singular"+s+" third thd="+thd+" simple present sp="+sp+"  simple past spa="+spa+"  simple future sf= "+sf+"  simple present continuous spc= "+spc+"  past cont="+pastc+"  future cont="+futc+" future perfect ="+fperf+"  simple perfect="+sperf+" past perfect= "+pperf+" fn= "+fn+"  gend="+gend+" pluralverb ="+pluralv);
        
      System.out.println("Welcome to English Translaiton early");
     
        for(int s2=0;s2<engTr.length;s2++){
          engTr[s2] = "null1";
        }
        for(int p=0;p< chunk.length;p++){
          System.out.println("chunk["+p+"]="+chunk[p]);
        }
        //for(int p1=0;p1< verbs.length;p1++){
        try{
        if(!verbs[1].equals("n") || !verbs[1].equals(null)){
          System.out.println("verb chunk ="+verbs[1]+" verbs["+0+"]="+verbs[0]);
          verbal = verbs[1];
          System.out.println("verbs["+1+"]="+verbal);
        }
      }
        catch(ArrayIndexOutOfBoundsException ai){};
        int wdct = 0;
        for(int p=0;p< tsword.length;p++){
          if(p < (tsword.length-1))
            tsword[p] = tsword[p+1];
          System.out.println("tswords["+p+"]="+tsword[p]);
          /*if(p%2 == 0 && tsword[p] > 1){
              tsword[p] = 0;
          }*/
        }
        ...
        //wdct = wdct/2;
         // tsword = chunk[c].trim().split("\\s+");
         System.out.println("hi tags.length="+tags.length+" word count ="+wdct+"  chunk length="+chunk.length+"  QWexist="+QWexist);
         for(int s2=0;s2<wdct;s2++){
          for(int l1=0;l1<tagset.length;l1++){
              if(sen[s2].equals(tagset[l1]) && s2%2 != 0){
                //if(wdct >6 )
                System.out.println("sen["+s2+"]="+sen[s2]+"  s2="+s2);
                int inds2 = s2/2;
                System.out.println("l1="+l1+"  s2="+s2);
                  anninput[inds2] = l1 + 1;
                //if (wdct <=6  && sen[s2].equals("VAUX")){    
                  //anninput[inds2] = 0;
                  //anninput[36] = 1;     // non verbal sentenses
                //}
              }
          }
         }

         for(int s1=0;s1<wdct;s1++){
          System.out.println("sent["+s1+"]="+sen[s1]);
              
              if(/*(wdct >6) && */(sen[s1].equals("VF") || sen[s1].equals("VAUX"))){
                ...
                break;
                 ...
                 System.out.println("No verb exist");
                vbexist = false;
              }
         }
        //}
        for(int i = 0 ; i < wdct && vbexist; i++){
         // eng[i] = getEnglishword(nep[i]);
          System.out.println("sen["+i+"]="+sen[i]);//+"   chunk["+i+"]="+chunk[i]+"  tsword["+(i+1)+"]="+tsword[i+1]);
        }
        System.out.println("English word count ="+wdct+"  QWexist1="+QWexist1);
        int time = 0;
        if(/*QWexist > 0 ||*/ QWexist1 != 200){time = -1;}
        String[] english = new String[wdct];
        String[] tempenglish = new String[wdct];
        int[] tempenglishpos = new int[wdct];
        String[] englishchunk = new String[chunk.length+time+1];
        String vbenglish = "hi";
        int biden =0;
        int biden1 = 0;
        String engverb = "hi";
      ...
      //  String[] englishunicode = new String[wdct];
       /* if(verbal[j1].equals(dictionary[k][1]) ){
                       System.out.println("dictionary verbal["+j1+"]="+sen[j]+" tempenglish["+biden+"]="+tempenglish[biden]);
                       
        }*/
        try{
          for(int j=0;j<wdct;j++){
             int tempk = 0;
             System.out.println("sen["+j+"]="+sen[j]+"   garnu="+garnu);
             if(QWexist1 != 200){
               // sen[j] = sen[j+2];
                System.out.println("inside quesiton new sen["+j+"]="+sen[j]);
             }
             if(j%2 == 0){
                    anninput[70+j]=1999;
                     anninput[90+j] = 1999;
                     english[j] = sen[j];
                     //englishunicode[j] = getengUnicode(sen[j]);
                    // System.out.println("sen["+j+"]="+sen[j]+"   english unicode ="+englishunicode[j]);
                     System.out.println("prior english ["+j+"]="+english[j]);
                  }
                  if(sen[j].equals("NN") || sen[j].equals("NNP")){
                        finalverb =1;
                      }
                      if(sen[j].equals("PRP") || sen[j].equals("PRL")){
                        finalverb =2;
                      }
                      /*if(sen[j+1].equals("RB")){
                        if(sen[j-1].equals("NN") || sen[j-1].equals("NNP") || sen[j-1].equals("PRP"))
                           finalnnrb = 1;
                      }*/
                     /* else{
                        finalnnrb = 0;
                      }*/
                     /* if(sen[j+1].equals("PSPLE") || sen[j+1].equals("PSPLAI")){
                        System.out.println("finalverb="+finalverb);
                        finalverb = 3;
                      }*/
              String mainverb = "null1";
              int reachablek = 0;
              int frequency = 0;
              int conjcount = 0;
              String[] verbconjuction =new String[3];
              for(int k=0;k<dictionary.length;k++){
                     try{
                      //if(verbal.length ==2){
                       // System.out.println("Fresh two verbal english");
                        
                        if(verbs[0].equals(dictionary[k][1]) && busvb0 == 0 && !verbal.equals("hi")){
                            mainverb = dictionary[k][2];
                            System.out.println("main verb ="+mainverb);
                            busvb0 = 1;
                        }
                        if(verbal.equals(dictionary[k][1]) && busvb1 ==0 ){  // multi verbal 
                          vbenglish = dictionary[k][2];
                          reachablek =1;  // collection of such nouns which depend on 2 double verbs
                          System.out.println("verbal english="+vbenglish);
                          busvb1 =1;
                        }
                      else {
                          reachablek =0;
                        }
                      //  System.out.println("again main verb ="+mainverb);
                        if(!mainverb.equals("null1") && garnu == 1 && busvb2 == 0){
                            vbenglish = "should "+vbenglish+" "+mainverb;
                          reachablek =1;  // collection of such nouns which depend on 2 double verbs
                          System.out.println("main verbal english="+vbenglish);
                          busvb2 = 1;
                        }
                      // }
                  if(sen[j].equals(dictionary[k][1]) ){
                      frequency++;
                      System.out.println("dictionary sen["+j+"]="+sen[j]+" tempenglish["+biden+"]="+tempenglish[biden]);
                      anninput[70+j]=k+1;
                      anninput[90+j] = k+1;
                      System.out.println("dictionary anninput["+(70+j)+"]="+anninput[70+j]);
                      //if(engverb.equals("hi")){
                          System.out.println("prior engish verb ="+engverb+"  position="+dictionary[k][0]);
                          tempenglish[biden] = dictionary[k][2];
                          String tnp1 = dictionary[k][0];
                          int tp1 = Integer.parseInt(tnp1);
                          System.out.println(" again position="+tp1);
                        //  tempenglishpos[biden] = Integer.parseInt(tnp1);
                        //}

                      con++;
                      
                      System.out.println("finalverb ="+finalverb+"  english verb="+engverb+"  verbal length="+verbal+"  verb ="+vb+"  reachable k="+reachablek);
                      if(sen[j].equals(vb) && garnu == 0){
                        engverb = dictionary[k][2];
                      if(sen[j].equals("vb") && garnu == 1){
                        engverb = "should "+dictionary[k][2];
                        System.out.println("verb garnu ="+engverb);
                      }
                      System.out.println("Garnu ="+engverb);
                        if(finalverb == 1 && (dictionary[k][2].equals("is") || dictionary[k][2].equals("was") || dictionary[k][2].equals("were")))
                          System.out.println("Hi its noun verb");
                      //  engverb = dictionary[k][2];
                        tempk = 0;
                       }
                       System.out.println("verbs length="+verbslength+"  frequency="+frequency+" tp1="+tp1+" dict length="+dictionary.length+" dict["+k+"]["+1+"]="+dictionary[k][1]);
                        if(tp1 > 1499 && tp1 < 1600){
                            String stringconceng = "hi";
                       int stringlen = dictionary[k].length;
                       System.out.println("conjuction string length ="+stringlen);
                            System.out.println("Verb Conjuction entry:");
                            for(int n=0;n<10 ;n++){
                              System.out.println("dictionary["+k+"]["+n+"]="+dictionary[k][n]);
                              if(dictionary[k][n].equals("=")){
                                int startpt = n+1;
                                stringconceng = dictionary[k][startpt]+" ";
                                System.out.println("string concat="+stringconceng+" start point="+startpt);
                                for(int n1=(n+2);n1<stringlen;n1++){
                                  if(!dictionary[k][n1].equals("null1")){
                                    System.out.println("String concat is ="+stringconceng+" temp before concat english["+(biden1-1)+"]="+english[biden1-1]);
                                      stringconceng = stringconceng.concat(dictionary[k][n1]);
                                      engverb = stringconceng;
                                     // if((biden1-1) >= startpt)
                                      //  engverb = stringconceng+" "+english[biden1-1];
                                      System.out.println("String concat is ="+stringconceng+" temp concat english["+(biden1-1)+"]="+engverb);
                                    }
                                }
                              }
                            }
                       ...
                       if(verbslength > 1 && frequency > 1){
                        if(tp1>1400   && tp1 <1500){
                          english[biden1-1] = tempenglish[biden];
                        }
                        System.out.println("conjuction string length ="+tp1);

                       

                        //if(finalverb == 1 && (dictionary[k][2].equals("is") || dictionary[k][2].equals("was") || dictionary[k][2].equals("were")))
                          System.out.println("reachablek ="+reachablek+" verb ="+vb+" k="+k+" english["+biden1+"]="+english[biden1]);
                      //  engverb = dictionary[k][2];
                        tempk = 1;
                       }
                       
                       /*if(verbslength >1 && frequency == 0){
                        if(tp1>=1500 ){
                            System.out.println("Verb Conjuction entry:");
                            for(int n=0;n<4;n++){
                                if(!dictionary[k][n].equals("=") ){
                                  nepalistring = dictionary[k][n];
                                  verbconjuction[conjcount] = nepalistring + dictionary[k][n];
                                }
                                }
                          //engverb = dictionary[k][2];
                            }
                       }*/
                      // if(verbslength == 1) tempk=1;
                       //if(english[biden1].equals("vibhakti")) tempk=1;
                      System.out.println(" temp English["+biden+"]="+tempenglish[biden]+" tempk="+tempk+"  final nn rb ="+finalnnrb);
                      /*if(finalnnrb == 1){
                        english[biden1] = dictionary[k][2]+" "+english[biden1-1];
                        finalnnrb = 0;
                      }*/
                      if(tempk == 0 ){
                        english[biden1] = dictionary[k][2];
                        System.out.println(" main English["+biden1+"]="+english[biden1]);
                        tempk = 1;
                       // englishchunk[i] = english[trump];
                        //if(!english[biden1].equals("vibhakti"))
                          biden1++;
                      }
                      //if(!sen[j].equals(vb))
                      biden++;
              ...
              for(int k=5000;k<dictionaryverb.length;k++){
                     try{
                  if(sen[j].equals(dictionaryverb[k][1]) ){
                      System.out.println("dictionary sen["+j+"]="+sen[j]+" tempenglish["+biden+"]="+tempenglish[biden]+" finalverb verb="+finalverb);
                     // anninput[70+j]=k+1;
                      //anninput[90+j] = k+1;
                      System.out.println("dictionary verb anninput["+(70+j)+"]="+anninput[70+j]);
                      
                  //    tempenglish[biden] = dictionaryverb[k][2];

                      con++;
                      if(sen[j].equals(vb)  ){
                        if( spa == 1){
                          engverb = dictionaryverb[k][3];
                        }
                        if(thd == 0 && sp==1){
                          engverb = dictionaryverb[k][2];
                        }
                        if(sperf == 1 || fperf == 1 || pperf == 1){
                          engverb = dictionaryverb[k][4];
                        }
                        if(thd == 1 && sp==1){
                          engverb = dictionaryverb[k][5];
                        }
                        if(spc == 1 || pastc == 1 || futc == 1){
                          engverb = dictionaryverb[k][6];
                        }
                        if(pl == 4 && sp == 1){
                          engverb = "are "+engverb;
                        }
                        ...
                        if(pl == 4 && spa == 1 && ne != 2){
                          engverb = "were "+engverb;
                        }
                        if(pl == 3 && spa == 1 && ne != 2){
                          engverb = "was "+engverb;
                        }
                        if(ne == 2 && spa == 1 && pl == 4){
                          engverb = " were not "+engverb;
                        }

                      }
                         

                      System.out.println(" temp verb English["+biden+"]="+tempenglish[biden]+" tempk="+tempk+" verb ="+engverb);
                      
                     /* if(tempk == 0){
                        english[biden1] = dictionaryverb[k][3];
                        System.out.println(" main verb English["+biden1+"]="+english[biden1]);
                        tempk = 1;
                        biden1++;
                      }*/
                      //if(!sen[j].equals(vb))
       ...
       /*   try{
          for(int j=0;j<wdct;j++){
             int tempkverb = 0;
             System.out.println(" verb sen["+j+"]="+sen[j]);
             if(j%2 == 0){
               //     anninput[70+j]=1999;
                 //    anninput[90+j] = 1999;
                   //  english[j] = sen[j];
                     System.out.println("prior verb english ["+j+"]="+english[j]);
                  }
              for(int k=0;k<dictionaryverb.length;k++){
                     try{
                  if(sen[j].equals(dictionaryverb[k][1]) ){
                      System.out.println("dictionary sen["+j+"]="+sen[j]+" tempenglish["+biden+"]="+tempenglish[biden]);
                      //anninput[70+j]=k+1;
                     ...
                     // tempenglish[biden] = dictionaryverb[k][2];
                      ...
                      con++;
                      if(sen[j].equals(vb))
                         engverb1 = dictionaryverb[k][2];

                      System.out.println(" temp English["+biden+"]="+tempenglish[biden]+" tempk="+tempk);
          ...
          boolean fair = false;
          int fairNNJJ = 0;
          //if(chunk.length == 1) time= 2;
          System.out.println("chunk length ="+chunk.length+"  time="+time);
          for(int i = 0 ; i < chunk.length+time  ; i++){
              System.out.println("tswords["+i+"]="+tsword[i]+"  tswords["+(i+1)+"]="+tsword[i+1]+"  english["+index+"]="+english[index]);
              if(QWexist > 0 && QWexist <50)
                index = index + tsword[i+1];
              else
                index = index + tsword[i+1]+1;
             // if(i==0)
              System.out.println("position of english ="+(index-tsword[i+1]+1));
               // int trump = index-tsword[i+1]+1;
             // if(i!=0 && tsword[i] == 0) trump = trump + 1;
              if(tsword[i]==0 && tsword[i+1]!= 0){
                trump++;
              }
              if(i==0 )//|| tsword[i] == 2)
                trump = i;
              else {
                trump = trump + tsword[i-1];
              }
              if(tsword[i] == tsword[i+1] && tsword[i] == 0){
                System.out.println("sentence is over :");
                break;
               // english[trump] = "null1";
              }
              System.out.println("old eng["+trump+"]="+english[trump]);
              int faltu = 0;
              /*if(english[trump].equals(null)){
                  System.out.println("non position");
                  englishchunk[i] = english[index-tsword[i+1]];
                }*/
                
              if(!english[trump].equals(null) ){
                  System.out.println("yes position english["+trump+"]="+english[trump]+" sen["+(2*i+1)+"]="+sen[2*i + 1]);
                 // englishchunk[i] = english[index-tsword[i+1]];
                  //englishchunk[i] = english[index+i];
                  if(sen[2*i + 1].equals("JJ") && sen[2*i + 3].equals("NN")){
                    fair = true;
                    System.out.println("Its a fair game JJNN");
                  }
                  if(sen[2*i + 1].equals("NN") && sen[2*i + 3].equals("JJ") && (sen[2*i + 5].equals("VF") || sen[2*i + 5].equals("VAUX"))){
                    fairNNJJ = 1;
                    englishchunk[i] = english[trump];
                   // englishchunk[i+2] = english[trump+2];

                    System.out.println("Its a un fair game NNJJ");
                  }
                  System.out.println("verb index ="+vbindex+" i="+i+" englishchunk["+i+"]="+englishchunk[i]+"  trmpt ="+trump+" english["+trump+"]="+english[trump]);
                  if((2*i + 1) != vbindex && !english[trump].equals("null1") && !english[trump].equals("vibhakti") ){
                    englishchunk[i] = english[trump];
                  }
                 /* else{
                    englishchunk[i] = english[i];
                  }*/
                  if(i > 1 && englishchunk[i] == englishchunk[i-1] && !fair){
                    System.out.println("Repeat english words");
                    //i = i -1;
                   // englishchunk[i-1] = "1234";
                   // trump++;
                    englishchunk[i] = english[trump+1];
                    englishchunk[i] = "123";
                  }
              ...
              //else
                System.out.println("englishchunk["+i+"]="+englishchunk[i]+" index="+index);
               // englishchunk[i] = english[i+tsword[i+1]-1];
            // eng[i] = getEnglishword(nep[i]);
            for(int r=1;r<tsword[i] && vbexist;r++){
             // if(!english[index-tsword[i+1]+1+r].equals(null))
              //if(i%2 != 0){
              System.out.println("previous english["+trump+"]="+english[trump]+"  r="+r+"  english["+(trump+1)+"]="+english[trump+1]);

              if(i>=1 && !english[trump+r].equals("take") && !english[trump+r].equals("are") && !english[trump+r].equals("are") ){
                System.out.println("take");
                if(!english[trump+r].equals("vibhakti"))
                  englishchunk[i] = englishchunk[i]+" "+english[trump+r];
                System.out.println("current english["+(i-1)+"]="+englishchunk[i-1]);
              }
              else{
                System.out.println("Dont take");
                //englishchunk[i] = englishchunk[i];
                if(i==0 && !sen[2*i + 3].equals("JJ") && !english[trump+r].equals("take"))
                  englishchunk[i] = englishchunk[i]+" "+english[trump+r];
                else if(fairNNJJ == 0){
                    englishchunk[i] = englishchunk[i];
                }
              ...
              if(fairNNJJ == 1 ){
                System.out.println("special NNJJ ");
                //System.out.println("english="+english[trump+1]+"  englishchunk["+(i+1)+"]="+englishchunk[i+1]+"  englishchunk["+(i)+"]="+englishchunk[i]);
                englishchunk[i+1] = english[trump+1];
                System.out.println("english="+english[trump+1]+"  englishchunk["+(i+1)+"]="+englishchunk[i+1]+"  englishchunk["+(i)+"]="+englishchunk[i]);
              }
              // englishchunk[i] = englishchunk[i]+" "+english[index-tsword[i+1]+1+r];
                anninput[40] = 1;  //CHUNK1: PRPNN
                //System.out.println("nep["+i+"]="+nep[i]+"   chunk["+i+"]="+chunk[i]);
                System.out.println("current english["+i+"]="+english[i]+"   englishchunk["+i+"]="+englishchunk[i]);
             // }
            }
          }
        }
          ...
          System.out.println("non position");
         // englishchunk[j] = english[j];
                 // trump = trump - 1;
        };

        // int ne, int pl, int f, int s, int thd, int sp, int spa, int sf
        if(pluralv == 1) anninput[49] = 1;
          else anninput[49] = 0;
        if(ne==2 || ne != 0) anninput[50] = 0;    // Negative
        else if(ne==0) anninput[50] = 2; // Positive
        if(pl==1) anninput[51] = 3; //
        if(pl==3 || pl != 4) anninput[51] = 3; //  singular
        if(pl==4) anninput[51] = 4; // plural haru
        if(f==1) anninput[52] = 1;
        if(s==1) anninput[53] = 1;
        if(thd==1) anninput[54] = 1;
        if(sp==1) anninput[55] = 1;
        if(spa==1) anninput[56] = 1;
        if(sf==1) anninput[57] = 1;
        if(spc==1) anninput[58] = 1;
        if(pastc==1) anninput[59] = 1;
        if(futc==1) anninput[60] = 1;
        if(sperf==1) anninput[61] = 1;
        if(pperf==1) anninput[62] = 1;
        if(fperf==1) anninput[63] = 1;
        if(QWexist >0 && QWexist <50) anninput[64] = 1;
        if(vbexist) anninput[65] = 1;
        if(k2pexist) anninput[66] = 1; else anninput[66] = 0;   // PLACE EXIST
        if(k7texist) anninput[67] = 1; else anninput[67] = 0;   // TIME EXIST
        if(k3exist) anninput[68] = 1; else anninput[68] = 0;    // KARANA EXIST
        anninput[69] = gend;   //0 means masculine, 1 female and 2 neutral
        int[] anninput1;
        anninput1 = anninput;

        try{
      OutputStreamWriter writer1 = new OutputStreamWriter(new FileOutputStream(fn, true), "UTF-8");
      BufferedWriter fout1 = new BufferedWriter(writer1);
        System.out.println("ANN input early");
       // fout1.write(" ANN input");
        
       // anninput1 = anninput;
        int cot = 70;
        for(int n=0; n<anninput.length;n++){
          System.out.println("new anninput1["+n+"]="+anninput1[n]);
          if(n>69){
          //  cot = n+cot;
            if(anninput[n] != 0){
              System.out.println("new new anninput1["+cot+"]="+anninput1[cot]);
              anninput1[cot]=anninput[n];
              System.out.print(" "+anninput[n]);
             // fout1.write(" "+anninput[n]);
              cot++;
            }
          }
          else{
       ...
       fout1.write("\n");
      int t = 69 + wdct/2;
      System.out.print("faripachu t="+t);
      int tt=70;
        int ttd = 0;
      for(int r=0;r<anninput1.length;r++){
        System.out.print(" "+anninput1[r]);
        
        if(r>=t && r < 90){
            anninput1[r] = 0;     // Reserved for long sentene of the length 20 words

        }
        for(int k = 90; k < 100;k++){
          anninput1[k] = 0 ;
        }
        for(int q = 0;q<wdct;q++){
            if( sen[q].equals("RB") ){
              System.out.println("RB q="+q+"  q="+q);
              if(q>0 ){
                for(int i1 =0 ; i1 < rel.length;i1++){
                 if(rel[i1].equals("Oth"))
                    rel[i1] = "Comparision(K*u)";
                    anninput[99] = 1;
                }
              //}
              //engTr[counter] = eng[index];
              System.out.println("RB rel["+(q-1)+"]="+rel[q-1]); 
            }
       ...
       // String[] relation = {"Karta(K1)","Karma(K2)", "Karana(K3)", "Sampradan(K4)", "Apadan(K5)","Sambandh(K6)","Adhikaran(K7)","Location(K2p)","Location(K7t)","Second Karta(K1s)"," Comparision(K*u)"};
        for(int j=0;j<rel.length;j++){
          System.out.println("rel["+j+"]="+rel[j]);
          if(rel[j].equals("Karta(K1)") && anninput1[90] == 0) {anninput1[90] = 1; System.out.println("hi");} //else anninput[90]=0;
          if(rel[j].equals("Karma(K2)") && anninput1[91] == 0) anninput1[91] = 1; //else anninput[91]=0;
          if(rel[j].equals("Karana(K3)") && anninput1[92] == 0) anninput1[92] = 1;// else anninput[92]=0;
          if(rel[j].equals("Sampradan(K4)") && anninput1[93] == 0) anninput1[93] = 1; //else anninput[93]=0;
          if(rel[j].equals("Apadan(K5)") && anninput1[94] == 0) anninput1[94] = 1; //else anninput[94]=0;
          if(rel[j].equals("Adhikaran(K7)") && anninput1[95] == 0) anninput1[95] = 1; //else anninput[95]=0;
          if(rel[j].equals("Location(K2p)") && anninput1[96] == 0) anninput1[96] = 1; //else anninput[96]=0;
          if(rel[j].equals("Location(K7t)") && anninput1[97] == 0) anninput1[97] = 1; //else anninput[97]=0;
          if(rel[j].equals("Second Karta(K1s)") && anninput1[98] == 0) anninput1[98] = 1; //else anninput[98]=0;
          if(rel[j].equals("Comparision(K*u)") && anninput1[99] == 0) anninput1[99] = 1; //else anninput[99]=0;
      }
        
        if(r>= 100){
          //for(int tt=66;tt<90;tt++)
            anninput1[r] = anninput1[tt];
            tt++;
      ...
      //System.out.println(" New Input Array");
            System.out.println(" New Input Array Revised intrachunk");
            try{
  //OutputStreamWriter writer2 = new OutputStreamWriter(new FileOutputStream(filename3, true), "UTF-8");
    //  BufferedWriter fout2 = new BufferedWriter(writer2);
      System.out.println(" New Input Array Revised intrachunk early");
      fout2.write("\n");
      fout2.write("\n");
      for(int r1=0;r1<anninput1.length;r1++){
       // if(r1 < 68){
          System.out.print(" "+anninput1[r1]);
          System.out.println();
         // fout2.write(" "+anninput1[r1]);
        //}
      }
      for(int r=0;r<anninput1.length;r++){
        if(r >68 && r <90){    // r = 69 reserved for gender (0,1 or 2)
          anninput1[r] = anninput1[r]/1500;   //normalization
        }
        if(r >99){    // r = 69 reserved for gender (0,1 or 2)
          anninput1[r] = anninput1[r];   //normalization
        }
        System.out.print(" "+anninput1[r]);
        fout2.write(" "+anninput1[r]);
      ...
      fout2.close();
        ...
        //eng[1] = "Sonam";
        //eng[2] = "Rama";
        if(vbexist && QWexist>0 && QWexist <50){
          eng[0]=english[0];
          System.out.println("verb english ="+vbenglish+" eng[0]="+eng[0]);
          if(!vbenglish.equals("hi") ){
            eng[0] = vbenglish+" "+english[0];
          }
          System.out.println(" verb eng[0] ="+eng[0]);
       // }
        }
        for(int p=0;p<chunk.length+time+1;p++){
          if(QWexist1 == 200){
            eng[p+1]=englishchunk[p];
          }
         /* else{
            eng[p+1]=englishchunk[p+1]; 
          }*/
          //eng[p+1]=english[p];
          System.out.println(" eng["+(p+1)+"]="+eng[p+1]);
          if(p == (chunk.length+time-1) ){
            System.out.println("two verbs :");
            //engverb = englishchunk[p];
          }
          System.out.println("Verb exist ="+vbexist+" word count"+wdct);
        }
     // }
        System.out.println("Verb exist ="+vbexist+" word count"+wdct);
        //eng[1] = "Sonam";
        ...
        int enter = 0;
        int ip = 100;
        int sampradankarma = 100;
        String temp = "krm";
        if(!vbexist){
          System.out.println("No verb");
          for(int l=0;l<=chunk.length && counter <= chunk.length;l++){
            System.out.println("new english["+l+"]="+english[l]);
            engTr[l] = english[l];
            System.out.println("NO VERB engTr["+counter+"]="+engTr[counter]); 
            counter++;
          }
        }
       /* else{
        ...
        for(int q=0;q<wdct;q++){
          if(sen[q].equals("QW")){
              System.out.println("Question exist QWexist="+QWexist);
           // QWexist = true;
          }
        ...
        String hold = "yes";
          int held = 0;
          int closed = 0;
          String carekarma = "hii";
          String inoun = "hii";
          int once = 0;
          int chunklength = 0;

         // boolean passigned = false;
          System.out.println("total words = "+wdct);
          for(int x =0;x < wdct ; x++){
              while(rel[x].equals("next")){
                chunklength++;
              }

          }
          System.out.println("total words = "+chunklength);
        for(int i = 0 ; i < chunklength && vbexist;i++){
          if(once == 0 && QWexist1 >0 && QWexist1 <50){
           // i=2;
            counter++;
            index++;
         ...
         /* if(tags[i].equals("PRP") && tags[i+1].equals("NN") && chunk[i].equals("PRP")){
          enter = 1;
        }*/
        try{
        System.out.println("  i="+i+" rel["+i+"]="+rel[i]+"  english["+i+"]="+english[i]+" sen["+(2*i+1)+"]="+sen[2*i+1]+"  eng["+index+"]="+eng[index]);
        if(sen[2*i+1].equals("PUNC")){
            closed=i;
        }
      }
        catch(NullPointerException ne22){};
        System.out.println("closed = "+closed+" QWexist="+QWexist);
          boolean assigned = false;
          
          if(QWexist >0 && QWexist <100){
            int qwind = QWexist/2  +  1;
            System.out.println("Question i="+i+" counter="+counter);
              engTr[counter] = eng[qwind]+" is";
              System.out.println("QW engTr["+counter+"]="+engTr[counter]); 
              index = 1;
              assigned = true;
              counter++;
              QWexist = -1;
            ...
            if( QWexist != -1 && rel[i].equals("Karta(K1)") && wdct >8){
              System.out.println("karta i="+i+" index="+index);
              engTr[counter] = eng[index];
              System.out.println("Karta engTr["+counter+"]="+engTr[counter]); 
              index++;
              assigned = true;
              counter++;
            }
            if(QWexist == 100 ){
              System.out.println("new karta i="+i+" index="+index);
              engTr[counter] = eng[index];
              System.out.println("Karta engTr["+counter+"]="+engTr[counter]); 
              index++;
              assigned = true;
            ...
            if((!assigned && tags[i].equals("PRP") ) || (!assigned && tags[i].equals("PRL") )){
              System.out.println("PRP i="+i+"  index="+index);
              if((english[i].equals("I") || english[i].equals("we") || english[i].equals("she") || english[i].equals("he")) && (tags[i+1].equals("NN") || tags[i+1].equals("VF"))){
                engTr[counter] = english[i];
               // counter++;
               // engTr[counter+2] = english[i+1];
                inoun = english[i+1];
                System.out.println("I engTr["+counter+"]="+engTr[counter]+"  inoun="+inoun);
              }
              else{
                engTr[counter] = eng[index];
              }
              System.out.println("PRP engTr["+counter+"]="+engTr[counter]); 
              index++;
              assigned = true;
              counter++;
            }
            System.out.println("verb english="+vbenglish+" english verb="+engverb);
            if(!vbenglish.equals("hi") && !vbenglish.equals("bus") && garnu == 0){
              eng[0] =  vbenglish+" "+engverb;
              engverb = vbenglish+" "+engverb;
              System.out.println("hi bus engverb="+engverb);
              vbenglish = "bus";
            }
            else if( !vbenglish.equals("bus") && garnu == 0){
              eng[0] = engverb;
              System.out.println("front bus engverb="+eng[0]);
            }
            else {
              eng[0] = vbenglish;
              System.out.println("else bus engverb="+eng[0]);
            }
            
            if(k2pexist || eng[0].equals("go") && entr == 0){
              engTr[counter] = eng[0]+" to";
              System.out.println("why k2p engTr["+counter+"]="+engTr[counter]);
             
              entr=1;
              assigned1=true;
              assigned = true;
              if(QWexist1 != 200){
                engTr[counter] = engTr[counter]+" "+inoun;
                System.out.println("Question engTr["+counter+"]="+engTr[counter]);
              }
              counter++;

             // assigned = true;
            }
            if(!assigned1 && (counter == 1 || counter == 2) && !k2pexist){
                engTr[counter] = eng[0];
                System.out.println("main bus engverb["+counter+"]="+engTr[counter]);
                if(thd == 1 && sp == 1 && pl==2){
                  engTr[counter] = engTr[counter]+"s";
                }
                counter++;
                assigned1 = true;
              }

            System.out.println("first counter="+counter+"  i="+i+"  assigned="+assigned+"  rel["+i+"]="+rel[i]+" engTr["+counter+"]= "+engTr[counter]+" sp="+sp+" pl ="+pl+" thd ="+thd+" eng[0]="+eng[0]+" eng["+i+"]="+eng[i]+"  assigned1="+assigned1);
           // counter++;
              engTr[counter] = eng[i];
             System.out.println("1 Extra engTr["+counter+"]="+engTr[counter]);  
                counter++; 
                assigned1=true ;
            if(!assigned1 && (counter == 1 || counter == 2) && QWexist1 == 200){
             // engTr[counter] = 
              if(thd == 1 && sp == 1 && pl==2){   // plural = 2 indicates affirmative sentence and plural =0 indicates negative
               // engTr[counter] = eng[0]+""; 
                System.out.println("1 engTr["+counter+"]="+engTr[counter]);  
                counter++; 
                assigned1=true ;
              }
              else if(ip == 100 && !assigned && spa ==1){
                //engTr[counter] = eng[0]+"ed";
                System.out.println("2 engTr["+counter+"]="+engTr[counter]); 
                counter++;
                assigned=true;
                ip = 0;
              }
              else if(!assigned && f==1 && sf == 1){
                  //engTr[counter] = "shall "+eng[0];
                  System.out.println("3 engTr["+counter+"]="+engTr[counter]); 
                  assigned=true;
              }
              else if(ip == 100 && !assigned && sp==1 && (pl == 3 || pl==0)){   
                  //engTr[counter] = eng[0]+" to";
                  System.out.println("3.1 engTr["+counter+"]="+engTr[counter]); 
                  counter++;
                  assigned=true;
                  ip = 0;
              }
              else if((s==1 && sf == 1 && !assigned)  || (thd==1 && sf == 1 && !assigned)){
                  //engTr[counter] = "will "+eng[0];
                  System.out.println("4 engTr["+counter+"]="+engTr[counter]); 
                  counter++;
                  assigned=true;
              }
              System.out.println("pluralharu="+pluralharu+"  pl="+pl);
              if(ip == 100 && ((!assigned && pluralharu== 1 && sp == 1) || (!assigned && pl== 4 && sp == 1) || (s ==1 && sp == 1))){
                //engTr[counter] = " are "+eng[0]+"ing";
                engTr[counter] = eng[0]+" to";
                //eng[0] = eng[0]+" to";
                System.out.println("5 engTr["+counter+"]="+engTr[counter]); 
                //counter++;
                assigned = true;
                ip = 0;
              }
              /*if((pluralharu== 0 && sp == 1}){
                engTr[counter] = ""+eng[0]+"es";
                System.out.println("5.1 engTr["+counter+"]="+engTr[counter]); 
                counter++;
              }*/
              if((!assigned && pl== 4 && spa == 1) ){ //|| (pluralharu== 1 && spa == 1)){
               // engTr[counter] = " were "+eng[0];
                System.out.println("6 engTr["+counter+"]="+engTr[counter]); 
                counter++;
                assigned = true;
              }
              if(!assigned &&  QWexist == 0 && (pl== 0 && sp == 1) && !rel[i].equals("Second Karta(K1s)") && !k1sexist){   //|| (pluralharu== 0 && sp == 1)){
                System.out.println(" is with k1s");
                engTr[counter] = " is "+eng[0];
                System.out.println("7 k1s engTr["+counter+"]="+engTr[counter]); 
                counter++;
                assigned = true;
              }
              else if((pl== 0 && sp == 1 ) &&  k1sexist && !assigned  && QWexist != -1){
              //  eng[0] = " ";
                System.out.println("Only is counter ="+counter);
              //  engTr[counter] = " is ";
                System.out.println("8 engTr["+counter+"]="+engTr[counter]); 
                assigned = true;
                counter++;
                System.out.println("Assigned="+assigned);
                QWexist = -1;
              }
              if((pl== 0 && spa == 1) ){   //|| (pluralharu== 0 && spa == 1)){
                //engTr[counter] = " was "+eng[0];
                System.out.println("9 engTr["+counter+"]="+engTr[counter]);
                counter++;
                assigned = true; 
              }
              if( !assigned && ip ==100 ){   //|| (pluralharu== 0 && spa == 1)){
                engTr[counter] = eng[0];
                System.out.println("10 engTr["+counter+"]="+engTr[counter]);
                counter++;
                assigned = true;
                ip = 1000; 
              }
            ...
            //}
            System.out.println("rel["+i+"]="+rel[i]+" English k2p entTr["+counter+"]= "+engTr[counter]+"  eng verb="+engverb+" index="+index+"  assigned="+assigned);

            if(!assigned &&  rel[i].equals("Location(K2p)")){
              System.out.println("English k2p entTr["+counter+"]= "+engTr[counter]);
              //index = index + 1;
              //counter++;
              counter--;
             /* if(i==0){
                engTr[1] = engverb+" to";
                System.out.println("inside k2p:");
                //counter++;
                //engTr[counter] = eng[index];
              }*/
             /* if(i > 1 && !rel[i-1].equals("Karma(K2)")){
                if(QWexist1 == 200){
                  engTr[1] = engverb+" to";
                  counter++;
                }
                ...
                System.out.println("inside karma k2p:");
              //  counter++;
                engTr[counter] = eng[index];
              }
              else{
                if(QWexist1 == 200)
                  ...
                  engTr[2] = engverb;
                System.out.println("inside else k2p:");
                //counter++;
               // engTr[counter] = "to "+eng[index];
              }*/
              counter++;
              ...
              System.out.println("SLE engTr["+counter+"]="+engTr[counter]); 
              assigned = true;
            }
            if(!assigned && (rel[i].equals("Sampradan(K4)")  &&  rel[i+2].equals("Karma(K2)")) || (rel[i+2].equals("Sampradan(K4)")  &&  rel[i].equals("Karma(K2)") )){
              System.out.println("Sampradan-karma counter="+counter+"  i="+i+" index="+index);
              index = index + 1;
              counter++;
              engTr[counter] = eng[index];
              counter++;
              ...
              index = index +1;
              engTr[counter] = eng[index];
              System.out.println("LE engTr["+counter+"]="+engTr[counter]); 
              //index = i+2;
              assigned = true;

            }
            else if(QWexist != -1 && !assigned && rel[i].equals("Karma(K2)")){
              System.out.println("karma i="+i+"  counter="+counter+" index="+index+" eng["+index+"]="+eng[index]+"  tags["+i+"]="+tags[i]);
              counter++;
              //index = i;
              engTr[counter] = eng[index];
             // System.out.println("")
              if( sen[2*i+3].equals("VF")){
                rel[i] = "Location(K2p)";
               // engTr[counter] = "to "+engTr[counter];
                engTr[counter] = engTr[counter];
              }
              System.out.println("NE engTr["+counter+"]="+engTr[counter]); 
            //  if(!engTr[counter].equals(null))
                carekarma = engTr[counter];
              index = index+1;
              counter++;
              assigned = true;
            }
          //if(eng[index])
          if(!assigned  ){// if(index < chunk.length){
              System.out.println("index="+index+"  counter="+counter+"  eng["+(index+1)+"]="+eng[index+1]+" rel["+counter+"]="+rel[counter]+" closed="+closed);

             // counter++;
              //index++;
              try{
              if(!eng[index].equals("null1")){
              //  counter = i;
                engTr[counter] = eng[index];
                //assigned = true;
                System.out.println("Extra PRE engTr["+counter+"]="+engTr[counter]+"  counter="+counter);
              }
              else{
              ...
              System.out.println("engTr["+counter+"]="+engTr[counter]+"  counter="+counter);
              if(rel[i].equals("Sampradan(K4)") && rel[i-1].equals("Karma(K2)")){
                //engTr[counter+1] = "to "+eng[index];
                sampradankarma = i;
                System.out.println("sampradankarma="+sampradankarma);
              }
              if(rel[i].equals("Karana(K3)")){
                if(eng[index].equals("1234")){
                  index = index + 1;
                 // hold = eng[index];
                 // held = counter + 1;
                  i--;
                  ...
                  hold = eng[index];
                held = counter;
                engTr[counter+1] = "with "+eng[index];
                assigned = true;
               // engTr[counter] = eng[index+1];
                System.out.println("1 hold="+hold+"  held="+held);
                counter++;

              }
              else if(!rel[i].equals("Oth") && !tags[i].equals("VF") && !tags[i].equals("VAUX")){ // && held != 0){
                System.out.println("1.5 hold="+hold+"  held="+held+" counter="+counter+"  eng["+index+"]="+eng[index]+" rel["+i+"]="+rel[i]);
                if(rel[i].equals("Second Karta(K1s)") ){
                    System.out.println("k1s index engTr["+counter+"]="+engTr[counter]);
                   // counter++;
                    //index++;
                    engTr[counter] = eng[index];
                    assigned = true;
                  ...
                  System.out.println("not k1s sent["+(2*i+3)+"]="+sen[2*i+3]);
                  if(!sen[2*i+3].equals("VF") &&  !sen[2*i+3].equals("VAUX") && !sen[2*i+3].equals("PUNC")){
                    engTr[counter] = eng[index];
                    assigned = true;
                    counter++;
                    index++;
                    System.out.println("yes not k1s");
                  }
                  else{
                    System.out.println("else not k1s");
                  }
                  
                }
               /* else{
                  System.out.println("General entr["+counter+"]="+engTr[counter]);
                  engTr[counter] = eng[index];
                  System.out.println("again General entr["+counter+"]="+engTr[counter]);
                    counter++;
                    index++;
                }*/
              }
              /*if(rel[i].equals("Oth") || rel[i].equals("next")){
               // index = index -2;
                //counter = counter - 2;
                System.out.println("1.75 hold="+hold+"  held="+held+" counter="+counter+"  eng["+index+"]="+eng[index]);

                engTr[counter] = eng[index];
              }*/
              System.out.println("over engTr["+counter+"]="+engTr[counter]); 
              if(!rel[i].equals("Karana(K3)")){
               // counter++;
               // index++;
                System.out.println("2 hold="+hold+"  held="+held);
                if(held != 0){
                  System.out.println("additional");
                  engTr[held] = eng[index];
                  assigned = true;
                  held = 0;
                }
              }
              else if(held != 0){
                  System.out.println("3 hold="+hold+"  held="+held);
             ...
             /* if(!assigned && held == 0){
               ...
               // index++;
                engTr[counter] = eng[index];
                System.out.println("engTr["+counter+"]="+engTr[counter]);
                held = 1;
             }*/
             if(!assigned){
                assigned=true;
           ...
           /* if(held != 0){
                  System.out.println("3.5 hold="+hold+"  held="+held);

                    engTr[held] = eng[held+1];
                    engTr[held+1] = "with "+hold;
                   // assigned = true;
             }*/
      ...
      //catch(NullPointerException ne1){};
        ...
        //for(int s=0;s<parsedtree[0];s++){
          //if(parsedtree[r][s]== 1){
           /* while(npindex <= (chunk.length)){
              System.out.print(chunk[npindex]+" "+vb+" "+articles[0]+" "+chunk[npindex+1]);

              npindex=npindex + 2;
            }*/
            npindex =0;
            String[] englishtranslation = new String[100];
            for(int r=0;r<parsedtree.length;r++){
              for(int u1=0;u1 < parsedtree[0].length;u1++){
                if(parsedtree[r][u1]== 1){
                    if(u1==0){
                      System.out.println("npindex = "+npindex);
                      System.out.println("chunk["+npindex+"]="+chunk[npindex]);
                      englishtranslation[npindex] = chunk[npindex];   //karta
                    }
                    if(u1==1){
                      System.out.print("npindex="+npindex);

                      englishtranslation[npindex+1] = vb;
                      if(ekaexist == 0)
                        npindex=npindex+2;
                      else
                        npindex++;
                     // englishtranslation[npindex] = chunk[npindex];
                    }
     ...
     // }
        int etr = 0;
        for(int j=0 ; j < chunk.length+time+10 ; j++){
          System.out.println("before check entTr["+counter+"]="+engTr[counter]+"  inoun="+inoun+"  entTr["+j+"]="+engTr[j]+" k2pexist="+k2pexist);
          if(QWexist ==100 && j>0 && etr ==0 && !k2pexist){
          ...
          else if(QWexist != 100 && etr == 0){
            engTr[j+1] = engTr[j];
            engTr[0] = eng[0];
            etr = 1;
            System.out.println("else j="+j);
          }
           System.out.println("after check entTr["+counter+"]="+engTr[counter]+"  inoun="+inoun+"   entTr["+j+"]="+engTr[j]);
         
        }
        System.out.println("English translation");
        boolean tempto = false;
       /* if(!inoun.equals("hii") && QWexist1 == 200){
              engTr[counter] = inoun;
              System.out.println("entTr["+counter+"]="+engTr[counter]);
            }*/
            System.out.println("111 time="+time+" tempto="+tempto+"  QWexist1="+QWexist1+" k2pexist="+k2pexist);

        //System.out.print(chunk,String[] nep, String[] tags, String[] rel, String vb, int ne, int pl, int f, int s, int thd, int sp, int spa, int sf, int[] tsword, int spc,int pastc,int futc,int fperf,int sperf,int pperf)
        try{
        for(int j=0 ; j < chunk.length+time+5 ; j++){
          System.out.println("111 entTr["+counter+"]="+engTr[counter]+"  inoun="+inoun+"entTr["+counter+"]="+engTr[counter]);
        /*  if(k2pexist || wdct <= 8){
            if(!inoun.equals("hii") && QWexist1 == 200){
              engTr[2] = inoun;
            ...
            if(k2pexist && !tempto){
              if(QWexist1 == 200)
                ...
                engTr[2] = engTr[2]+" "+"to";
                System.out.println("question engtr[2]="+engTr[2]);
              }
              tempto = true;
            }
          }*/
          
          System.out.println("question engTr[2]="+engTr[2]+" QWexist1="+QWexist1);
         // if(engTr[j].e)
          System.out.println("1 sampradankarma engtr["+j+"]="+engTr[j]+" sampradankarma engtr["+(j+1)+"]="+engTr[j+1]);
          if(engTr[j].equals("null1")){
           // if(engTr[j+1])
           /* for(int r=j+1;r<10;r++){
             ...
             j=j+1;
             sampradankarma=sampradankarma+1;
             System.out.println("j="+j);
           }
          if(!engTr[j].equals("null1")  ){

            System.out.println("2 sampradankarma ="+sampradankarma);
            if( !engTr[j].equals("123")){
              if(sampradankarma == j){
                System.out.println("sampradankarma index="+index);
                temp = engTr[j];
                if(engTr[j+1].equals("null1")){
                  engTr[j+1]= eng[index];
                }
                engTr[j] = engTr[j+1];
                engTr[j+1] = "to "+temp;
      ...
      int repeat = 10;
      int joinrepeat =29;
      String[] engTrr = new String[engTr.length ];
      for(int s2=0;s2<engTrr.length;s2++){
        engTrr[s2] = "null1";
      }
      System.out.println("enttrr length="+engTrr.length);
      try{
      for(int s1=0;s1<engTrr.length;s1++){
       // engTrr[s1] = "null1";
        System.out.println("carekarma"+carekarma+"  s1="+s1);
        if(carekarma.equals(hold) && hold.equals(engTr[s1])){
         joinrepeat = s1;
          System.out.println("inside joinrepeat="+joinrepeat);
        }
                //else repeat = 1;
      }
    }
    catch(NullPointerException ne11){}

      System.out.println("carekarma="+carekarma+"  hold="+hold);
        try{
        for(int j=0 ; j < engTr.length; j++){
          System.out.println(" inside engTr["+j+"]"+engTr[j]);
          if(j!=1){
           repeat = 1;
          }
          else if(QWexist == 100){
          ...
          if(k2pexist){
            engTr[2] = "";
            System.out.println("blank k2pexist");
          }
          //repeat = 1;

          if(j>0 && (j < engTr.length-1) && k2pexist  ){
            repeat = 0;
            System.out.println(" just inside engTr["+j+"]"+engTr[j]+"  repeat ="+repeat);
            
            k2pexist = false;    // wrong information
          }
          if(!engTr[j].equals("null1")  ){
            if( !engTr[j].equals("123") ){
              if(!engTr[j].equals("-")){
              for(int k=0;k<j;k++){
                ...
                if(!engTr[j].equals(engTr[k]) && repeat !=0  ){
                  System.out.println(" deep inside engTr["+j+"]"+engTr[j]);
                  repeat = 1;
                }
                else if(j != 0){
                  repeat = 0;
                }
             //   System.out.println("pre repeat="+repeat);
               // if(carekarma.equals(hold) && hold.equals(engTr[j])) repeat = 0;
                //else repeat = 1;
                System.out.println("repeat="+repeat);
            }
            if(engTr[joinrepeat].equals(engTr[j])){
              repeat = 0;
              System.out.println("again join repeat="+repeat);
            }

           // System.out.println("again repeat="+repeat);
            if(repeat == 1){
                  System.out.println("  "+engTr[j]);
                  engTrr[j] = engTr[j];
                }
...
public String[] getEnglishsentence(int[][] parsedtree, String[]  chunk,String[] nep, String[] tags, String[] rel, String vb, int ne, int pl, int f, int s, int thd, int sp, int spa, int sf, int[] tsword, int spc,int pastc,int futc,int fperf,int sperf,int pperf, String[] sen, String fn, String filename3 , int gend, String[] verbs, int garnu, int pluralv){
        String[] eng = new String[nep.length+5];
        String verbal = "hi";
        for(int i = 0 ; i < nep.length ; i++){
          eng[i]="null1";
      ...
      System.out.println("Welcome to English Translaiton");
     
        for(int s2=0;s2<engTr.length;s2++){
          engTr[s2] = "null1";
        }
        System.out.println("Welcome to English Translaiton parsed tree");
         for(int pt = 0 ; pt < parsedtree.length ; pt++){
        for(int pt1 = 0 ; pt1 < parsedtree[0].length ; pt1++){
         
          System.out.print(" "+parsedtree[pt][pt1]);
        ...
        //wdct = wdct/2;
         // tsword = chunk[c].trim().split("\\s+");
         System.out.println("tags.length="+tags.length+" word count ="+wdct+"  chunk length="+chunk.length+"  QWexist="+QWexist);
         for(int s2=0;s2<wdct;s2++){
          for(int l1=0;l1<tagset.length;l1++){
              if(sen[s2].equals(tagset[l1]) && s2%2 != 0){
                //if(wdct >6 )
                ...
                System.out.println("l1="+l1+"  s2="+s2);
                  anninput[inds2] = l1 + 1;
                  System.out.println("anninput["+inds2+"]="+anninput[inds2]+"  s2="+s2);
               // if (wdct <=6  && sen[s2].equals("VAUX")){    
                 // anninput[inds2] = 0;
                 // anninput[36] = 1;     // non verbal sentenses
               // }
      ...
      //  String[] englishunicode = new String[wdct];
       ...
       /*   try{
          ...
          int fairNNJJ = 0;
          //if(chunk.length == 1) time= 2;
          System.out.println("chunk length ="+chunk.length+"  time="+time +" word count ="+wdct);
          for(int i = 0 ; i < wdct  ; i++){
              System.out.println("tswords["+i+"]="+tsword[i]+"  tswords["+(i+1)+"]="+tsword[i+1]+"  english["+index+"]="+english[index]);
              if(QWexist > 0 && QWexist <50)
                index = index + tsword[i+1];
        ...
        // int ne, int pl, int f, int s, int thd, int sp, int spa, int sf
        System.out.println("neg = "+ne);
        if(pluralv == 1) anninput[49] = 1;
        else anninput[49] = 0;
        if(ne==2 || ne != 0) anninput[50] = 0;     // Negative sentence
        else if(ne == 0) anninput[50] = 2; // Positive sentence
        if(pl==1) anninput[51] = 3;
        if(pl==4) anninput[51] = 4; //  plural haru
        if(pl==3 || pl != 4) anninput[51] = 3; //  singular
        if(f==1) anninput[52] = 1;
      ...
      OutputStreamWriter writer1 = new OutputStreamWriter(new FileOutputStream(fn, true), "UTF-8");
      BufferedWriter fout1 = new BufferedWriter(writer1);
        System.out.println("ANN input late");
       // fout1.write(" ANN input");
      ...
      for(int r=0;r<anninput1.length;r++){
        ...
        for(int q = 0;q<wdct;q++){
            if( sen[q].equals("RB") ){
              ...
              if(q>0 ){
                for(int i1 =0 ; i1 < rel.length;i1++){
                 if(rel[i1].equals("Oth") && rel[i1+1].equals("next"))
                    rel[i1] = "Comparision(K*u)";
                    anninput[99] = 1;
                }
              //}
      ...
      System.out.println("Final ANN Input:");
      for(int r1 = 0 ; r1<anninput1.length;r1++){
        
        System.out.println(" anninput1["+r1+"]="+anninput1[r1]);
      }
      for(int r=0;r<anninput1.length;r++){
      //  fout1.write(" "+anninput[r]);
      }
  ...
  OutputStreamWriter writer2 = new OutputStreamWriter(new FileOutputStream(filename3, false), "UTF-8");
    ...
    //  fout2.write("\n");
    //  fout2.write("\n");
      System.out.println("parsedtree iiii");
      for(int pt = 0 ; pt < parsedtree.length ; pt++){
        for(int pt1 = 0 ; pt1 < parsedtree[0].length ; pt1++){
           fout2.write("  "+parsedtree[pt][pt1]); // FOR ANN INPUT
      ...
      for(int r1=0;r1<anninput1.length;r1++){
        ...
        if(r1 <= 69){
          System.out.print(" anninput1["+r1+"]="+anninput1[r1]);
          System.out.println();
          fout2.write("  "+anninput1[r1]);     // FOR ANN INPUT POSITION OF POS
          
          
          

         /* int tann = anninput1[r1] + 20;
          if(r1 == tann){
              fout2.write("1"); 
          }
          else
         ...
         /* if(anninput1[r1] != anninput1[r1+1] ){
            fout2.write("  "+anninput1[r1]);
          }
          else if(anninput1[r1] == 0){
           fout2.write("  "+anninput1[r1]); 
          }*/
        }
      }
     // fout2.write("  "+anninput1)
      for(int r=0;r<anninput1.length;r++){
        if(r >68 && r <90){    // r = 69 reserved for gender (0,1 or 2)
          System.out.print(" anninput1["+r+"]="+anninput1[r]);
          anninput1[r] = anninput1[r]/1500;   //normalization
        }
        if(r >99){    // r = 69 reserved for gender (0,1 or 2)
          anninput1[r] = anninput1[r];   //normalization
      ...
      System.out.println("new Final ANN Input:");
      for(int r1 = 0 ; r1<anninput1.length;r1++){
     ...
     // }
        System.out.println("Verb exist ="+vbexist);
        //eng[1] = "Sonam";
        //eng[2] = "Rama";
        int counter = 0;
        int index =1;
  ...
  for(int n1 = 0 ; n1 < nlcols;n1++){
       //   if(extduplicate[m1][n1] == 1){
              if(n1 == 0){
                  ...
                  fout.write("Part of Speech of "+words[n1-2]+" is "+postagset[index]);
                  fout.write("\n");
                  try{
                    if(parserelation[n1].equals("Oth")) parserelation[n1] = "Chunk with "+words[n1];
                  }
                  ...
                  if(!parserelation[n1-1].equals("next")){
                      ...
                      fout.write("Relation of  "+words[n1-2]+" with verb is "+ parserelation[n1-1]);
                      fout.write("\n");
                  }
                  else{
...
//            fout.write(nn[l]);
    ...
    public String[] findNouns(String[] tgs1, String[] ms , String[] nns, String[] vbkts, int len, String[] ntstart , int tg){
        ...
        try{
        for(int i = 0; i < noWords/2 ; i++){
          System.out.println("tgs1["+i+"]="+tgs1[i]);
          for(int j=0;j<10;j++){
            System.out.println("nns["+j+"]="+nns[j]);
...
//  for(int u1 = 0 ; u1 < nsgr ; u1++){
    ...
    try{
      ...
      if(flg){
        System.out.println("***oflag="+flg+" check TAM="+nsgr);
      ...
      System.out.println("** special flag = "+flg+"  count ="+count+"  nsgr ="+nsgr);
  ...
  if(flg == true && fg[0][0][2] != 1 ){
   ...
   // golden = fg;
    ...
    //System.out.println("\t  KARTA(k1)   \tKARMA(k2)\t  KARANA(k3)\t  SAMPRADAN(K4) \tAPADAN(k5)   \tSAMBANDH(K6)  \tADHIKARAN(K7)    \tLOCATION(K2P)     \tLOCATION(K7t)");
          System.out.println();
          System.out.println("Prescheckindex="+presCheckIndex+"  locationindex ="+locationindex+"  krks ="+krks);
          for(int l = 0 ; l < rows ; l++){
            //System.out.print(nn[l]);
    ...
    for(int u = 0 ; u < 100 ; u++){
     ...
     System.out.println("fail OYE");
    for(int u = 0 ; u < 100 ; u++){
      for(int l = 0 ; l < rows ; l++){
        for(int m = 0 ; m < krks ; m++){
          System.out.print("  "+subgr[u][l][m]);
        }
        System.out.println();
      }
      System.out.println();
    ...
    //  if(flg)
        return golden;
      //else{
        //System.out.println(" Check TAM fails:");
        //return subgr;
      //}
    }
...
//              count++;
    ...
    //public static void main(String[] args) {
       ...
       int fileLength = file.length();
        int findMeLength = findMe.length();
        System.out.println("LAI filelength="+fileLength+"   findme="+findMeLength);
        String findMe1 = "hi";
        if(fileLength > 3){
          findMe1 = file.substring(fileLength-3,fileLength);
        }
       /* else{ 
          findMe1 = file.substring(0,fileLength);
          //findMe1 = file.substring(0,fileLength-3);  seed verb
        }*/
          ...
          //  //System.out.println("i ="+i+"file["+i+"]="+file[i]);
           ...
           if(findMe1.equals(findMe)) {
              ...
              if(fileLength > 3){
               ...
               g[0] = file.substring(0, fileLength); 
              }
              System.out.println("g[0]="+g[0]);
              g[1] = findMe1;
          //System.out.println("file["+(i+1)+"]="+file[i+1]);
...
//              count++;
        ...
        public String[] RegionMatchesDemoika(String findMe, String file) {
    //public static void main(String[] args) {
       // String searchMe = "Green Eggs and Ham";
       String[] positions = new String[50000];  // Maximum number of tags to each words = 5
        int index = 0;
    ...
    g[0] = "ab";
        ...
        boolean foundIt = false;
      //  for(int i = 0; i < s; i++) {
          System.out.println("findMe1="+findMe1+"  ikaexist ="+ikaexist);
           if(findMe1.equals(findMe) || !foundIt && ikaexist != 100) {
               //System.out.println("check");    
               //System.out.println(" filelength="+fileLength);   
              foundIt = true;
              if(fileLength > 3)
