...
// JAVA PROGRAOM TO CREATE VERB FRAMES AND STORES IN F:\\cars.xml
...
// FRAME OF DINCHHA
	 ...
	 Element carnamepc21dinchh = doc.createElement("vibhakti");
         Attr attrTypepc23dinchh = doc.createAttribute("presence");
         attrTypepc23dinchh.setValue("Optional");
         carnamepc21dinchh.setAttributeNode(attrTypepc23dinchh);
         carnamepc21dinchh.appendChild(
         doc.createTextNode("null"));
         supercar.appendChild(carnamepc21dinchh);
         Attr attrTypekkpc24dinchh = doc.createAttribute("karaka");
         attrTypekkpc24dinchh.setValue("Locative(K7t)");
         carnamepc21dinchh.setAttributeNode(attrTypekkpc24dinchh);
...
/*         Element vibhakti = doc.createElement("vibhakti");
  	 ...
  	 Element vibhakti7 = doc.createElement("vibhakti");
         ...
         doc.createTextNode("लाई or लागि"));
	 ...
	 Element carnamepc21diyo = doc.createElement("vibhakti");
         Attr attrTypepc23diyo = doc.createAttribute("presence");
         attrTypepc23diyo.setValue("Optional");
         carnamepc21diyo.setAttributeNode(attrTypepc23diyo);
         carnamepc21diyo.appendChild(
         doc.createTextNode("null"));
         supercar1.appendChild(carnamepc21diyo);
         Attr attrTypekkpc24diyo = doc.createAttribute("karaka");
         attrTypekkpc24diyo.setValue("Locative(K7t)");
         carnamepc21diyo.setAttributeNode(attrTypekkpc24diyo);
...
/*         Element vibhakti = doc.createElement("vibhakti");
	 ...
	 Element carnamepc21die = doc.createElement("vibhakti");
         Attr attrTypepc23die = doc.createAttribute("presence");
         attrTypepc23die.setValue("Optional");
         carnamepc21die.setAttributeNode(attrTypepc23die);
         carnamepc21die.appendChild(
         doc.createTextNode("null"));
         supercar4.appendChild(carnamepc21die);
         Attr attrTypekkpc24die = doc.createAttribute("karaka");
         attrTypekkpc24die.setValue("Locative(K7t)");
         carnamepc21die.setAttributeNode(attrTypekkpc24die);
...
/*         Element vibhakti = doc.createElement("vibhakti");
	 ...
	 Element carnamepc21jamma = doc.createElement("vibhakti");
         Attr attrTypepc23jamma = doc.createAttribute("presence");
         attrTypepc23jamma.setValue("Optional");
         carnamepc21jamma.setAttributeNode(attrTypepc23jamma);
         carnamepc21jamma.appendChild(
         doc.createTextNode("null"));
         supercar5.appendChild(carnamepc21jamma);
         Attr attrTypekkpc24jamma = doc.createAttribute("karaka");
         attrTypekkpc24jamma.setValue("Locative(K7t)");
         carnamepc21jamma.setAttributeNode(attrTypekkpc24jamma);
...
/*         Element vibhakti = doc.createElement("vibhakti");
	 ...
	 Element carnamepc21dekhyo = doc.createElement("vibhakti");
         Attr attrTypepc23dekhyo = doc.createAttribute("presence");
         attrTypepc23dekhyo.setValue("Optional");
         carnamepc21dekhyo.setAttributeNode(attrTypepc23dekhyo);
         carnamepc21dekhyo.appendChild(
         doc.createTextNode("null"));
         supercar6.appendChild(carnamepc21dekhyo);
         Attr attrTypekkpc24dekhyo = doc.createAttribute("karaka");
         attrTypekkpc24dekhyo.setValue("Locative(K7t)");
         carnamepc21dekhyo.setAttributeNode(attrTypekkpc24dekhyo);
...
/*         Element vibhakti = doc.createElement("vibhakti");
  	 ...
  	 Element vibhaktipc16 = doc.createElement("vibhakti");
         ...
         doc.createTextNode("लाई or लागि or हरुलाई"));
	 ...
	 Element carnamepc21pathaunchh = doc.createElement("vibhakti");
         Attr attrTypepc23pathaunchh = doc.createAttribute("presence");
         attrTypepc23pathaunchh.setValue("Optional");
         carnamepc21pathaunchh.setAttributeNode(attrTypepc23pathaunchh);
         carnamepc21pathaunchh.appendChild(
         doc.createTextNode("null"));
         supercarpc5.appendChild(carnamepc21pathaunchh);
         Attr attrTypekkpc24pathaunchh = doc.createAttribute("karaka");
         attrTypekkpc24pathaunchh.setValue("Locative(K7t)");
         carnamepc21pathaunchh.setAttributeNode(attrTypekkpc24pathaunchh);
...
/*         Element vibhakti = doc.createElement("vibhakti");
	 ...
	 Element carnamepath1 = doc.createElement("vibhakti");
         ...
         doc.createTextNode("लाई or null or लागि"));
	...
	Element carname12pathaunchh1 = doc.createElement("vibhakti");
 	 ...
 	 Element carnamepc21pathaunchh1 = doc.createElement("vibhakti");
         Attr attrTypepc23pathaunchh1 = doc.createAttribute("presence");
         attrTypepc23pathaunchh1.setValue("Optional");
         carnamepc21pathaunchh1.setAttributeNode(attrTypepc23pathaunchh1);
         carnamepc21pathaunchh1.appendChild(
         doc.createTextNode("null"));
         supercarpcn5.appendChild(carnamepc21pathaunchh1);
         Attr attrTypekkpc24pathaunchh1 = doc.createAttribute("karaka");
         attrTypekkpc24pathaunchh1.setValue("Locative(K7t)");
         carnamepc21pathaunchh1.setAttributeNode(attrTypekkpc24pathaunchh1);
  	 ...
  	 Element carnamepcn103 = doc.createElement("Tense");
         ...
         // FRAME OF KHANCHHA OPTIONAL
  	  Element supercarpcn6 = doc.createElement("supercars");
         rootElement.appendChild(supercarpcn6);

         // setting attribute to element
         Attr attrpcn6 = doc.createAttribute("Verb");
         attrpcn6.setValue("खान्छ");
         supercarpcn6.setAttributeNode(attrpcn6);
...
/*         Element vibhakti = doc.createElement("vibhakti");
  	 ...
  	 Element vibhaktipcn16khanchh = doc.createElement("vibhakti");
         Attr attrTypepcn19khanchh = doc.createAttribute("presence");
         attrTypepcn19khanchh.setValue("Mendatory");
         vibhaktipcn16khanchh.setAttributeNode(attrTypepcn19khanchh);
         vibhaktipcn16khanchh.appendChild(
         doc.createTextNode("ले  or null"));
         supercarpcn6.appendChild(vibhaktipcn16khanchh);
         Attr attrTypekkpcn19khanchh = doc.createAttribute("karaka");
         attrTypekkpcn19khanchh.setValue("karta(K1)");               // Noun is Transitive or Ergative i.e. after karta immediately karma does not appear
         vibhaktipcn16khanchh.setAttributeNode(attrTypekkpcn19khanchh);
         	
         Element carnamepcnkhanchh20 = doc.createElement("vibhakti");
         Attr attrTypepcnkhanchh22 = doc.createAttribute("presence");
         attrTypepcnkhanchh22.setValue("Optional");
         carnamepcnkhanchh20.setAttributeNode(attrTypepcnkhanchh22);
         carnamepcnkhanchh20.appendChild(
         doc.createTextNode("लाई or null"));
         supercarpcn6.appendChild(carnamepcnkhanchh20);
         Attr attrTypekkpcnkhanchh23 = doc.createAttribute("karaka");
         attrTypekkpcnkhanchh23.setValue("karma(K2)");
         carnamepcnkhanchh20.setAttributeNode(attrTypekkpcnkhanchh23);

	 Element carnamepathkhanchh1 = doc.createElement("vibhakti");
         Attr attrTypepathkhanchh1 = doc.createAttribute("presence");
         attrTypepathkhanchh1.setValue("Optional");
         carnamepathkhanchh1.setAttributeNode(attrTypepathkhanchh1);
         carnamepathkhanchh1.appendChild(
         doc.createTextNode("Dwara or द्वारा or बाट or ले"));
         supercarpcn6.appendChild(carnamepathkhanchh1);
         Attr attrTypekkpathkhanchh1 = doc.createAttribute("karaka");
         attrTypekkpathkhanchh1.setValue("karana(K3)");
         carnamepathkhanchh1.setAttributeNode(attrTypekkpathkhanchh1);
         
         Element carnamepcnkhanchh19 = doc.createElement("vibhakti");
         Attr attrTypepcnkhanchh20 = doc.createAttribute("presence");
         attrTypepcnkhanchh20.setValue("Optional");
         carnamepcnkhanchh19.setAttributeNode(attrTypepcnkhanchh20);
         carnamepcnkhanchh19.appendChild(
         doc.createTextNode("लाई or null or लागि"));
         supercarpcn6.appendChild(carnamepcnkhanchh19);
         Attr attrTypekkpcnkhanchh21 = doc.createAttribute("karaka");
         attrTypekkpcnkhanchh21.setValue("Sampradan(K4)");
         carnamepcnkhanchh19.setAttributeNode(attrTypekkpcnkhanchh21);

	Element carname12khanchh1 = doc.createElement("vibhakti");
         Attr attrType12khanchh1 = doc.createAttribute("presence");
         attrType12khanchh1.setValue("Optional");
         carname12khanchh1.setAttributeNode(attrType12khanchh1);
         carname12khanchh1.appendChild(
         doc.createTextNode("देखि"));
         supercarpcn6.appendChild(carname12khanchh1);
         Attr attrTypekk12khanchh1 = doc.createAttribute("karaka");
         attrTypekk12khanchh1.setValue("Apadan(K5)");
         carname12khanchh1.setAttributeNode(attrTypekk12khanchh1);
         Attr attrTypeform4khanchh1 = doc.createAttribute("Form");
         attrTypeform4khanchh1.setValue("Singular and Plural");
         carname12khanchh1.setAttributeNode(attrTypeform4khanchh1);
         

         Element carname13khanchh1 = doc.createElement("vibhakti");
         Attr attrType13khanchh1 = doc.createAttribute("presence");
         attrType13khanchh1.setValue("Optional");
         carname13khanchh1.setAttributeNode(attrType13khanchh1);
         carname13khanchh1.appendChild(
         doc.createTextNode("को or करुको or रो or नो"));
         supercarpcn6.appendChild(carname13khanchh1);
         Attr attrTypekk13khanchh1 = doc.createAttribute("karaka");
         attrTypekk13khanchh1.setValue("Sambandh(K6)");
         carname13khanchh1.setAttributeNode(attrTypekk13khanchh1);
         Attr attrTypeform5khanchh1 = doc.createAttribute("Form");
         attrTypeform5khanchh1.setValue("Singular and Plural");
         carname13khanchh1.setAttributeNode(attrTypeform5khanchh1);


         Element carname14khanchh1 = doc.createElement("vibhakti");
         Attr attrType14khanchh1 = doc.createAttribute("presence");
         attrType14khanchh1.setValue("Optional");
         carname14khanchh1.setAttributeNode(attrType14khanchh1);
         carname14khanchh1.appendChild(
         doc.createTextNode("मा or हरुमा "));
         supercarpcn6.appendChild(carname14khanchh1);
         Attr attrTypekk14khanchh1 = doc.createAttribute("karaka");
         attrTypekk14khanchh1.setValue("Adhikaran(K7)");
         carname14khanchh1.setAttributeNode(attrTypekk14khanchh1);
         Attr attrTypeform6khanchh1 = doc.createAttribute("Form");
         attrTypeform6khanchh1.setValue("Singular and Plural");
         carname14khanchh1.setAttributeNode(attrTypeform6khanchh1);
         
         Element carnamepc20khanchh1 = doc.createElement("vibhakti");
         Attr attrTypepc22khanchh1 = doc.createAttribute("presence");
         attrTypepc22khanchh1.setValue("Optional");
         carnamepc20khanchh1.setAttributeNode(attrTypepc22khanchh1);
         carnamepc20khanchh1.appendChild(
         doc.createTextNode("null"));
         supercarpcn6.appendChild(carnamepc20khanchh1);
         Attr attrTypekkpc23khanchh1 = doc.createAttribute("karaka");
         attrTypekkpc23khanchh1.setValue("Locative(K2p)");
         carnamepc20khanchh1.setAttributeNode(attrTypekkpc23khanchh1);
        
 	 Element carnamepc21khanchh1 = doc.createElement("vibhakti");
         Attr attrTypepc23khanchh1 = doc.createAttribute("presence");
         attrTypepc23khanchh1.setValue("Optional");
         carnamepc21khanchh1.setAttributeNode(attrTypepc23khanchh1);
         carnamepc21khanchh1.appendChild(
         doc.createTextNode("null or मा"));
         supercarpcn6.appendChild(carnamepc21khanchh1);
         Attr attrTypekkpc24khanchh1 = doc.createAttribute("karaka");
         attrTypekkpc24khanchh1.setValue("Locative(K7t)");
         carnamepc21khanchh1.setAttributeNode(attrTypekkpc24khanchh1);

  	 Element carnamepcnkhanchh103 = doc.createElement("Tense");
         Attr attrTypepcnkhanchh103 = doc.createAttribute("Vibhakti");
         attrTypepcnkhanchh103.setValue("Simple Present Tense");
         carnamepcnkhanchh103.setAttributeNode(attrTypepcnkhanchh103);
         supercarpcn6.appendChild(carnamepcnkhanchh103);


  // FRAME OF KHANCHHA MENDATORY
  	  Element supercarpcn7 = doc.createElement("supercars");
         rootElement.appendChild(supercarpcn7);

         // setting attribute to element
         Attr attrpcn7 = doc.createAttribute("Verb");
         attrpcn7.setValue("खान्छ");
         supercarpcn7.setAttributeNode(attrpcn7);
...
/*         Element vibhakti = doc.createElement("vibhakti");
  	 ...
  	 Element vibhaktipcn16khanchh1 = doc.createElement("vibhakti");
         Attr attrTypepcn19khanchh1 = doc.createAttribute("presence");
         attrTypepcn19khanchh1.setValue("Mendatory");
         vibhaktipcn16khanchh1.setAttributeNode(attrTypepcn19khanchh1);
         vibhaktipcn16khanchh1.appendChild(
         doc.createTextNode("ले  or null"));
         supercarpcn7.appendChild(vibhaktipcn16khanchh1);
         Attr attrTypekkpcn19khanchh1 = doc.createAttribute("karaka");
         attrTypekkpcn19khanchh1.setValue("karta(K1)");               // Noun is Transitive or Ergative i.e. after karta immediately karma does not appear
         vibhaktipcn16khanchh1.setAttributeNode(attrTypekkpcn19khanchh1);
         	
         Element carnamepcnkhanchh120 = doc.createElement("vibhakti");
         Attr attrTypepcnkhanchh122 = doc.createAttribute("presence");
         attrTypepcnkhanchh122.setValue("Mendatory");
         carnamepcnkhanchh120.setAttributeNode(attrTypepcnkhanchh122);
         carnamepcnkhanchh120.appendChild(
         doc.createTextNode("null"));
         supercarpcn7.appendChild(carnamepcnkhanchh120);
         Attr attrTypekkpcnkhanchh123 = doc.createAttribute("karaka");
         attrTypekkpcnkhanchh123.setValue("karma(K2)");
         carnamepcnkhanchh120.setAttributeNode(attrTypekkpcnkhanchh123);

	 Element carnamepathkhanchh11 = doc.createElement("vibhakti");
         Attr attrTypepathkhanchh11 = doc.createAttribute("presence");
         attrTypepathkhanchh11.setValue("Optional");
         carnamepathkhanchh11.setAttributeNode(attrTypepathkhanchh11);
         carnamepathkhanchh11.appendChild(
         doc.createTextNode("Dwara or द्वारा or बाट or ले"));
         supercarpcn7.appendChild(carnamepathkhanchh11);
         Attr attrTypekkpathkhanchh11 = doc.createAttribute("karaka");
         attrTypekkpathkhanchh11.setValue("karana(K3)");
         carnamepathkhanchh11.setAttributeNode(attrTypekkpathkhanchh11);
         
         Element carnamepcnkhanchh119 = doc.createElement("vibhakti");
         Attr attrTypepcnkhanchh120 = doc.createAttribute("presence");
         attrTypepcnkhanchh120.setValue("Optional");
         carnamepcnkhanchh119.setAttributeNode(attrTypepcnkhanchh120);
         carnamepcnkhanchh119.appendChild(
         doc.createTextNode("लाई or null or लागि"));
         supercarpcn7.appendChild(carnamepcnkhanchh119);
         Attr attrTypekkpcnkhanchh121 = doc.createAttribute("karaka");
         attrTypekkpcnkhanchh121.setValue("Sampradan(K4)");
         carnamepcnkhanchh119.setAttributeNode(attrTypekkpcnkhanchh121);

	Element carname12khanchh11 = doc.createElement("vibhakti");
         Attr attrType12khanchh11 = doc.createAttribute("presence");
         attrType12khanchh11.setValue("Optional");
         carname12khanchh11.setAttributeNode(attrType12khanchh11);
         carname12khanchh11.appendChild(
         doc.createTextNode("देखि"));
         supercarpcn7.appendChild(carname12khanchh11);
         Attr attrTypekk12khanchh11 = doc.createAttribute("karaka");
         attrTypekk12khanchh11.setValue("Apadan(K5)");
         carname12khanchh11.setAttributeNode(attrTypekk12khanchh11);
         Attr attrTypeform4khanchh11 = doc.createAttribute("Form");
         attrTypeform4khanchh11.setValue("Singular and Plural");
         carname12khanchh11.setAttributeNode(attrTypeform4khanchh11);
         

         Element carname13khanchh11 = doc.createElement("vibhakti");
         Attr attrType13khanchh11 = doc.createAttribute("presence");
         attrType13khanchh11.setValue("Optional");
         carname13khanchh11.setAttributeNode(attrType13khanchh11);
         carname13khanchh11.appendChild(
         doc.createTextNode("को or करुको or रो or नो"));
         supercarpcn7.appendChild(carname13khanchh11);
         Attr attrTypekk13khanchh11 = doc.createAttribute("karaka");
         attrTypekk13khanchh11.setValue("Sambandh(K6)");
         carname13khanchh11.setAttributeNode(attrTypekk13khanchh11);
         Attr attrTypeform5khanchh11 = doc.createAttribute("Form");
         attrTypeform5khanchh11.setValue("Singular and Plural");
         carname13khanchh11.setAttributeNode(attrTypeform5khanchh11);


         Element carname14khanchh11 = doc.createElement("vibhakti");
         Attr attrType14khanchh11 = doc.createAttribute("presence");
         attrType14khanchh11.setValue("Optional");
         carname14khanchh11.setAttributeNode(attrType14khanchh11);
         carname14khanchh11.appendChild(
         doc.createTextNode("मा or हरुमा "));
         supercarpcn7.appendChild(carname14khanchh11);
         Attr attrTypekk14khanchh11 = doc.createAttribute("karaka");
         attrTypekk14khanchh11.setValue("Adhikaran(K7)");
         carname14khanchh11.setAttributeNode(attrTypekk14khanchh11);
         Attr attrTypeform6khanchh11 = doc.createAttribute("Form");
         attrTypeform6khanchh11.setValue("Singular and Plural");
         carname14khanchh11.setAttributeNode(attrTypeform6khanchh11);
         
         Element carnamepc20khanchh11 = doc.createElement("vibhakti");
         Attr attrTypepc22khanchh11 = doc.createAttribute("presence");
         attrTypepc22khanchh11.setValue("Optional");
         carnamepc20khanchh11.setAttributeNode(attrTypepc22khanchh11);
         carnamepc20khanchh11.appendChild(
         doc.createTextNode("मा or हरुमा "));
         supercarpcn7.appendChild(carnamepc20khanchh11);
         Attr attrTypekkpc23khanchh11 = doc.createAttribute("karaka");
         attrTypekkpc23khanchh11.setValue("Locative(K2p)");
         carnamepc20khanchh11.setAttributeNode(attrTypekkpc23khanchh11);
        
 	 Element carnamepc21khanchh11 = doc.createElement("vibhakti");
         Attr attrTypepc23khanchh11 = doc.createAttribute("presence");
         attrTypepc23khanchh11.setValue("Optional");
         carnamepc21khanchh11.setAttributeNode(attrTypepc23khanchh11);
         carnamepc21khanchh11.appendChild(
         doc.createTextNode("null"));
         supercarpcn7.appendChild(carnamepc21khanchh11);
         Attr attrTypekkpc24khanchh11 = doc.createAttribute("karaka");
         attrTypekkpc24khanchh11.setValue("Locative(K7t)");
         carnamepc21khanchh11.setAttributeNode(attrTypekkpc24khanchh11);

  	 Element carnamepcnkhanchh1103 = doc.createElement("Tense");
         Attr attrTypepcnkhanchh1103 = doc.createAttribute("Vibhakti");
         attrTypepcnkhanchh1103.setValue("Simple Present Tense");
         carnamepcnkhanchh1103.setAttributeNode(attrTypepcnkhanchh1103);
         supercarpcn7.appendChild(carnamepcnkhanchh1103);

	// FUTURE TENSE
  // FRAME OF KHANECHHU MENDATORY
  	  Element supercarpcn7f = doc.createElement("supercars");
         rootElement.appendChild(supercarpcn7f);

         // setting attribute to element
         Attr attrpcn7f = doc.createAttribute("Verb");
         attrpcn7f.setValue("खानेछु");
         supercarpcn7f.setAttributeNode(attrpcn7f);
...
/*         Element vibhakti = doc.createElement("vibhakti");
  	 ...
  	 Element vibhaktipcn16khanechhu1 = doc.createElement("vibhakti");
         Attr attrTypepcn19khanechhu1 = doc.createAttribute("presence");
         attrTypepcn19khanechhu1.setValue("Mendatory");
         vibhaktipcn16khanechhu1.setAttributeNode(attrTypepcn19khanechhu1);
         vibhaktipcn16khanechhu1.appendChild(
         doc.createTextNode("null"));
         supercarpcn7f.appendChild(vibhaktipcn16khanechhu1);
         Attr attrTypekkpcn19khanechhu1 = doc.createAttribute("karaka");
         attrTypekkpcn19khanechhu1.setValue("karta(K1)");               // Noun is Transitive or Ergative i.e. after karta immediately karma does not appear
         vibhaktipcn16khanechhu1.setAttributeNode(attrTypekkpcn19khanechhu1);
         	
         Element carnamepcnkhanechhu120 = doc.createElement("vibhakti");
         Attr attrTypepcnkhanechhu122 = doc.createAttribute("presence");
         attrTypepcnkhanechhu122.setValue("Mendatory");
         carnamepcnkhanechhu120.setAttributeNode(attrTypepcnkhanechhu122);
         carnamepcnkhanechhu120.appendChild(
         doc.createTextNode("null or संग"));
         supercarpcn7f.appendChild(carnamepcnkhanechhu120);
         Attr attrTypekkpcnkhanechhu123 = doc.createAttribute("karaka");
         attrTypekkpcnkhanechhu123.setValue("karma(K2)");
         carnamepcnkhanechhu120.setAttributeNode(attrTypekkpcnkhanechhu123);

	 Element carnamepathkhanechhu11 = doc.createElement("vibhakti");
         Attr attrTypepathkhanechhu11 = doc.createAttribute("presence");
         attrTypepathkhanechhu11.setValue("Optional");
         carnamepathkhanechhu11.setAttributeNode(attrTypepathkhanechhu11);
         carnamepathkhanechhu11.appendChild(
         doc.createTextNode("Dwara or द्वारा or बाट or ले"));
         supercarpcn7f.appendChild(carnamepathkhanechhu11);
         Attr attrTypekkpathkhanechhu11 = doc.createAttribute("karaka");
         attrTypekkpathkhanechhu11.setValue("karana(K3)");
         carnamepathkhanechhu11.setAttributeNode(attrTypekkpathkhanechhu11);
         
         Element carnamepcnkhanechhu119 = doc.createElement("vibhakti");
         Attr attrTypepcnkhanechhu120 = doc.createAttribute("presence");
         attrTypepcnkhanechhu120.setValue("Optional");
         carnamepcnkhanechhu119.setAttributeNode(attrTypepcnkhanechhu120);
         carnamepcnkhanechhu119.appendChild(
         doc.createTextNode("null or लागि"));
         supercarpcn7f.appendChild(carnamepcnkhanechhu119);
         Attr attrTypekkpcnkhanechhu121 = doc.createAttribute("karaka");
         attrTypekkpcnkhanechhu121.setValue("Sampradan(K4)");
         carnamepcnkhanechhu119.setAttributeNode(attrTypekkpcnkhanechhu121);

	Element carname12khanechhu11 = doc.createElement("vibhakti");
         Attr attrType12khanechhu11 = doc.createAttribute("presence");
         attrType12khanechhu11.setValue("Optional");
         carname12khanechhu11.setAttributeNode(attrType12khanechhu11);
         carname12khanechhu11.appendChild(
         doc.createTextNode("null"));
         supercarpcn7f.appendChild(carname12khanechhu11);
         Attr attrTypekk12khanechhu11 = doc.createAttribute("karaka");
         attrTypekk12khanechhu11.setValue("Apadan(K5)");
         carname12khanechhu11.setAttributeNode(attrTypekk12khanechhu11);
         Attr attrTypeform4khanechhu11 = doc.createAttribute("Form");
         attrTypeform4khanechhu11.setValue("Singular and Plural");
         carname12khanechhu11.setAttributeNode(attrTypeform4khanechhu11);
         

         Element carname13khanechhu11 = doc.createElement("vibhakti");
         Attr attrType13khanechhu11 = doc.createAttribute("presence");
         attrType13khanechhu11.setValue("Optional");
         carname13khanechhu11.setAttributeNode(attrType13khanechhu11);
         carname13khanechhu11.appendChild(
         doc.createTextNode("को or करुको or रो or नो"));
         supercarpcn7f.appendChild(carname13khanechhu11);
         Attr attrTypekk13khanechhu11 = doc.createAttribute("karaka");
         attrTypekk13khanechhu11.setValue("Sambandh(K6)");
         carname13khanechhu11.setAttributeNode(attrTypekk13khanechhu11);
         Attr attrTypeform5khanechhu11 = doc.createAttribute("Form");
         attrTypeform5khanechhu11.setValue("Singular and Plural");
         carname13khanechhu11.setAttributeNode(attrTypeform5khanechhu11);


         Element carname14khanechhu11 = doc.createElement("vibhakti");
         Attr attrType14khanechhu11 = doc.createAttribute("presence");
         attrType14khanechhu11.setValue("Optional");
         carname14khanechhu11.setAttributeNode(attrType14khanechhu11);
         carname14khanechhu11.appendChild(
         doc.createTextNode("मा or null हरुमा  or देखि or बाट"));
         supercarpcn7f.appendChild(carname14khanechhu11);
         Attr attrTypekk14khanechhu11 = doc.createAttribute("karaka");
         attrTypekk14khanechhu11.setValue("Adhikaran(K7)");
         carname14khanechhu11.setAttributeNode(attrTypekk14khanechhu11);
         Attr attrTypeform6khanechhu11 = doc.createAttribute("Form");
         attrTypeform6khanechhu11.setValue("Singular and Plural");
         carname14khanechhu11.setAttributeNode(attrTypeform6khanechhu11);
         
         Element carnamepc20khanechhu11 = doc.createElement("vibhakti");
         Attr attrTypepc22khanechhu11 = doc.createAttribute("presence");
         attrTypepc22khanechhu11.setValue("Optional");
         carnamepc20khanechhu11.setAttributeNode(attrTypepc22khanechhu11);
         carnamepc20khanechhu11.appendChild(
         doc.createTextNode("null or संग"));
         supercarpcn7f.appendChild(carnamepc20khanechhu11);
         Attr attrTypekkpc23khanechhu11 = doc.createAttribute("karaka");
         attrTypekkpc23khanechhu11.setValue("Locative(K2p)");
         carnamepc20khanechhu11.setAttributeNode(attrTypekkpc23khanechhu11);
        
 	 Element carnamepc21khanechhu11 = doc.createElement("vibhakti");
         Attr attrTypepc23khanechhu11 = doc.createAttribute("presence");
         attrTypepc23khanechhu11.setValue("Optional");
         carnamepc21khanechhu11.setAttributeNode(attrTypepc23khanechhu11);
         carnamepc21khanechhu11.appendChild(
         doc.createTextNode("मा or हरुमा or null or देखि or सम्म"));
         supercarpcn7f.appendChild(carnamepc21khanechhu11);
         Attr attrTypekkpc24khanechhu11 = doc.createAttribute("karaka");
         attrTypekkpc24khanechhu11.setValue("Locative(K7t)");
         carnamepc21khanechhu11.setAttributeNode(attrTypekkpc24khanechhu11);

  	 Element carnamepcnkhanechhu1103 = doc.createElement("Tense");
         Attr attrTypepcnkhanechhu1103 = doc.createAttribute("Vibhakti");
         attrTypepcnkhanechhu1103.setValue("Simple Future Tense");
         carnamepcnkhanechhu1103.setAttributeNode(attrTypepcnkhanechhu1103);
         supercarpcn7f.appendChild(carnamepcnkhanechhu1103);
...
//	 attrTypeformp.setValue("Plural");
  //       vibhakti8.setAttributeNode(attrTypeformp);         	
         ...
         attrType9.setValue("Optional");
         carname9.setAttributeNode(attrType9);
         carname9.appendChild(
         doc.createTextNode("लाई or null or हरुलाई or संग"));
         ...
         attrTypeform6.setValue("Singular adefaultnd Plural");
         carname14.setAttributeNode(attrTypeform6);
         
         Element carnamepc20default = doc.createElement("vibhakti");
         Attr attrTypepc22default = doc.createAttribute("presence");
         attrTypepc22default.setValue("Optional");
         carnamepc20default.setAttributeNode(attrTypepc22default);
         carnamepc20default.appendChild(
         doc.createTextNode("null"));
         supercar2.appendChild(carnamepc20default);
         Attr attrTypekkpc23default = doc.createAttribute("karaka");
         attrTypekkpc23default.setValue("Locative(K2p)");
         carnamepc20default.setAttributeNode(attrTypekkpc23default);
         
         Element carnamepc21default = doc.createElement("vibhakti");
         Attr attrTypepc23default = doc.createAttribute("presence");
         attrTypepc23default.setValue("Optional");
         carnamepc21default.setAttributeNode(attrTypepc23default);
         carnamepc21default.appendChild(
         doc.createTextNode("मा or null or सम्म"));
         supercar2.appendChild(carnamepc21default);
         Attr attrTypekkpc24default = doc.createAttribute("karaka");
         attrTypekkpc24default.setValue("Locative(K7t)");
         carnamepc21default.setAttributeNode(attrTypekkpc24default);
         ...
         StreamResult result =
         new StreamResult(new File("E:\\Nepali Parser-19May2025\\Nepali Parser\\cars.xml"));
