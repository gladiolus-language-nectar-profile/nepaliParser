...
public final class Picture implements ActionListener {
   ...
   /**
    ...
    public void show(JFrame  frame1) {
        ...
        if (frame1 == null) {
            ...
            frame1.setContentPane(getJLabel());
...
public static void  Picture(){
    ...
    public static void main1(int[][] parsedMatrix, int row, int col, String[] sw, String[] rel, String[] tags, String filename) throws Exception {
      //  try{
        Graphics g = null;
       PaintNodes pn1 = new PaintNodes(parsedMatrix, row, col, sw, rel, tags, filename);
       JFrame jf = pn1.getJframe( g,parsedMatrix, row, col, sw, rel, tags, filename);
   //}
