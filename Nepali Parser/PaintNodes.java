...
public  class PaintNodes extends JFrame {
  ...
  // FullScreenCaptureExample cs = new FullScreenCaptureExample();
    public PaintNodes(int[][] pm, int rw, int cl, String[] wd, String[] rela, String[] tgs, String fn) throws Exception {
    ...
    public PaintNodes(int[][] pm, int rw, int cl, String[] wd, String[] rela, String[] tgs, PaintNodes pl, String fn) {
    	node = new NodeLabel[cl];
...
private static BufferedImage renderImage(JPanel panel) {
 ...
 return bi;
    ...
    private void paintNodeConnections(Graphics g2d, int[][] pm1, int rows, int cols, String[] rel, String[] tg, String fn) {
      ...
      //  int rows = pm1.length;
        ...
        int count = 0;
        System.out.println(" 123 HI ITS PAINTNODES.JAVA");
...
//           dmp1 = dpm;
    ...
    private void initComponents(int[][] dpm, int row, int col, String[] words, String[] relation, String[] tags,String filename) throws Exception {
        setDefaultCloseOperation(EXIT_ON_CLOSE);
...
System.out.println("new exp2");
        ...
        String outputImagePath = "f:/project1/NPhalfparser21-2-2020/Newset/Logo.png";
       // g2d.dispose();
...
//           dmp1 = dpm;
           ...
           public void paintComponent(Graphics g2d){
                ...
                paintNodeConnections(g2d, dpm, row, col, relation, tags, filename);
...
//           dmp1 = dpm;
	...
	/*public int show(JFrame frame) {
     ...
     public  void main1(int[][] parsedMatrix, int row, int col, String[] sw, String[] rel, String[] tags, String filename) throws Exception {
        
        	PaintNodes pn =   new PaintNodes(parsedMatrix, row, col, sw, rel, tags, filename);
           /* public void run() {
            	try{
                 	new PaintNodes(parsedMatrix, row, col, sw, rel, tags, filename).setVisible(true) ;
                 }
...
//        g2d.drawLine(p1.x, p1.y, p2.x, p2.y);
    ...
    public  void main2(int[][] parsedMatrix, int row, int col, String[] sw, String[] rel, String[] tags, PaintNodes pn, String filename) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            //pn.setVisible(true);
                new PaintNodes(parsedMatrix, row, col, sw, rel, tags, pn, filename).setVisible(true);
            }
        });
      //  pict.show(pn);
       /* try {
