...
//Actualvibhaktilist = new String[nKarkas];
      // t.readFile(args[0], args[1],args[2], glyph);
       t.readFile("annoutput.txt", "ann.txt" ,"display.txt", glyph);
...
//              NP[i] =  N[i][j]  
  ...
  Vph= ch.getVerbChunks();
       ...
       vphtag = ch.getverbtag();
        ...
        //tgv = 0;
  //System.out.println("verb chunk  Lwg5 Vph["+0+"]["+0+"]="+Vph[0][0]+"    vphtag["+0+"]["+0+"]"+vphtag[0][0]);
...
//                count = count + 2;
        ...
        count++;
            ...
            //nllength = i;
            t.NPmain(nlsentence1[i], "ann.txt" ,"display.txt", wordnetfile, i);
     ...
     //  for(int l1 = 0 ; l1 < Verbs.length ; l1++){
      ...
      /* for(int b=0;b<duplicate.length;b++){
       ...
       if(projective){
        ...
        //  if(lol ==0)
         intramatrix = t.intrachunk(NNP,TTNP,duplicate,nlen, Verbs, filename, output, Words);
  }
  ...
  //}
   ...
   public static void NPmain1(String[] np1, String args, String args1, String args2, int index1)throws IOException {
    ...
    public static void NPmain(String[] np1, String args, String args1, String args2, int index1)throws IOException 
   {
       String glyph = "\u0926\u0947\u0916\u093F";
       int nonouns = 0;
     ...
     //  for(int l1 = 0 ; l1 < Verbs.length ; l1++){
       ...
       if(projective){
         ...
         if(index1 ==0){
            ...
            intramatrix = t.intrachunk(NP,TNP,duplicate,nnlength, Verbs, filename, output, Words);
         }
         else{
...
//        wordnetfile = wordnet;
        ...
        try {
            ...
            int flag = 0, flag1 = 0, flag2 = 0, flag3 = 0, flag4 = 0, flag5 = 0, flag6 = 0, flag7 = 0, flag8 = 0;
            int alaram = 0;
            int dgindex = 0 ;
            String ws,ws1;
            int dontgo = 0;
  ...
  /*                   String temp = "ab";
               ...
               if(k2exist == 0 )
                     ...
                     //System.out.println("flag="+flag+"  flag1 = "+flag1+"   flag2 ="+flag2+"    flag3="+flag3+"   flag4="+flag4+"  nowords="+nowords+"  alaram = "+alaram);
                      ...
                      if(flag == 0 && flag1 == 0 && flag2 == 0 && flag3 == 0 && flag4 == 0 && flag5 == 0 && flag6 == 0 && flag7 == 0 && flag8 == 0 && alaram == 0){
                              words[nowords]=ws;
                              //System.out.println("wd["+(nowords)+"]="+words[nowords]);
                              nowords++;
                      }
...
//      int fugee = 0;
  ...
  //        fugee = 1;
    ...
    if(sw.length >1 && duplicateparse[1][2] == 1 && duplicateparse[2][1] == 1 && tsw[1].equals("PSPLAI") && nouse==0){
                System.out.println("Sampradan added instead of K3");
...
//        npwords[npcount][s] = words[s];
  ...
  OutputStreamWriter writer = new OutputStreamWriter(new FileOutputStream(filename, true), "UTF-8");
     ...
     /* else{
      ...
      if(neg == 0)
        neg = getNegation3("\u0928\u0941\u0939\u0941\u0928\u094d\u0928\u093e", words[0]);   // dainau
      ...
      fout.write("\n");
       ...
       if(neg == 0)
        neg = getNegation("\u0926\u0948\u0928", words[0]);   // dainau
      ...
      if(neg == 0)
        neg = getNegation6("\u0926\u0948\u0928\u0928\u094d", words[0]);   // dainau
     ...
     /* else{
      ...
      if(plural == 0)
        plural = getNegation5("\u091b", words[0]);   // chau
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        fout.write(" Subject is Affirmative ");
      ...
      if(plural == 0)
        plural = getNegation("\u091b\u0928\u094d", words[0]);   // chau
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
        fout.write(" Subject is Affirmative ");
...
if(neg == 0)
      ...
      if(plural == 0)
        plural = getNegation2("\u092f\u094b", words[0]);   // nubhayo
      System.out.println("in simple past tense neg="+neg+"   plural="+plural);
      fout.write("\n");
      if(neg == 0 && plural == 1){
        System.out.println("Subject is Affirmative");
...
if(neg == 0)
    ...
    if(neg == 0)
      ...
      System.out.println(" neg="+neg+"  plural="+plural+"  first="+first+"  second="+second+"  third="+third+"  SPreT="+spre+" SPast="+spast+"  Sfut="+sfuture);
      String[] English1 = new String[words.length];
      English1 = getEnglishsentence(np, words, tags, parserelation, words[0], neg,plural,first,second,third,spre,spast,sfuture);
...
//              count++;
    ...
    public String[] getEnglishsentence(String[]  chunk,String[] nep, String[] tags, String[] rel, String vb, int ne, int pl, int f, int s, int thd, int sp, int spa, int sf){
        String[] eng = new String[nep.length];
        String[] engTr = new String[nep.length];
        System.out.println("Welcome to Englihs Translaiton");
        ...
        for(int i = 0 ; i < chunk.length;i++){
          boolean assigned = false;
            if(rel[i].equals("Karta(K1)")){
              System.out.println("karta i="+i);
              engTr[counter] = eng[1];
              index = 1;
              assigned = true;
              counter++;
            ...
            //if(){
            System.out.println("first counter="+counter+"  i="+i+"  assigned="+assigned+"  rel["+i+"]="+rel[i]);
           // counter++;
            if(counter == 1){
              if(thd == 1 && sp == 1 && pl==0){
                engTr[1] = eng[0]+" es";    
              ...
              else if((s==1 && sf == 1)  || (thd==1 && sf == 1)){
                  engTr[1] = "will"+eng[0];
              }
             // counter++;
            }
            //}
            if(!assigned && rel[i].equals("Sampradan(K4)")  &&  rel[i+2].equals("Karma(K2)")  ){
              System.out.println("Sampradan-karma counter="+counter+"  i="+i);
              index = index + 1;
              counter++;
            ...
            else if(!assigned && rel[i].equals("Karma(K2)")){
              System.out.println("karma i="+i+"  counter="+counter);
              counter++;
              engTr[counter] = eng[i+1];
              index = i+1;
              assigned = true;
            }
            else if(!assigned){// if(index < chunk.length){
              System.out.println("index="+index+"  counter="+counter+"  eng["+(index+1)+"]="+eng[index+1]);
              counter++;
